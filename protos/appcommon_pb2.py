...
_LPROTO = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='L_PROTO_HTTP', index=3, number=3,
      serialized_options=None,
      type=None),
  ],
...
_APPPORT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='path_prefix', full_name='distributed_match_engine.AppPort.path_prefix', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fqdn_prefix', full_name='distributed_match_engine.AppPort.fqdn_prefix', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_port', full_name='distributed_match_engine.AppPort.end_port', index=5,
