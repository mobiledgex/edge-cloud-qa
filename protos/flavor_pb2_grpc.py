...
class FlavorApiStub(object):
  ...
  def __init__(self, channel):
    ...
    self.AddFlavorRes = channel.unary_unary(
        '/edgeproto.FlavorApi/AddFlavorRes',
        request_serializer=flavor__pb2.Flavor.SerializeToString,
        response_deserializer=result__pb2.Result.FromString,
        )
    self.RemoveFlavorRes = channel.unary_unary(
        '/edgeproto.FlavorApi/RemoveFlavorRes',
        request_serializer=flavor__pb2.Flavor.SerializeToString,
        response_deserializer=result__pb2.Result.FromString,
        )
...
class FlavorApiServicer(object):
  ...
  def AddFlavorRes(self, request, context):
  ...
  def RemoveFlavorRes(self, request, context):
...
def add_FlavorApiServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'AddFlavorRes': grpc.unary_unary_rpc_method_handler(
          servicer.AddFlavorRes,
          request_deserializer=flavor__pb2.Flavor.FromString,
          response_serializer=result__pb2.Result.SerializeToString,
      ),
      'RemoveFlavorRes': grpc.unary_unary_rpc_method_handler(
          servicer.RemoveFlavorRes,
          request_deserializer=flavor__pb2.Flavor.FromString,
          response_serializer=result__pb2.Result.SerializeToString,
      ),
  }
