...
appinst_delete = [{'cloudlet_name':'automationBuckhornCloudlet'},{'cloudlet_name':'automationSunnydaleCloudlet'}]
clusterinst_delete = [{'cloudlet_name':'automationBuckhornCloudlet'},{'cloudlet_name':'automationSunnydaleCloudlet'}]
