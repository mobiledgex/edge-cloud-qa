...
Create App
   ...
   Create App   developer_org_name=MobiledgeX  app_name=automation-sdk-porttest  app_version=1.0  image_type=ImageTypeDocker  image_path=docker-qa.mobiledgex.net/mobiledgex/images/server_ping_threaded:9.0  access_ports=udp:2015,tcp:2015:tls,tcp:2016,tcp:3765,tcp:8085  cluster_name=automationapicluster  default_flavor_name=automation_api_flavor  use_defaults=${False}
Create App Instance
