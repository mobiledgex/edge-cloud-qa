...
sleep 1
        command nohup ./jmeterbash.sh jmeterx8076.jmx 900 50 10 10 8076 testappalertcluster.automationdallascloudlet.packet.mobiledgex.net &
sleep 1
...
sleep 1
        command nohup ./jmeterbash.sh jmeterx8076.jmx 900 $1 10 10 8076 testappalertcluster.automationdallascloudlet.packet.mobiledgex.net &
sleep 1
#Two parameters for duration in seconds $1 and the cluster $2 you want to target
elif [ $# -eq 3 ]
then
        command nohup ./jmeterbash.sh jmeterx8076.jmx 900 $1 10 10 $3 8076 $4 &
sleep 1
        command nohup ./diskbash.sh $1 1024k 1024 1 &
sleep 1
...
#                     ./jmeterbash.sh jmeterx8076.jmx 900 35 5 5 8076 testappalertcluster.automationdallascloudlet.packet.mobiledgex.net
        command nohup ./jmeterbash.sh jmeterx8076.jmx 900 $1 10 10 $3 $2 $4 &
sleep 1
fi
