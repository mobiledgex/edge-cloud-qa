...
public class FindCloudletMelDisabledWifiOnTest {
    ...
    public static String foundCloudletFqdn = "automationhamburgcloudlet.tdg.mobiledgex.net";
    public static String foundCloudletFqdn1 = "automationmunichcloudlet.tdg.mobiledgex.net";
    public static String foundCloudletFqdn2 = "automationberlincloudlet.tdg.mobiledgex.net";
