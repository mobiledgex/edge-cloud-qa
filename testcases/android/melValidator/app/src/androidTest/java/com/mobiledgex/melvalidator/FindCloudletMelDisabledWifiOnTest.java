...
public class FindCloudletMelDisabledWifiOnTest {
    ...
    public static String foundCloudletFqdn1 = "frankfurt-main.tdg.mobiledgex.net";
    ...
    //public static String foundCloudletFqdn1 = "automationberlincloudlet.tdg.mobiledgex.net";
