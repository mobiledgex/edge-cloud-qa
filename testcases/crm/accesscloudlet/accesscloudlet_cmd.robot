...
# valid nodes: [{platformvm automationFrankfurtCloudlet-TDG-pf} {sharedrootlb automationfrankfurtcloudlet.tdg.mobiledgex.net} {dedicatedrootlb cluster1603893239-0834615.automationfrankfurtcloudlet.tdg.mobiledgex.net}]
...
#    ...  '${cloudlet_platform_type}' == 'PlatformTypeVCD'           ${cloudlet_name_vcd}
      ...
      ${clusterk8sconfigfile}=  Catenate  SEPARATOR=.  ${cluster_name_access_cloudlet}  ${operator_name_crm}  kubeconfig   #cluster-16accesscloudlet.TDG.kubeconfig
