...
CRM shall be able to create a cluster instances with 64 chars on openstack
    ...
    Create Cluster Instance	cloudlet_name=${cloudlet_name}  operator_name=${operator_name}  cluster_name=${cluster_name}  flavor_name=${flavor_name}
...
CRM shall be able to create a cluster instances with long name on openstack
    ...
    Create Cluster Instance     cloudlet_name=${cloudlet_name}  operator_name=${operator_name}  cluster_name=${cluster_name_long}  flavor_name=${flavor_name}
...
Setup
    ...
    ${k8s_cloudlet_name}=  Catenate  SEPARATOR=  ${cloudlet_name}  -
