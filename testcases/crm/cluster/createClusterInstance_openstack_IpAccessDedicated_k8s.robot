...
ClusterInst shall create with IpAccessDedicated/K8s and num_masters=1 and num_nodes=1 on openstack
   ...
   ${cluster_inst}=  Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack_dedicated}  operator_org_name=${operator_name_openstack}  number_nodes=1  number_masters=1  ip_access=IpAccessDedicated  deployment=kubernetes
...
ClusterInst shall create with IpAccessDedicated/k8s and num_masters=1 and num_nodes=5 on openstack
   [Documentation]
   ...  create a cluster on openstack with IpAccessDedicated and kubernetes and masters=1 and num_nodes=5
   ...
   Log to Console  START creating cluster instance
   ${cluster_inst}=  Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack_dedicated}  operator_org_name=${operator_name_openstack}  number_nodes=5  number_masters=1  ip_access=IpAccessDedicated  deployment=kubernetes
   Log to Console  DONE creating cluster instance
...
ClusterInst shall create with IpAccessDedicated/k8s and num_masters=0 and num_nodes=4
   [Documentation]
   ...
   Log to Console  START creating cluster instance
   ${cluster_inst}=  Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack_dedicated}  operator_org_name=${operator_name_openstack}  number_nodes=4  number_masters=0  ip_access=IpAccessDedicated  deployment=kubernetes
   Log to Console  DONE creating cluster instance
