...
ClusterInst shall create 3 with IpAccessShared/docker on openstack
   [Documentation]
   ...  create 3 clusters on openstack with IpAccessShared and deploymenttype=docker
   ...  collect the time it takes to create the clusters and write it to a file
...
ClusterInst shall create 5 with IpAccessShared/docker on openstack
   [Documentation]
   ...  create 5 clusters on openstack with IpAccessShared and deploymenttype=docker
   ...  collect the time it takes to create the clusters and write it to a file
