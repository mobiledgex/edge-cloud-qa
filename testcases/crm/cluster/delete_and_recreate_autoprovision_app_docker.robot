...
Create App, Add Autoprovisioning Policy and Deploy an App Instance
   ...
   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name}  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  cluster_instance_name=autocluster-autoprov  token=${user_token}
   ...
   show app instances  region=${region}  developer_org_name=${orgname}  app_version=1.0  app_name=${app_name}  operator_org_name=${operator_name_crm}  cluster_instance_name=autocluster-autoprov
