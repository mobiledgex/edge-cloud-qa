...
CRM shall be able to Create 2 cluster instances at the same time on openstack
    ...
    ${handle1}=  Create Cluster Instance	cloudlet_name=${cloudlet_name_openstack}  operator_name=${operator_name}  cluster_name=${cluster_name_1}  flavor_name=${flavor_name}  use_thread=${True}
    ${handle2}=  Create Cluster Instance	cloudlet_name=${cloudlet_name_openstack}  operator_name=${operator_name}  cluster_name=${cluster_name_2}  flavor_name=${flavor_name}  use_thread=${True}
