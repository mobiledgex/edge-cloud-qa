...
CRM shall be able to Create 2 cluster instances on the same cloudlet for openstack
    ...
    ${cluster1}=  Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  cluster_name=${cluster_name_1}  number_masters=1  number_nodes=1 
    ${cluster2}=  Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  cluster_name=${cluster_name_2}  number_masters=1  number_nodes=1 
    ...
    ${cloudletinfo}=  Show Cloudlet Info  region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}
...
CRM shall be able to Create 2 docker cluster instances on the same cloudlet
    ...
    ${cluster1}=  Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  cluster_name=${cluster_name_1}  deployment=docker  ip_access=IpAccessShared
    ${cluster2}=  Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  cluster_name=${cluster_name_2}  deployment=docker  ip_access=IpAccessShared
