*** Settings ***
Documentation   Create 5 kubernetes Reservable Auto Cluster and Verify Auto-Provisioning
...
${kubernetes_image}  kubernetes-qa.mobiledgex.net/testmonitor/images/myfirst-app:v1
${policy_name}  AutoProvPolicyTest
${app_name_1}  AutoProvAppkubernetes1
${app_name_2}  AutoProvAppkubernetes2
${app_name_3}  AutoProvAppkubernetes3
${app_name_4}  AutoProvAppkubernetes4
${app_name_5}  AutoProvAppkubernetes5
