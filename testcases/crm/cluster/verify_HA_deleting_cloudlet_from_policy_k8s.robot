...
Create App, Add Autoprovisioning Polivy and Deploy an App Instance
   ...
   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name}  cloudlet_name=${cloudlet1}  operator_org_name=${operator_name_openstack}  token=${user_token}
#   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name}  cloudlet_name=${cloudlet2}  operator_org_name=${operator_name_openstack}  cluster_instance_name=${cluster_name}  token=${user_token}
...
Delete Cloudlet from Auto Provisioning Policy
    ...
    Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name}  cloudlet_name=${cloudlet2}  operator_org_name=${operator_name_openstack_packet}  token=${user_token}
    Wait For App Instance To Be Deleted  app_name=${app_name}  region=${region}  app_version=1.0  developer_org_name=${orgname}  cloudlet_name=${cloudlet1}
...
#    app instance should not exist  app_name=${app_name}  region=${region}  app_version=1.0  developer_org_name=${orgname}  cloudlet_name=${cloudlet1}
    Wait For App Instance To Be Deleted  app_name=${app_name}  region=${region}  app_version=1.0  developer_org_name=${orgname}  cloudlet_name=${cloudlet2}
