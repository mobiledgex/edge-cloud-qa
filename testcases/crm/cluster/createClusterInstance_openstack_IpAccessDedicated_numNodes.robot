...
*** Test Cases ***
# ECQ-1315
ClusterInst shall create with IpAccessDedicated and num_nodes=1 on CRM
   [Documentation]
...
# ECQ-1316
ClusterInst shall create with IpAccessDedicated and num_nodes=3 on CRM
   [Documentation]
...
# ECQ-1317
ClusterInst shall create with IpAccessDedicated and num_nodes=12 on CRM
   [Documentation]
...
ClusterInst shall not create with IpAccessDedicated and multiple masters
   ...
   Log to Console  START creating cluster instance
   #${cluster_inst}=  Create Cluster Instance  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  number_nodes=4  number_masters=2
   ${error_msg}=  Run Keyword and Expect Error  *  Create Cluster Instance  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  number_nodes=4  number_masters=2  ip_access=IpAccessDedicated
   Log to Console  DONE creating cluster instance
...
# ECQ-1320
ClusterInst shall create with IpAccessDedicated and num_masters=0 num_nodes=0 on CRM
   [Documentation]
   ...
   ${cluster_inst}=  Create Cluster Instance  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  number_nodes=0  number_masters=0  ip_access=IpAccessDedicated
   Log to Console  DONE creating cluster instance
