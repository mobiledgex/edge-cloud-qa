...
*** Test Cases ***
IpAccessShared helm - Heathcheck shows HealthCheckOk after creation of App Instance
    [Documentation]
    ...
    ${appinst}=  Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  
