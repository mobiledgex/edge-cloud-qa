...
Create App, Add Autoprovisioning Policy and Deploy an App Instance
   ...
   create app  region=${region}  app_name=${app_name_1}  deployment=docker  developer_org_name=${orgname}  image_path=${docker_image}  auto_prov_policies=${policy}  access_ports=tcp:2015  app_version=1.0  default_flavor_name=${default_flavor_name}  token=${user_token}
   create app  region=${region}  app_name=${app_name_2}  deployment=docker  developer_org_name=${orgname}  image_path=${docker_image}  auto_prov_policies=${policy}  access_ports=tcp:2015  app_version=1.0  default_flavor_name=${default_flavor_name}  token=${user_token}
   create app  region=${region}  app_name=${app_name_3}  deployment=docker  developer_org_name=${orgname}  image_path=${docker_image}  auto_prov_policies=${policy}  access_ports=tcp:2015  app_version=1.0  default_flavor_name=${default_flavor_name}  token=${user_token}
   create app  region=${region}  app_name=${app_name_4}  deployment=docker  developer_org_name=${orgname}  image_path=${docker_image}  auto_prov_policies=${policy}  access_ports=tcp:2015  app_version=1.0  default_flavor_name=${default_flavor_name}  token=${user_token}
   create app  region=${region}  app_name=${app_name_5}  deployment=docker  developer_org_name=${orgname}  image_path=${docker_image}  auto_prov_policies=${policy}  access_ports=tcp:2015  app_version=1.0  default_flavor_name=${default_flavor_name}  token=${user_token}
   ...
   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name_1}  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${user_token}

   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name_2}  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${user_token}

   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name_3}  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${user_token}

   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name_4}  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${user_token}

   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name_5}  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${user_token}

#   wait for cluster instance to be ready  region=${region}  cluster_name=reservable0  cloudlet_name=${cloudlet_name_crm}  token=${user_token}
...
Cleanup
    ...
    delete cluster instance  region=${region}  cluster_name=${reservable1_cluster_name}  developer_org_name=MobiledgeX  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${super_token}
    delete cluster instance  region=${region}  cluster_name=${reservable2_cluster_name}  developer_org_name=MobiledgeX  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${super_token}
    delete cluster instance  region=${region}  cluster_name=${reservable3_cluster_name}  developer_org_name=MobiledgeX  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${super_token}
    delete cluster instance  region=${region}  cluster_name=${reservable4_cluster_name}  developer_org_name=MobiledgeX  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${super_token}
    delete cluster instance  region=${region}  cluster_name=${reservable5_cluster_name}  developer_org_name=MobiledgeX  cloudlet_name=${cloudlet_name_crm}  operator_org_name=${operator_name_crm}  token=${super_token}
