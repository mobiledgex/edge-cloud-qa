...
Shall be able to update IpAccessShared k8s cluster to modify number of worker nodes
    ...
    Update Cluster Instance   region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  number_nodes=2
    ...
    Log To Console  Updating Cluster Instance
    Update Cluster Instance   region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  number_nodes=1
    Log To Console  Done Updating Cluster Instance
...
Shall be able to update IpAccessShared k8s cluster to include auto scale policy
    ...
    Log To Console  Creating Cluster Instance
    Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  deployment=kubernetes  ip_access=IpAccessShared  number_masters=1  number_nodes=2
    Log To Console  Done Creating Cluster Instance
    ...
    Log To Console  Updating Cluster Instance
    Update Cluster Instance   region=${region}  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  autoscale_policy_name=${policy_name_default}
    Log To Console  Done Updating Cluster Instance
