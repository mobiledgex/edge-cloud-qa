...
ClusterInst shall create with IpAccessDedicated/helm and num_masters=1 and num_nodes=1 on openstack
   ...
   ${cluster_inst}=  Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack}  operator_name=${operator_name_openstack}  number_nodes=1  number_masters=1  ip_access=IpAccessDedicated  deployment=helm
...
ClusterInst shall create with IpAccessDedicated/helm and num_masters=1 and num_nodes=6 on openstack
   ...
   Log to Console  START creating cluster instance
   ${cluster_inst}=  Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack}  operator_name=${operator_name_openstack}  number_nodes=6  number_masters=1  ip_access=IpAccessDedicated  deployment=helm
   Log to Console  DONE creating cluster instance
...
ClusterInst shall create with IpAccessDedicated/helm and num_masters=0 and num_nodes=4
   ...
   Log to Console  START creating cluster instance
   ${cluster_inst}=  Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack}  operator_name=${operator_name_openstack}  number_nodes=4  number_masters=0  ip_access=IpAccessDedicated  deployment=helm
   Log to Console  DONE creating cluster instance
