...
#   Should Be Equal As Numbers  ${cloudlet.status}  FIND_NOTFOUND
   ...
   Wait For App Instance To Be Ready   region=${region}   developer_org_name=${orgname}  app_version=1.0  app_name=${app_name}  cloudlet_name=${cloudlet_name_openstack_dedicated}  operator_org_name=${operator_name_openstack}  cluster_instance_name=autocluster-autoprov  token=${user_token}
...
#   sleep  15s
   ...
   show app instances  region=${region}  developer_org_name=${orgname}  app_version=1.0  app_name=${app_name}  operator_org_name=${operator_name_openstack}  cluster_instance_name=autocluster-autoprov
