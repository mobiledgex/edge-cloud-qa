...
Create App, Add Autoprovisioning Polivy and Deploy an App Instance
   ...
   create app  region=${region}  app_name=${app_name}  deployment=kubernetes  developer_org_name=testmonitor  image_path=docker-qa.mobiledgex.net/testmonitor/images/myfirst-app:v1  auto_prov_policy=${policy_name}  access_ports=tcp:8080  app_version=v1  default_flavor_name=${default_flavor_name}
