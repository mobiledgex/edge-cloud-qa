...
#${error_400_cloudletnotfound}=  (\'code=400\', \'error={"message":"Org ${cloudlet_notfound} not found"}\')
...
#   Log To Console  ${\n}federated_org specified not found during update${\n}
   ${network1_update_err}=  Run Keyword and Expect Error  *    Update Network  region=${region}  token=${token}  network_name=${name_err}  cloudlet_name=${cloudlet_name_crm}  cloudlet_org=${operator_name_crm}  connection_type=${connect2}  route_list=${routelist2}  federated_org=86868686noorghere
...
#   Log To Console  ${\n}federated_org specified not found during show${\n}
   ...
   ${network1_show_err}=  Run Keyword and Ignore Error    Show Network  region=${region}  token=${token}  network_name=${name_err}  cloudlet_name=${cloudlet_name_crm}  cloudlet_org=${operator_name_crm}  federated_org=86868686noorghere
