...
User shall be able to access TCP/UDP ports for 2 k8s apps with same name but different versions on the same rootlb
   ...
   Log To Console  Checking if port is alive
   TCP Port Should Be Alive  ${fqdn_tcp1}  ${cloudlet1.ports[0].public_port}  app_name=${app_name_k8s}
   UDP Port Should Be Alive  ${fqdn_udp1}  ${cloudlet1.ports[1].public_port}  app_name=${app_name_k8s}
   ...
   Log To Console  Checking if port is alive
   TCP Port Should Be Alive  ${fqdn_tcp2}  ${cloudlet2.ports[0].public_port}  app_name=${app_name_k8s}
   UDP Port Should Be Alive  ${fqdn_udp2}  ${cloudlet2.ports[1].public_port}  app_name=${app_name_k8s}
...
User shall be able to access TCP/UDP ports for 2 k8s apps with with same ports on the same rootlb with dedicatedip=true
   ...
   Log To Console  Checking if port is alive
   TCP Port Should Be Alive  ${fqdn_tcp1}  ${cloudlet1.ports[0].public_port}  app_name=${app_name_1}
   UDP Port Should Be Alive  ${fqdn_udp1}  ${cloudlet1.ports[1].public_port}  app_name=${app_name_1}
   ...
   Log To Console  Checking if port is alive
   TCP Port Should Be Alive  ${fqdn_tcp2}  ${cloudlet2.ports[0].public_port}  app_name=${app_name_2}
   UDP Port Should Be Alive  ${fqdn_udp2}  ${cloudlet2.ports[1].public_port}  app_name=${app_name_2}
