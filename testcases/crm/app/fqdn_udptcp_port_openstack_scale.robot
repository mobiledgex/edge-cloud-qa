...
User shall be able to access UDP,TCP and HTTP ports on openstack with scaling and num_nodes=1
    ...
    Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack}  operator_name=${operator_name_openstack}  number_masters=1  number_nodes=1
...
User shall be able to access UDP,TCP and HTTP ports on openstack with scaling and num_nodes=2
    ...
    Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack}  operator_name=${operator_name_openstack}  number_masters=1  number_nodes=2
...
User shall be able to access UDP,TCP and HTTP ports on openstack with scaling and num_nodes=10
    ...
    Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack}  operator_name=${operator_name_openstack}  number_masters=1  number_nodes=${num_nodes}
