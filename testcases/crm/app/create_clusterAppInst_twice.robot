...
CreateAppInst - User shall be able to create same cluster/appinst twice
    ...
    TCP Port Should Be Alive  ${fqdn_02}  ${cloudlet2.ports[0].public_port}  app_name=${app_name_default}
    TCP Port Should Be Alive  ${fqdn_12}  ${cloudlet2.ports[1].public_port}  app_name=${app_name_default}
