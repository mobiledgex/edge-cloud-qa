...
CreateAppInst - User shall be able to create same cluster/appinst twice
    ...
    Create App           region=${region}  image_path=${docker_image}  access_ports=tcp:2016,tcp:2015
 
    Log To Console  Creating Cluster Instance
    Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_dedicated}  operator_org_name=${operator_name_openstack}  deployment=kubernetes  ip_access=IpAccessDedicated  number_masters=1  number_nodes=1  auto_delete=${False}
