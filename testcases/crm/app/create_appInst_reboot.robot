*** Settings ***
Documentation  create/delete appinst on openstack after reboot
...
User shall be able to access UDP,TCP and HTTP ports on openstack after reboot
    ...
    Create App Instance  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  cluster_instance_name=${cluster_name_default}  no_auto_delete=${True}
...
Setup
    ...
    Create Cluster Instance  cloudlet_name=${cloudlet_name_openstack_shared}  operator_org_name=${operator_name_openstack}  no_auto_delete=${True}  #flavor_name=${cluster_flavor_name}
