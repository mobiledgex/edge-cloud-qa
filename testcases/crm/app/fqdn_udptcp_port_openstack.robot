...
*** Test Cases ***
# ECQ-1089
User shall be able to access 1 UDP port on CRM
    [Documentation]
    ...
    UDP Port Should Be Alive  ${fqdn}  ${cloudlet.ports[0].public_port}  app_name=${app_name_default}
...
# ECQ-1090
User shall be able to access 2 UDP ports on CRM
    [Documentation]
    ...
    UDP Port Should Be Alive  ${fqdn_0}  ${cloudlet.ports[0].public_port}  app_name=${app_name_default}
...
User shall be able to access 1 TCP port on CRM
    ...
    Log To Console  Checking if port is alive
    TCP Port Should Be Alive  ${fqdn}  ${cloudlet.ports[0].public_port}  app_name=${app_name_default}
...
User shall be able to access 2 UDP and 2 TCP ports on CRM
    ...
    UDP Port Should Be Alive  ${fqdn_3}  ${cloudlet.ports[3].public_port}  app_name=${app_name_default}
...
# ECQ-2267
User shall be able to access UDP,TCP and HTTP ports on CRM with manifest
    [Documentation]
...
# ECQ-2994
User shall be able to access UDP,TCP and HTTP ports on CRM with manifest with externalports != interalports
    [Documentation]
...
# ECQ-2268
User shall be able to access UDP,TCP and HTTP ports on CRM with manifest and no image_path
    [Documentation]
