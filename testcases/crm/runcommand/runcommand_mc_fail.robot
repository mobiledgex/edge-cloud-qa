...
RunCommand - shall return error with appname not found
    ...
    Should Contain  ${error}  Error: Bad Request, AppInst key {"app_key":{"developer_key":{"name":"automation_api"},"name":"automation_api_ap","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autocluster"},"cloudlet_key":{"operator_key":{"name":"dmuus"},"name":"tmocloud-1"},"developer":"automation_api"}} not found 
...
RunCommand - shall return error with app version not found
    ...
    Should Contain  ${error}  Error: Bad Request, AppInst key {"app_key":{"developer_key":{"name":"automation_api"},"name":"automation_api_app","version":"1.1"},"cluster_inst_key":{"cluster_key":{"name":"autocluster"},"cloudlet_key":{"operator_key":{"name":"dmuus"},"name":"tmocloud-1"},"developer":"automation_api"}} not found 
...
RunCommand - shall return error with cluster not found
    ...
    Should Contain  ${error}  Error: Bad Request, AppInst key {"app_key":{"developer_key":{"name":"automation_api"},"name":"automation_api_app","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autocluste"},"cloudlet_key":{"operator_key":{"name":"dmuus"},"name":"tmocloud-1"},"developer":"automation_api"}} not found 
...
RunCommand - shall return error with cloudlet not found
    ...
    Should Contain  ${error}  Error: Bad Request, AppInst key {"app_key":{"developer_key":{"name":"automation_api"},"name":"automation_api_app","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autocluster"},"cloudlet_key":{"operator_key":{"name":"dmuus"},"name":"tmocloud-"},"developer":"automation_api"}} not found 
