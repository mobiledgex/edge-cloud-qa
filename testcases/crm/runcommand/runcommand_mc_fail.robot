...
RunCommand - shall return error without token
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Command  region=US  app_name=automation_api_app  app_version=1.0  developer_name=automation_api  cluster_instance_name=autocluster  operator_name=tmus  cloudlet_name=tmocloud-1  command=ls
    log to console  ${error}
