...
RunCommand - shall return error with appname not found
    ...
    Should Contain  ${error}  Error: Bad Request (400), AppInst key {"app_key":{"organization":"${developer}","name":"automation_api_ap","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autocluster"},"cloudlet_key":{"organization":"tmus","name":"tmocloud-1"},"organization":"${developer}"}} not found 
...
RunCommand - shall return error with app version not found
    ...
    Should Contain  ${error}  Error: Bad Request (400), AppInst key {"app_key":{"organization":"${developer}","name":"automation_api_app","version":"1.1"},"cluster_inst_key":{"cluster_key":{"name":"autocluster"},"cloudlet_key":{"organization":"tmus","name":"tmocloud-1"},"organization":"${developer}"}} not found 
...
RunCommand - shall return error with developer not found
    ...
    Should Contain  ${error}  Error: Bad Request (400), AppInst key {"app_key":{"organization":"automation_ap","name":"automation_api_app","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autocluster"},"cloudlet_key":{"organization":"tmus","name":"tmocloud-1"},"organization":"automation_ap"}} not found 
...
RunCommand - shall return error with cloudlet not found
    ...
    Should Contain  ${error}  Error: Bad Request (400), AppInst key {"app_key":{"organization":"${developer}","name":"automation_api_app","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autocluster"},"cloudlet_key":{"organization":"tmus","name":"tmocloud-"},"organization":"${developer}"}} not found 
