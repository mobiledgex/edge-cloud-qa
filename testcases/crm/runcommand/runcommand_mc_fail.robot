...
RunCommand - shall return error with appname not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Command  region=US  app_name=automation_api_ap  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluster  operator_org_name=tmus  cloudlet_name=tmocloud-1  command=ls
...
RunCommand - shall return error with app version not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Command  region=US  app_name=automation_api_app  app_version=1.1  developer_org_name=${developer}  cluster_instance_name=autocluster  operator_org_name=tmus  cloudlet_name=tmocloud-1  command=ls
...
RunCommand - shall return error with developer not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Command  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=automation_ap  cluster_instance_name=autocluster  operator_org_name=tmus  cloudlet_name=tmocloud-1  command=ls
...
RunCommand - shall return error with cluster not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Command  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluste  operator_org_name=tmus  cloudlet_name=tmocloud-1  command=ls
...
RunCommand - shall return error with cloudlet not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Command  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluster  operator_org_name=tmus  cloudlet_name=tmocloud-  command=ls

    Should Contain  ${error}  ('code=400', 'error={"message":"AppInst key {\\\\"app_key\\\\":{\\\\"organization\\\\":\\\\"${developer}\\\\",\\\\"name\\\\":\\\\"automation_api_app\\\\",\\\\"version\\\\":\\\\"1.0\\\\"},\\\\"cluster_inst_key\\\\":{\\\\"cluster_key\\\\":{\\\\"name\\\\":\\\\"autocluster\\\\"},\\\\"cloudlet_key\\\\":{\\\\"organization\\\\":\\\\"tmus\\\\",\\\\"name\\\\":\\\\"tmocloud-\\\\"},\\\\"organization\\\\":\\\\"${developer}\\\\"}} not found"}') 
...
RunCommand - shall return error without run command 
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Command  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autoclusterautomation  operator_org_name=tmus  cloudlet_name=tmocloud-1  
...
RunCommand - shall return error for VM app 
    ...
    Create App Instance  region=US  operator_org_name=tmus  cloudlet_name=tmocloud-1  #app_name=${app_name_default}  developer_org_name=${developer_name_default}  app_version=${app_version_default}  cloudlet_name=${cloudlet_name}  operator_org_name=${operator_name}  use_defaults=${False}

    ${error}=  Run Keyword And Expect Error  *  Run Command  region=US  command=ls  operator_org_name=tmus  cloudlet_name=tmocloud-1  #app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluster  operator_org_name=tmus  cloudlet_name=tmocloud-1  command=ls  use_defaults=${False}
