...
#    EDGECLOUD-2556 - ShowLogs for VM should show error consistent with RunCommand
    ...
    ${error1}=  Run Keyword And Expect Error  *  Show Logs  region=US  cloudlet_name=tmocloud-1  operator_org_name=tmus  developer_org_name=${developer_artifactory}  cluster_instance_developer_org_name=${developer_artifactory}
