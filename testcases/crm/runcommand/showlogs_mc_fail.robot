...
ShowLogs - shall return error with appname not found
    ...
    Should Contain  ${error}  Error: Bad Request (400), AppInst key {"app_key":{"organization":"${developer}","name":"automation_api_ap","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autoclusterautomation"},"cloudlet_key":{"organization":"dmuus","name":"tmocloud-1"},"organization":"${developer}"}} not found 
...
ShowLogs - shall return error with app version not found
    ...
    Should Contain  ${error}  Error: Bad Request (400), AppInst key {"app_key":{"organization":"${developer}","name":"automation_api_app","version":"1.1"},"cluster_inst_key":{"cluster_key":{"name":"autoclusterautomation"},"cloudlet_key":{"organization":"dmuus","name":"tmocloud-1"},"organization":"${developer}"}} not found 
...
ShowLogs - shall return error with developer not found
    ...
    Should Contain  ${error}  Error: Bad Request (400), AppInst key {"app_key":{"organization":"automation_ap","name":"automation_api_app","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autoclusterautomation"},"cloudlet_key":{"organization":"dmuus","name":"tmocloud-1"},"organization":"automation_ap"}} not found 
...
ShowLogs - shall return error with cluster not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Show Logs  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluste  operator_org_name=dmuus  cloudlet_name=tmocloud-1  token=${token}  
    log to console  ${error}
...
ShowLogs - shall return error with cloudlet not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Show Logs  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autoclusterautomation  operator_org_name=dmuus  cloudlet_name=tmocloud-  token=${token}  
    log to console  ${error}

    Should Contain  ${error}  Error: Bad Request (400), AppInst key {"app_key":{"organization":"${developer}","name":"automation_api_app","version":"1.0"},"cluster_inst_key":{"cluster_key":{"name":"autoclusterautomation"},"cloudlet_key":{"organization":"dmuus","name":"tmocloud-"},"organization":"${developer}"}} not found 
...
ShowLogs - shall return error without invalid parms 
    ...
    ${error1}=  Run Keyword And Expect Error  *  Show Logs  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autoclusterautomation  operator_org_name=dmuus  cloudlet_name=tmocloud-1   since=x

    ${error2}=  Run Keyword And Expect Error  *  Show Logs  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autoclusterautomation  operator_org_name=dmuus  cloudlet_name=tmocloud-1   tail=x

    ${error3}=  Run Keyword And Expect Error  *  Show Logs  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autoclusterautomation  operator_org_name=dmuus  cloudlet_name=tmocloud-1   time_stamps=x

    ${error4}=  Run Keyword And Expect Error  *  Show Logs  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autoclusterautomation  operator_org_name=dmuus  cloudlet_name=tmocloud-1   follow=x
