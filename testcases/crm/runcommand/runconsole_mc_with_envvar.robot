...
RunConsole - DeveloperContributor shall not be able to do RunConsole with envvar=spice
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Console  region=EU  developer_org_name=${docker_image_developer}  operator_org_name=GDDT  cloudlet_name=automationSunnydaleCloudlet
