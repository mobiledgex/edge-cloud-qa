...
ShowLogs - k8s shared shall return logs on CRM
    ...
    Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_crm_shared}  operator_org_name=${operator_name_crm}  flavor_name=${cluster_flavor_name}  deployment=kubernetes  ip_access=IpAccessShared
...
ShowLogs - k8s dedicated shall return logs on CRM
    ...
    Log To Console  Creating Cluster Instance
    Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_crm_dedicated}  operator_org_name=${operator_name_crm}  flavor_name=${cluster_flavor_name}  deployment=kubernetes  ip_access=IpAccessDedicated
...
ShowLogs - docker dedicated shall return logs on CRM
    ...
    Log To Console  Creating Cluster Instance
    Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_crm_dedicated}  operator_org_name=${operator_crm_openstack}  flavor_name=${cluster_flavor_name}  deployment=docker  ip_access=IpAccessDedicated
...
ShowLogs - docker shared shall return logs on CRM
    ...
    Log To Console  Creating Cluster Instance
    Create Cluster Instance  region=${region}  cloudlet_name=${cloudlet_name_crm_dedicated}  operator_org_name=${operator_name_crm}  flavor_name=${cluster_flavor_name}  deployment=docker  ip_access=IpAccessShared
