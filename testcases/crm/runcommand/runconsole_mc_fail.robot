...
RunConsole - shall return error with cluster not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Console  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluste  operator_org_name=tmus  cloudlet_name=tmocloud-1  token=${token}  command=ls
...
RunConsole - shall return error with cloudlet not found
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Console  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluster  operator_org_name=tmus  cloudlet_name=tmocloud-  token=${token}  command=ls
...
RunConsole - shall return error with bad token 
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Console  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluster  operator_org_name=tmus  cloudlet_name=tmocloud-1  token=xx  command=ls
...
RunConsole - shall return error without token
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Console  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autocluster  operator_org_name=tmus  cloudlet_name=tmocloud-1  command=ls  use_defaults=${False}
...
RunConsole - shall return error with non-vm app
    ...
    ${error}=  Run Keyword And Expect Error  *  Run Console  region=US  app_name=automation_api_app  app_version=1.0  developer_org_name=${developer}  cluster_instance_name=autoclusterautomation  operator_org_name=tmus  cloudlet_name=tmocloud-1  token=${token}  command=ls
