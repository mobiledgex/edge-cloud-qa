...
GetCloudletManifest - User shall be able to get cloudlet manifest, revoke and get again
   ...
   ${cloudlet_manifest}=  Get Cloudlet Manifest  region=EU   operator_org_name=${operator_name_openstack_hamburg}  cloudlet_name=${cloudlet_name_openstack_hamburg}restricted
   ...
   Run Keyword and Expect Error  ('code=400', 'error={"message":"Cloudlet has access key registered, please revoke the current access key first so a new one can be generated for the manifest"}')  Get Cloudlet Manifest  region=EU   operator_org_name=${operator_name_openstack_hamburg}  cloudlet_name=${cloudlet_name_openstack_hamburg}restricted

   Revoke Access Key  region=EU   operator_org_name=${operator_name_openstack_hamburg}  cloudlet_name=${cloudlet_name_openstack_hamburg}restricted

   ${cloudlet_manifest2}=  Get Cloudlet Manifest  region=EU   operator_org_name=${operator_name_openstack_hamburg}  cloudlet_name=${cloudlet_name_openstack_hamburg}restricted
