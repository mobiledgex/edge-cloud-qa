...
StreamCloudlet - shall be able to streamcloudlet for Create/Delete cloudlet
   ...
   Create Cloudlet  region=${region}  operator_org_name=${operator_name_openstack_frankfurt}  platform_type=PlatformTypeOpenstack  physical_name=${physical_name_openstack_frankfurt}  number_dynamic_ips=254  latitude=53.551085  longitude=9.993682  use_thread=${True}
   Sleep  5s
   ${output}=  Stream Cloudlet  region=${region}  operator_org_name=${operator_name_openstack_frankfurt}
   ...
   Delete Cloudlet  region=EU  operator_org_name=${operator_name_openstack_frankfurt}  use_thread=${True}
   Sleep  5s
   ${output2}=  Stream Cloudlet  region=${region}  operator_org_name=${operator_name_openstack_frankfurt}
...
*** Keywords ***
Teardown
   Run Keyword and Ignore Error  Delete Cloudlet  region=${region}  operator_org_name=${operator_name_openstack_frankfurt}
