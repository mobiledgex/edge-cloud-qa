...
- id: 1
  ...
  contenttype: url
  contentsubtype: none
  content: https://artifactory.mobiledgex.net/artifactory/baseimages/mobiledgex-v4.7.0.qcow2"""

manifest_2 = """- id: 2
  title: Execute the following command to upload the image to your glance store
  contenttype: command
  contentsubtype: none
  content: openstack image create mobiledgex-v4.7.0 --disk-format qcow2 --container-format
    bare --shared --file mobiledgex-v4.7.0.qcow2"""
