...
CreateCloudlet - User shall be able to create a cloudlet on Openstack Buckhorn
        ...
        Run Keyword and Ignore Error  Create Resource Tag Table  region=US  resource_table_name=${gpu_resource_name}  operator_org_name=${operator_name_openstack_buckhorn}  tags=pci=t4gpu:1
        Run Keyword and Ignore Error  Add Resource Tag  region=US  resource_name=${gpu_resource_name}  operator_org_name=${operator_name_openstack_buckhorn}  tags=pci=t4gpu:1
...
CreateCloudlet - User shall be able to create a fake cloudlet
        ...
        Run Keyword and Continue on Failure  Create Cloudlet  region=EU  operator_org_name=dmuus  cloudlet_name=eucloud-1  platform_type=PlatformTypeFake  number_dynamic_ips=254  latitude=41.38879  longitude=2.15899  env_vars=FAKE_RAM_MAX=4096000,FAKE_VCPUS_MAX=1000,FAKE_DISK_MAX=100000
...
DeleteCloudlet - User shall be able to delete a cloudlet on Openstack Buckhorn
        ...
        Cleanup Clusters and Apps  region=US  cloudlet_name=${cloudlet_name_openstack_buckhorn}
...
DeleteCloudlet - User shall be able to delete a cloudlet on Openstack Beacon
        ...
        Cleanup Clusters and Apps  region=EU  cloudlet_name=${cloudlet_name_openstack_beacon}
...
#        Delete All Cluster Instances  region=EU  cloudlet_name=${cloudlet_name_openstack_beacon}
        Delete All Auto Provisioning Policies  region=EU  cloudlet_name=${cloudlet_name_openstack_beacon}
...
DeleteCloudlet - User shall be able to delete a fake cloudlet
        ...
        Run Keyword and Continue on Failure  Delete Cloudlet  region=EU  operator_org_name=dmuus  cloudlet_name=eucloud-1
