...
DeleteCloudlet - User shall be able to delete a fake cloudlet
        ...
        Update Cloudlet  region=US  cloudlet_name=tmocloud-1  operator_org_name=tmus  maintenance_state=NormalOperation
        Update Cloudlet  region=US  cloudlet_name=tmocloud-2  operator_org_name=tmus  maintenance_state=NormalOperation
