...
CreateCloudlet - User shall be able to create a fake cloudlet
        ...
        Run Keyword and Continue on Failure  Create Cloudlet  region=EU  operator_org_name=att  cloudlet_name=eucloud-1  platform_type=PlatformTypeFake  number_dynamic_ips=254  latitude=41.38879  longitude=2.15899  env_vars=FAKE_RAM_MAX=4096000,FAKE_VCPUS_MAX=1000,FAKE_DISK_MAX=100000
