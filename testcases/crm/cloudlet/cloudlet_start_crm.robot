...
UpgradeCloudlet - User shall be able to upgrade a cloudlet on Openstack Bonn
        ...
        Update Cloudlet  region=EU  operator_name=${operator_name_openstack_bonn}  cloudlet_name=${cloudlet_name_openstack_bonn}  container_version=${version}   package_version=${imgversion}  use_defaults=${False}
...
UpgradeCloudlet - User shall be able to upgrade a cloudlet on Openstack Munich 
        ...
        Update Cloudlet  region=EU  operator_name=${operator_name_openstack_munich}  cloudlet_name=${cloudlet_name_openstack_munich}  container_version=${version}   package_version=${imgversion}  use_defaults=${False}
...
UpgradeCloudlet - User shall be able to upgrade a cloudlet on Openstack Hamburg 
        ...
        Update Cloudlet  region=EU  operator_name=${operator_name_openstack_hamburg}  cloudlet_name=${cloudlet_name_openstack_hamburg}  container_version=${version}   package_version=${imgversion}  use_defaults=${False}
...
UpgradeCloudlet - User shall be able to upgrade a cloudlet on Openstack Frankfurt 
        ...
        Update Cloudlet  region=EU  operator_name=${operator_name_openstack_frankfurt}  cloudlet_name=${cloudlet_name_openstack_frankfurt}  container_version=${version}   package_version=${imgversion}  use_defaults=${False}
...
UpgradeCloudlet - User shall be able to upgrade a cloudlet on Openstack Dusseldorf
        ...
        Update Cloudlet  region=EU  operator_name=${operator_name_openstack_dusseldorf}  cloudlet_name=${cloudlet_name_openstack_dusseldorf}  container_version=${version}   package_version=${imgversion}  use_defaults=${False}
