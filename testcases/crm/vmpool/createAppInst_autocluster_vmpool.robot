...
AppInst autocluster shall create with VMPool IpAccessDedicated/docker/lb
   ...
   ${appinst}=  Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_vmpool}  operator_org_name=${operator_name_vmpool}  cluster_instance_name=autocluster${cluster_name_default}  autocluster_ip_access=IpAccessDedicated
   Log to Console  DONE creating cluster instance
