...
Verify Common Data
   ...
   Should Match Regexp  ${node['data']['build_head']}  v\\d{1,3}\\.\\d{1,3}\\.\\d{1,3}\\-.+
...
DME Should Exist
   [Arguments]  ${nodes}
    ...
    #                         'GDDTOperatorBuildDate': 'Tue Feb  9 04:03:19 UTC 2021',
    #                         'GDDTOperatorBuildHead': 'v1.2.4-83-g7cbc43ff+',
...
Verify DME 
   ...
   Should Be Equal   ${node['data']['key']['cloudlet_key']['organization']}  GDDT
   ...
   Should Match Regexp  ${node['data']['properties']['GDDTOperatorBuildDate']}  ^\\b\\w{3}\\b \\b\\w{3}\\b
   Should Match Regexp  ${node['data']['properties']['GDDTOperatorBuildHead']}  v\\d{1,3}\\.\\d{1,3}\\.\\d{1,3}\\-.+ 
   Should Be Equal  ${node['data']['properties']['GDDTOperatorBuildHead']}  ${node['data']['properties']['GDDTOperatorBuildMaster']}
   Should Be Equal      ${node['data']['internal_pki']}  UseVaultPki  #useVaultCAs,useVaultCerts
