...
MC - Admin shall be able to see all controller info
    ...
    Should Be Equal  ${info[0]['NotifyAddr']}     ${EMPTY}
    Should Be Equal  ${info[0]['ThanosMetrics']}  ${EMPTY}
    ...
    Should Be Equal  ${info[1]['NotifyAddr']}     ${EMPTY}
    Should Be Equal  ${info[1]['ThanosMetrics']}  ${EMPTY}
...
Non-admin shall show region only
    ...
    Should Not Contain  ${info[0]}  CreatedAt
    Should Not Contain  ${info[0]}  UpdatedAt
