...
Update Setup
   ...
   Run mcctl  autoprovpolicy create region=${region} name=${autoprovpolicy_name}0 apporg=${developer} deployclientcount=1 minactiveinstances=1 cloudlets:0.key.organization=tmus cloudlets:0.key.name=tmocloud-1
   Run mcctl  autoprovpolicy create region=${region} name=${autoprovpolicy_name} apporg=${developer} deployclientcount=1 minactiveinstances=1 cloudlets:0.key.organization=tmus cloudlets:0.key.name=tmocloud-1
