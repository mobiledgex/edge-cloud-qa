...
CreateApp - mcctl shall be able to create/show/delete app 
   ...
   [Template]  Success Create/Show/Delete App Via mcctl
      ...
      appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${False}  requiredoutboundconnections:0.protocol=icmp  requiredoutboundconnections:0.remotecidr=1.1.1.1/1  defaultflavor=${flavor_name_automation}
...
CreateApp - mcctl shall handle create failures
   ...
   [Template]  Fail Create App Via mcctl
     ...
     Error: Bad Request (400), Cannot unmarshal env vars: x - yaml: unmarshal errors:\\n  line 1: cannot unmarshal !!str `x` into []v1.EnvVar  appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  imagepath=${docker_image}  accessports=tcp:2015  configs:0.kind=envVarsYaml  configs:0.config=x  defaultflavor=${flavor_name_automation}
      ...
      # requiredoutboundconnections
      Bad Request (400), Port range must be empty for icmp   appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=icmp  requiredoutboundconnections:0.portrangemin=1  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      Error: Bad Request (400), Invalid min port: 0   appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=tcp  requiredoutboundconnections:0.portrangemin=0  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      ...
      Error: Bad Request (400), Protocol must be one of: (tcp,udp,icmp)  appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=cmp  requiredoutboundconnections:0.portrangemin=1  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      Error: Bad Request (400), Invalid CIDR address:    appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=icmp
      Error: Bad Request (400), Invalid min port: 0    appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=tcp 
      Error: Bad Request (400), Invalid CIDR address:    appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=udp  requiredoutboundconnections:0.portrangemin=1
      Error: Bad Request (400), Invalid min port: 0   appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=tcp  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      Error: Bad Request (400), Protocol must be one of: (tcp,udp,icmp)  appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeHelm    deployment=helm        accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=  # remove the ports
      Bad Request (400), Invalid min port: 0   appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=tcp  requiredoutboundconnections:0.portrangemax=1  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      Bad Request (400), Min port range: 2 cannot be higher than max: 1   appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}       trusted=${True}  requiredoutboundconnections:0.protocol=tcp  requiredoutboundconnections:0.portrangemin=2  requiredoutboundconnections:0.portrangemax=1  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      ...
      Error: Bad Request (400), Serverless config vcpus cannot have precision less than 0.001  appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}  defaultflavor=${flavor_name_automation}  allowserverless=${True}  serverlessconfig.vcpus=0.000001  serverlessconfig.ram=2  serverlessconfig.minreplicas=3
      ...
      Error: parsing arg "serverlessconfig.minreplicas\=x" failed: unable to parse "x" as uint: invalid syntax  appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}  defaultflavor=${flavor_name_automation}  allowserverless=${True}  allowserverless=${True}  serverlessconfig.vcpus=0.01  serverlessconfig.ram=2  serverlessconfig.minreplicas=x
      Error: parsing arg "serverlessconfig.vcpus\=x" failed: unable to parse "x" as unsigned decimal: invalid format  appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}  defaultflavor=${flavor_name_automation}  allowserverless=${True}  serverlessconfig.vcpus=x  serverlessconfig.ram=2  serverlessconfig.minreplicas=1
      ...
      Error: parsing arg "serverlessconfig.vcpus\=-1" failed: unable to parse "-1" as unsigned decimal: invalid format  appname=${app_name}  app-org=${developer}  appvers=1.0  imagetype=ImageTypeDocker  deployment=kubernetes  accesstype=AccessTypeLoadBalancer  imagepath=${docker_image}  defaultflavor=${flavor_name_automation}  allowserverless=${True}  serverlessconfig.vcpus=-1  serverlessconfig.ram=2  serverlessconfig.minreplicas=1
...
UpdateApp - mcctl shall handle update app 
   ...
   [Template]  Success Update/Show App Via mcctl
      ...
      appname=${app_name_k8s}  app-org=${developer}  appvers=1.0  requiredoutboundconnections:0.protocol=icmp  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      appname=${app_name_docker}  app-org=${developer}  appvers=1.0  requiredoutboundconnections:0.protocol=tcp  requiredoutboundconnections:0.portrangemin=1  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      appname=${app_name_docker}  app-org=${developer}  appvers=1.0  requiredoutboundconnections:0.protocol=udp  requiredoutboundconnections:0.portrangemin=1  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
      appname=${app_name_helm}  app-org=${developer}  appvers=1.0  requiredoutboundconnections:0.protocol=icmp  requiredoutboundconnections:0.remotecidr=1.1.1.1/1  requiredoutboundconnections:1.protocol=tcp  requiredoutboundconnections:1.portrangemin=1  requiredoutboundconnections:1.remotecidr=1.1.1.1/1
      appname=${app_name_vm}  app-org=${developer}  appvers=1.0  requiredoutboundconnections:0.protocol=tcp  requiredoutboundconnections:0.portrangemin=10  requiredoutboundconnections:0.remotecidr=1.1.1.1/1  requiredoutboundconnections:1.protocol=tcp  requiredoutboundconnections:1.portrangemin=1  requiredoutboundconnections:1.remotecidr=1.1.1.1/1
      appname=${app_name_docker}  app-org=${developer}  appvers=1.0  requiredoutboundconnections:0.protocol=tcp  requiredoutboundconnections:0.portrangemin=1  requiredoutboundconnections:0.portrangemax=2  requiredoutboundconnections:0.remotecidr=1.1.1.1/1
...
Update Setup
   ...
   Run mcctl  autoprovpolicy create region=${region} name=${autoprovpolicy_name}0 app-org=${developer} deployclientcount=1 minactiveinstances=1 cloudlets:0.key.organization=tmus cloudlets:0.key.name=tmocloud-1
   Run mcctl  autoprovpolicy create region=${region} name=${autoprovpolicy_name} app-org=${developer} deployclientcount=1 minactiveinstances=1 cloudlets:0.key.organization=tmus cloudlets:0.key.name=tmocloud-1
