...
Clientapiusage - mcctl shall handle clientapiusage metrics failures
   ...
   [Template]  Fail Clientapiusage Metrics Via mcctl
      ...
      error decoding \\\'MetricsCommon.TimeRange.StartTime\\\'                                                                  selector=api  app-org=automation_dev_org  starttime=x
      error decoding \\\'MetricsCommon.TimeRange.EndTime\\\'                                                                    selector=api  app-org=automation_dev_org  endtime=x
      error decoding \\\'MetricsCommon.TimeRange.StartAge\\\': time: invalid duration "x"                                       selector=api  cloudlet-org=automation_dev_org  startage=x
      error decoding \\\'MetricsCommon.TimeRange.EndAge\\\': time: invalid duration "x"                                         selector=api  cloudlet-org=automation_dev_org  endage=x
      Unable to parse "limit" value "x" as int: invalid syntax                                                                  selector=api  app-org=automation_dev_org  limit=x
      Unable to parse "cellid" value "x" as int: invalid syntax                                                                 selector=api  app-org=automation_dev_org  cellid=x
      Unable to parse "numsamples" value "x" as int: invalid syntax                                                             selector=api  app-org=automation_dev_org  numsamples=x
