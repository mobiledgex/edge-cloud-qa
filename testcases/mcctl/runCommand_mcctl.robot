...
RunCommand - mcctl shall be able to run command on app 
   ...
   [Template]  Success RunCommand Via mcctl
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation  command=whoami
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation  command=whoami  containerid=x
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation  cluster-org=MobiledgeX  command=whoami
...
RunCommand - mcctl shall handle failures
   ...
   [Template]  Fail RunCommand Via mcctl
      ...
      Error: missing required args:  appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation
      Bad Request (400), App key {"organization":"MobiledgeX","name":"utomation_api_app","version":"1.0"} not found  appname=utomation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation  command=whoami
      ...
      Bad Request (400), App key {"organization":"MobiledgeX","name":"automation_api_app","version":"111.0"} not found  appname=automation_api_app  app-org=MobiledgeX  appvers=111.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation  command=whoami
