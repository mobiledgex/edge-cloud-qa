...
GetCloudletResourceUsage - mcctl shall handle failures
   ...
   [Template]  Fail GetCloudletResourceUsage Via mcctl
      ...
      # missing arguments
      Error: missing required args: cloudletorg cloudlet
      Error: missing required args: cloudlet  cloudletorg=${operator}
      Error: missing required args: cloudletorg  cloudlet=${cloudlet}

      # invalid values
      Error: Bad Request (400), Specified Cloudlet not found  cloudlet=${cloudlet}  cloudletorg=x
      Error: Bad Request (400), Specified Cloudlet not found  cloudlet=x  cloudletorg=${operator}
...
CreateCloudlet with resource quotas - mcctl shall handle failures
   ...
   [Template]  Fail CreateCloudlet Via mcctl
      ...
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for Floating IPs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name="Floating IPs"  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for RAM, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name=RAM  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for vCPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name=vCPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for GPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name=GPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource alert threshold 101 specified, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  defaultresourcealertthreshold=101
      
      #Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for Disk, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name=Disk  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for Instances, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name=Instances  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for Floating IPs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name="Floating IPs"  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for RAM, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name=RAM  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for vCPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name=vCPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for GPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  resourcequotas:0.name=GPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource alert threshold -1 specified, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  location.latitude=10  location.longitude=10  numdynamicips=254  platformtype=PlatformTypeOpenstack  physicalname=packet2  defaultresourcealertthreshold=-1
...
UpdateCloudlet with resource quotas - mcctl shall handle failures for PlatformTypeFake
   ...
   [Template]  Fail UpdateCloudlet Via mcctl
      ...
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for GPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=GPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource alert threshold 101 specified, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  defaultresourcealertthreshold=101

      #Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for Disk, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=Disk  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for External IPs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name="External IPs"  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for RAM, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=RAM  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for vCPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=vCPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for GPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=GPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource alert threshold -1 specified, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  defaultresourcealertthreshold=-1
...
UpdateCloudlet with resource quotas - mcctl shall handle failures for PlatformTypeOpenstack
   ...
   [Template]  Fail UpdateCloudlet Via mcctl
      ...
      #Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for Disk, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=Disk  resourcequotas:0.value=160 resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for Instances, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=Instances  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for Floating IPs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name="Floating IPs"  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for RAM, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=RAM  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for vCPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=vCPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource quota alert threshold 101 specified for GPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=GPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=101
      Error: Bad Request (400), Invalid resource alert threshold 101 specified, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  defaultresourcealertthreshold=101
      ...
      #Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for Disk, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=Disk  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for Instances, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=Instances  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for Floating IPs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name="Floating IPs"  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for RAM, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=RAM  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for vCPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=vCPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource quota alert threshold -1 specified for GPUs, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=GPUs  resourcequotas:0.value=160  resourcequotas:0.alertthreshold=-1
      Error: Bad Request (400), Invalid resource alert threshold -1 specified, valid threshold is in the range of 0 to 100  cloudletorg=${operator}  cloudlet=${cloudlet_name}  defaultresourcealertthreshold=-1
...
UpdateCloudlet with resource quotas - mcctl shall handle failures when quotamaxvalue is lesser than currently used value for PlatformTypeFake
   ...
   [Template]  Fail UpdateCloudlet Via mcctl
      #Error: Bad Request (400), Resource quota value for Disk is less than currently used value. Should be atleast ${disk_used_value}  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=Disk  resourcequotas:0.value=${disk_updated_value}
      Error: Bad Request (400), Resource quota value for RAM is less than currently used value. Should be atleast ${ram_used_value}  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=RAM  resourcequotas:0.value=${ram_updated_value}
      Error: Bad Request (400), Resource quota value for vCPUs is less than currently used value. Should be atleast ${vcpus_used_value}  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=vCPUs  resourcequotas:0.value=${vcpus_updated_value}
      Error: Bad Request (400), Resource quota value for External IPs is less than currently used value. Should be atleast ${external_ips_used_value}  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name="External IPs"  resourcequotas:0.value=${external_ips_updated_value}
...
UpdateCloudlet with resource quotas - mcctl shall handle failures when quotamaxvalue is lesser than currently used value for PlatformTypeOpenstack
   ...
   [Template]  Fail UpdateCloudlet Via mcctl
      ...
      Error: Bad Request (400), Resource quota value for RAM is less than currently used value. Should be atleast ${ram_used_value}  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=RAM  resourcequotas:0.value=${ram_updated_value}
      Error: Bad Request (400), Resource quota value for vCPUs is less than currently used value. Should be atleast ${vcpus_used_value}  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=vCPUs  resourcequotas:0.value=${vcpus_updated_value}
      Error: Bad Request (400), Resource quota value for Instances is less than currently used value. Should be atleast ${instances_used_value}  cloudletorg=${operator}  cloudlet=${cloudlet_name}  resourcequotas:0.name=Instances  resourcequotas:0.value=${instances_updated_value}
...
Metrics Cloudletusage - mcctl shall handle failures
   ...
   [Template]  Fail Metrics CloudletUsage Via mcctl
      ...
      Error: Bad Request (400), Cloudlet details must be present  cloudlet=automationMunichCloudlet selector=flavorusage
      ...
      Error: parsing arg "starttime\=x" failed: unable to parse "x" as time: invalid format, valid values are RFC3339 format, i.e. "2006-01-02T15:04:05Z07:00"      selector=resourceusage cloudletorg=${operator_name_openstack} starttime=x
      Error: parsing arg "endtime\=x" failed: unable to parse "x" as time: invalid format, valid values are RFC3339 format, i.e. "2006-01-02T15:04:05Z07:00"        selector=resourceusage cloudletorg=${operator_name_openstack} endtime=x
...
Update Setup
   ...
   Run Keyword If  '${platform_type}' == 'PlatformTypeFake'  Run mcctl  cloudlet create region=${region} cloudlet=${cloudlet_name} cloudletorg=${operator} location.latitude=10 location.longitude=10 numdynamicips=254 platformtype=${platform_type}
   ...  ELSE  Run mcctl  cloudlet create region=${region} cloudlet=${cloudlet_name} cloudletorg=${operator} location.latitude=10 location.longitude=10 numdynamicips=254 platformtype=${platform_type} physicalname=packet2

   ${cloudlet_resource_usage}=  Run mcctl  cloudlet getresourceusage region=${region} cloudlet=${cloudlet_name} cloudletorg=${operator}
