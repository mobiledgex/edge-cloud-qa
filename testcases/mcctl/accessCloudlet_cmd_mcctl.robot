...
#    ${os_clusterk8sconfigfile}=  Catenate  SEPARATOR=.  ${cluster_name_mcctl_access}  operator_org_name=${operator_name_openstack}  kubeconfig   #cluster-16mcctlaccess.TDG.kubeconfig
