...
# mcctl --addr https://console-qa.mobiledgex.net:443 --skipverify region AccessCloudlet region=EU cloudlet=automationDusseldorfCloudlet cloudlet-org=TDG node-type=sharedrootlb command=ls;exit
...
AccessCloudlet - mcctl shall handle error messages
   ...
   [Template]  Fail AccessCloudlet Command Via mcctl
      ...
      Error: parsing arg "notcloudlet-org\=TDG" failed: invalid argument: key "notcloudlet-org" not found   region=${region_US}  cloudlet=${cloudlet_name_openstack_dedicated}  notcloudlet-org=${operator_name_openstack}   
