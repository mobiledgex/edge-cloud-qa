...
ShowLogs - mcctl shall be able to show logs on app 
   ...
   [Template]  Success ShowLogs Via mcctl
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation 
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  containerid=x
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  since=1985-04-12T23:20:50.52Z
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  since=1m
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  since=1s
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  since=1h
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  timestamps=true
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  timestamps=1
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  timestamps=false
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  timestamps=0
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  tail=1
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  follow=true
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  follow=1
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  follow=false
      appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation  cluster-org=MobiledgeX  follow=0
...
ShowLogs - mcctl shall handle failures
   ...
   [Template]  Fail ShowLogs Via mcctl
      ...
      Bad Request (400), App key {"organization":"MobiledgeX","name":"utomation_api_app","version":"1.0"} not found  appname=utomation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=tmus  cluster=autoclusterautomation
