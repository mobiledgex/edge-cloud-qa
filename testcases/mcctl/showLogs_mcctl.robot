...
ShowLogs - mcctl shall handle failures
   ...
   [Template]  Fail ShowLogs Via mcctl
      ...
      Unable to parse "timestamps" value "s" as bool: invalid syntax, valid values are true, false, 1, 0  appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation  cluster-org=MobiledgeX  timestamps=s
      Unable to parse "timestamps" value "2" as bool: invalid syntax, valid values are true, false, 1, 0  appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation  cluster-org=MobiledgeX  timestamps=2
      ...
      Unable to parse "follow" value "s" as bool: invalid syntax, valid values are true, false, 1, 0  appname=automation_api_app  app-org=MobiledgeX  appvers=1.0  cloudlet=tmocloud-1  cloudlet-org=dmuus  cluster=autoclusterautomation  cluster-org=MobiledgeX  follow=s
