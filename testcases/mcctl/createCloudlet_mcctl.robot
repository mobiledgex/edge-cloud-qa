...
CreateCloudlet - mcctl shall be able to create/show/delete cloudlet
   ...
   [Template]  Success Create/Show/Delete Cloudlet Via mcctl
      ...
      cloudlet=${cloudlet_name}  cloudlet-org=${operator}  location.latitude=1  location.longitude=1  numdynamicips=1  platformtype=PlatformTypeFake  allianceorgs=att allianceorgs=GDDT
...
CreateCloudlet - mcctl shall handle create failures
   ...
   [Template]  Fail Create Cloudlet Via mcctl
      ...
      # trusted
      Error: OK (200), Policy key {"organization":"dmuus","name":"x"} not found  cloudlet=${cloudlet_name}  cloudlet-org=${operator}  location.latitude=1  location.longitude=1  numdynamicips=1  platformtype=PlatformTypeFake  trustpolicy=x
...
UpdateCloudlet - mcctl shall handle update cloudlet 
   ...
   [Template]  Success Update/Show Cloudlet Via mcctl
      ...
      cloudlet=${cloudlet_name}  cloudlet-org=${operator}  allianceorgs=att allianceorgs=GDDT
...
ShowFlavorsFor - mcctl shall handle showflavorsfor
   ...
   ${show3}=  Run mcctl  cloudlet showflavorsfor region=${region} cloudlet-org=dmuus   version=${version}
...
UpdateCloudlet - mcctl shall handle allianceorg clear
   ...
   Run mcctl  cloudlet update region=${region} cloudlet=${cloudlet_name} cloudlet-org=${operator} allianceorgs=att allianceorgs=GDDT  version=${version}
   ${show}=  Run mcctl  cloudlet show region=${region} cloudlet=${cloudlet_name} cloudlet-org=${operator}  version=${version}
