...
ShowOrg - mcctl shall be able to show orgs
   ...
   [Template]  Success ShowOrg Via mcctl
       name_to_check=TDG                 num_results=-1
       name_to_check=TDG                 num_results=1   name=TDG

       name_to_check=tmus                num_results=-1  type=operator
       ...
       name_to_check=TDG                 num_results=-1  publicimages=false

       name_to_check=${None}             num_results=0   deleteinprogress=true
       name_to_check=TDG                 num_results=-1  deleteinprogress=false

       name_to_check=${None}             num_results=-1  edgeboxonly=true
       name_to_check=TDG                 num_results=-1  edgeboxonly=false
