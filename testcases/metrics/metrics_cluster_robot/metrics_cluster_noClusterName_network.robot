*** Settings ***
Documentation   Cluster Network Metrics no cluster name
...
ClusterMetrics - Shall be able to get the cluster Network metrics with cloudlet/operator/developer only 
   [Documentation]
   ...  request all cluster Network metrics with cloudlet/operator/developer only
...
ClusterMetrics - Shall be able to get the cluster Network metrics with cloudlet/developer only
   [Documentation]
   ...  request all cluster Network metrics with cloudlet/developer only
   ...  verify info is correct
