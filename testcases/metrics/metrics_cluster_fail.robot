...
ClusterMetrics - get with invalid start time shall return error
   ...
   Should Contain  ${error}  {"message":"Invalid POST data, parsing time \\\\"\\\\"2019-09-26T04:01:01\\\\"\\\\" into RFC3339 format failed. Example: \\\\"2006-01-02T15:04:05Z07:00\\\\""}
...
ClusterMetrics - get with invalid start/end time shall return error
   ...
   Should Contain  ${error}  {"message":"Invalid POST data, parsing time \\\\"\\\\"x\\\\"\\\\" into RFC3339 format failed. Example: \\\\"2006-01-02T15:04:05Z07:00\\\\""}
...
ClusterMetrics - get with invalid last shall return error
   ...
   Should Contain  ${error}  {"message":"Invalid POST data, code=400, message=Unmarshal type error: expected=int, got=string, field=Last, offset=
...
ClusterMetrics - get with cluster not found shall return an empty list
   ...
   ${metrics}=  Get Cluster Metrics  region=US  selector=cpu  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  cluster_name=xx  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=disk  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  cluster_name=xx  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=tcp  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  cluster_name=xx  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=udp  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  cluster_name=xx  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=network  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  cluster_name=xx  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=mem  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  cluster_name=xx  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}
...
ClusterMetrics - get with cloudlet not found shall return an empty list
   ...
   ${metrics}=  Get Cluster Metrics  region=US  selector=cpu  last=1  cloudlet_name=cloudlet_name_openstack_metrics  cluster_name=autoclusterautomation  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=disk  last=1  cloudlet_name=cloudlet_name_openstack_metrics  cluster_name=autoclusterautomation  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=mem  last=1  cloudlet_name=cloudlet_name_openstack_metrics  cluster_name=autoclusterautomation  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=tcp  last=1  cloudlet_name=cloudlet_name_openstack_metrics  cluster_name=autoclusterautomation  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=udp  last=1  cloudlet_name=cloudlet_name_openstack_metrics  cluster_name=autoclusterautomation  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get Cluster Metrics  region=US  selector=network  last=1  cloudlet_name=cloudlet_name_openstack_metrics  cluster_name=autoclusterautomation  operator_org_name=GDDT  developer_org_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}
