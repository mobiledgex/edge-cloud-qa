...
Metrics Should Match Connected App 
   ...
   #\  @{datesplit}=  Split String  ${reading[0]}  .
      ...
      ${found_histogram}=  Run Keyword If  '${reading[14]}' > '0' and '${reading[15]}' > '0' and '${reading[16]}' > '0' and '${reading[17]}' > '0' and '${reading[18]}' > '0' and '${reading[19]}' > '0' and '${reading[20]}' > '0' and '${reading[21]}' > '0' and '${reading[23]}' > '0' and '${reading[23]}' > '0'  Set Variable  ${True}
