...
Get the last cluster metric on openstack
   ...
   ${metrics}=         Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=1
   ${metrics_influx}=  Run Keyword  Get Influx Cluster ${selector} Metrics  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  condition=GROUP BY cluster ORDER BY DESC LIMIT 1  # last record
...
Get the last 5 cluster metrics on openstack
   ...
   ${metrics}=         Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=5
   ${metrics_influx}=  Run Keyword  Get Influx Cluster ${selector} Metrics  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  condition=GROUP BY * ORDER BY DESC LIMIT 5  # last 5
...
Get the last 10 cluster metrics on openstack
   ...
   ${metrics}=         Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=10
   ${metrics_influx}=  Run Keyword  Get Influx Cluster ${selector} Metrics  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  condition=GROUP BY * ORDER BY DESC LIMIT 10  # last 5
...
Get all cluster metrics on openstack
   ...
   ${metrics}=         Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}
...
Get more cluster metrics than exist on openstack
   ...
   ${metricsall}=  Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}
   ...
   ${metrics}=  Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=${more_readings}
...
Get cluster metrics with starttime on openstack
   ...
   ${metricspre}=   Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=1
   ...
   ${metrics}=   Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet_name_openstack_metrics}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  start_time=${start_date}
...
Get cluster metrics with endtime on openstack
   ...
   ${metricspre}=   Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}
   ...
   ${metrics}=   Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  end_time=${end_date}
   ${num_readings}=  Get Length  ${metrics['data'][0]['Series'][0]['values']}
   @{datesplit_first}=  Split String  ${metrics['data'][0]['Series'][0]['values'][0][0]}  .
   ${epoch_first}=  Convert Date  ${datesplit_first[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
...
Get cluster metrics with starttime=lastrecord on openstack
   ...
   # get readings and 1st and last timestamp
   ${metrics}=   Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  start_time=${metricspre['data'][0]['Series'][0]['values'][0][0]}
   #log to console  ${metrics}
...
Get cluster metrics with starttime > lastrecord on openstack
   ...
   ${metrics}=  Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  start_time=${start_date}
...
Get cluster metrics with endtime=lastrecord on openstack
   ...
   # get all metrics
   ${metrics_all}=  Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}

   # get readings and 1st and last timestamp
   ${metrics}=  Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  end_time=${metricspre['data'][0]['Series'][0]['values'][0][0]}
   log to console  ${metrics}
   @{datesplit_first}=  Split String  ${metrics['data'][0]['Series'][0]['values'][0][0]}  .
   @{datesplit_last}=   Split String  ${metrics['data'][0]['Series'][0]['values'][-1][0]}  .
   ${epoch_first}=  Convert Date  ${datesplit_first[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
...
Get cluster metrics with starttime > endtime on openstack
   ...
   # get readings and with starttime in the future
   ${metrics}=  Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  start_time=${start_date}  end_time=${end_date}
...
Get cluster metrics with starttime and endtime on openstack
   ...
   ${metricspre}=  Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=5
   log to console  ${metricspre['data'][0]}
   @{datesplit}=  Split String  ${metricspre['data'][0]['Series'][0]['values'][0][0]}  .
   ${epochpre}=  Convert Date  ${datesplit[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
...
Get cluster metrics with starttime and endtime and last on openstack
   ...
   # get readings with starttime and endtime
   ${metrics}=  Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  start_time=${start_date}  end_time=${end_date}  last=1
   @{datesplit_first}=  Split String  ${metrics['data'][0]['Series'][0]['values'][0][0]}  .
   @{datesplit_last}=   Split String  ${metrics['data'][0]['Series'][0]['values'][-1][0]}  .
   ${epoch_first}=  Convert Date  ${datesplit_first[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
   ${epoch_last}=   Convert Date  ${datesplit_last[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
...
DeveloperManager shall be able to get cluster metrics
   ...
   Create Org  orgname=${developer}  orgtype=developer
   ...
   ${metrics}=         Get Cluster Metrics  region=US  cluster_instance_name=${cluster}  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=5  token=${userToken}
...
Get cluster metrics with cloudlet/operator/developer only 
   ...
   # get last metric and set starttime = 1 hour earlier
   ${metricspre}=  Get Cluster Metrics  region=US  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=20
   log to console  ${metricspre['data'][0]}
   @{datesplit}=  Split String  ${metricspre['data'][0]['Series'][0]['values'][0][0]}  .
   ${epochpre}=  Convert Date  ${datesplit[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
   log to console  ${epochpre}
   ...
   # get readings with starttime and endtime
   ${metrics}=  Get Cluster Metrics  region=US  cloudlet_name=${cloudlet}  operator_name=${operator}  developer_name=${developer}  selector=${selector}  start_time=${start_date}  end_time=${end_date}  last=20
   #@{datesplit_first}=  Split String  ${metrics['data'][0]['Series'][0]['values'][0][0]}  .
   #@{datesplit_last}=   Split String  ${metrics['data'][0]['Series'][0]['values'][-1][0]}  .
   #${epoch_first}=  Convert Date  ${datesplit_first[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
   #${epoch_last}=   Convert Date  ${datesplit_last[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
...
Get cluster metrics with cloudlet/developer only
   ...
   # get last metric and set starttime = 1 hour earlier
   ${metricspre}=  Get Cluster Metrics  region=US  cloudlet_name=${cloudlet}  developer_name=${developer}  selector=${selector}  last=20
   log to console  ${metricspre['data'][0]}
   @{datesplit}=  Split String  ${metricspre['data'][0]['Series'][0]['values'][0][0]}  .
   ${epochpre}=  Convert Date  ${datesplit[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
   log to console  ${epochpre}
   ...
   # get readings with starttime and endtime
   ${metrics}=  Get Cluster Metrics  region=US  cloudlet_name=${cloudlet}  developer_name=${developer}  selector=${selector}  start_time=${start_date}  end_time=${end_date}  last=20
   #@{datesplit_first}=  Split String  ${metrics['data'][0]['Series'][0]['values'][0][0]}  .
   #@{datesplit_last}=   Split String  ${metrics['data'][0]['Series'][0]['values'][-1][0]}  .
   #${epoch_first}=  Convert Date  ${datesplit_first[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
   #${epoch_last}=   Convert Date  ${datesplit_last[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
...
Get cluster metrics with operator/developer only
   ...
   # get last metric and set starttime = 1 hour earlier
   ${metricspre}=  Get Cluster Metrics  region=US  operator_name=${operator}  developer_name=${developer}  selector=${selector}  last=20
   log to console  ${metricspre['data'][0]}
   @{datesplit}=  Split String  ${metricspre['data'][0]['Series'][0]['values'][0][0]}  .
   ${epochpre}=  Convert Date  ${datesplit[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
   log to console  ${epochpre}
   ...
   # get readings with starttime and endtime
   ${metrics}=  Get Cluster Metrics  region=US  operator_name=${operator}  developer_name=${developer}  selector=${selector}  start_time=${start_date}  end_time=${end_date}  last=20
   #@{datesplit_first}=  Split String  ${metrics['data'][0]['Series'][0]['values'][0][0]}  .
   #@{datesplit_last}=   Split String  ${metrics['data'][0]['Series'][0]['values'][-1][0]}  .
   #${epoch_first}=  Convert Date  ${datesplit_first[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
   #${epoch_last}=   Convert Date  ${datesplit_last[0]}  result_format=epoch  date_format=%Y-%m-%dT%H:%M:%S
