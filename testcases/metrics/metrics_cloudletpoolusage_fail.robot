...
CloudletPoolUsage - get with no cloudletpool shall return error
   ...
   ${error}=  Run Keyword and Expect Error  *  Get Cloudlet Pool Usage  region=US  operator_org_name=dmuus  start_time=2006-01-02T15:04:05Z  end_time=2006-01-02T15:04:05Z  token=${token}  use_defaults=${False}
   Should Be Equal  ${error}  ('code=400', 'error={"message":"CloudletPool details must be present"}')
...
CloudletPoolUsage - developer get with no cloudletpool shall return error
   ...
   ${error}=  Run Keyword and Expect Error  *  Get Cloudlet Pool Usage  region=US  operator_org_name=dmuus  start_time=2006-01-02T15:04:05Z  end_time=2006-01-02T15:04:05Z  token=${dev_manager_token}  use_defaults=${False}
   Should Be Equal  ${error}  ('code=400', 'error={"message":"CloudletPool details must be present"}')
...
CloudletPoolUsage - operator get with no cloudletpool shall return error
   ...
   ${error}=  Run Keyword and Expect Error  *  Get Cloudlet Pool Usage  region=US  operator_org_name=dmuus  start_time=2006-01-02T15:04:05Z  end_time=2006-01-02T15:04:05Z  token=${op_manager_token}  use_defaults=${False}
   Should Be Equal  ${error}  ('code=400', 'error={"message":"CloudletPool details must be present"}')

   ${error}=  Run Keyword and Expect Error  *  Get Cloudlet Pool Usage  region=US  cloudlet_pool_name=dmuus  start_time=2006-01-02T15:04:05Z  end_time=2006-01-02T15:04:05Z  token=${op_manager_token}  use_defaults=${False}
   Should Be Equal  ${error}  ('code=400', 'error={"message":"CloudletPool details must be present"}')
