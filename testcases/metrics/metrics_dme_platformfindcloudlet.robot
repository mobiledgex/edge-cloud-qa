...
Setup
   ...
   Create App        region=${region}  access_ports=tcp:1  official_fqdn=${platos_uri}
   ${dmuus_appinst}=  Create App Instance  region=${region}  cloudlet_name=${cloudlet_name}  operator_org_name=${operator_name_fake}  cluster_instance_name=autocluster
