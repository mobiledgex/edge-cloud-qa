...
${operator}=                       packet
${clustername_k8shared}=   k8sshared
...
*** Test Cases ***
ClusterMetrics - k8s Shared Cluster NETWORK metric on openstack
   [Documentation]
...
ClusterMetrics - last 5 k8s Shared Cluster NETWORK metric on openstack
   [Documentation]
...
Setup
   ...
   ${clustername_k8shared}=  set variable  k8sshared
