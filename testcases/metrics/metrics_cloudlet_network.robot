...
Metrics - Shall be able to get the last 5 network metrics on buckhorn openstack
   [Documentation]
   ...  create a new user with various name
   ...  get user/current info
   ...  verify info is correct
...
Metrics - Shall be able to get the last 100 network metrics on buckhorn openstack
   [Documentation]
   ...  create a new user with various name
   ...  get user/current info
   ...  verify info is correct
...
Metrics - Shall be able to get all network metrics on buckhorn openstack
   [Documentation]
   ...  create a new user with various name
   ...  get user/current info
   ...  verify info is correct
...
Metrics - Shall be able to request more network metrics than exist on buckhorn openstack
   [Documentation]
   ...  create a new user with various name
   ...  get user/current info
   ...  verify info is correct
...
Metrics - Shall be able to get the network metrics with starttime on buckhorn openstack
   [Documentation]
   ...  create a new user with various name
   ...  get user/current info
   ...  verify info is correct
