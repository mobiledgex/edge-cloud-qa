...
ClusterMetrics - Shall be able to get the last k8s shared cluster Memory metric on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last cluster metric on openstack   ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the last 5 k8s shared cluster Memory metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last 5 cluster metrics on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the last 10 k8s shared cluster Memory metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last 10 cluster metrics on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get all k8s shared cluster Memory metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get all cluster metrics on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to request more k8s shared cluster Memory metrics than exist on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get more cluster metrics than exist on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get k8s shared cluster Memory metrics with starttime on openstack
   ...
   ${metrics}=  Get cluster metrics with starttime on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get k8s shared cluster Memory metrics with endtime on openstack
   ...
   ${metrics}=  Get cluster metrics with endtime on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the k8s shared cluster Memory metrics with starttime=lastrecord on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get cluster metrics with starttime=lastrecord on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
#
#   Get cluster metrics with starttime > lastrecord on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the k8s shared cluster Memory metrics with endtime=lastrecord on openstack
   ...
   ${metrics}=  Get cluster metrics with endtime=lastrecord on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the k8s shared cluster Memory metrics with endtime = firstrecord on openstack
   ...
   Get cluster metrics with endtime = firstrecord on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the k8s shared cluster Memory metrics with starttime > endtime on openstack
   ...
   Get cluster metrics with starttime > endtime on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the k8s shared cluster Memory metrics with starttime and endtime > lastrecord on openstack
   ...
   Get cluster metrics with starttime and endtime > lastrecord on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the k8s shared cluster Memory metrics with starttime and endtime on openstack
   ...
   ${metrics}=  Get cluster metrics with starttime and endtime on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - Shall be able to get the k8s shared cluster Memory metrics with starttime and endtime and last on openstack
   ...
   ${metrics}=  Get cluster metrics with starttime and endtime and last on openstack     ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - DeveloperManager shall be able to get k8s shared cluster Memory metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperManager shall be able to get cluster metrics  ${username}  ${password}  ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - DeveloperContributor shall be able to get k8s shared cluster Memory metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperContributor shall be able to get cluster metrics  ${username}  ${password}  ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
...
ClusterMetrics - DeveloperViewer shall be able to get k8s shared cluster Memory metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperViewer shall be able to get cluster metrics  ${username}  ${password}  ${clustername_k8shared}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem
