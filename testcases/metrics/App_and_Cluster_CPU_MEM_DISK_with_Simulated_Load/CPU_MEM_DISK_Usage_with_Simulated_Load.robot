...
Create Cluster and App Instnce
  ...
  ${handle1}=  create cluster instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_dedicated}  cluster_name=${cluster_name_1}  operator_org_name=${operator_name_openstack_tdg}  flavor_name=${default_flavor_name}  ip_access=IpAccessDedicated  deployment=docker  token=${user_token}  use_thread=${True}
  ${handle2}=  create cluster instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_dedicated}  cluster_name=${cluster_name_2}  operator_org_name=${operator_name_openstack_tdg}  flavor_name=${default_flavor_name}  ip_access=IpAccessShared  deployment=docker  token=${user_token}  use_thread=${True}
  ${handle3}=  create cluster instance  region=${region}  cloudlet_name=${cloudlet_name_openstack_dedicated}  cluster_name=${cluster_name_3}  operator_org_name=${operator_name_openstack_tdg}  flavor_name=${default_flavor_name}  ip_access=IpAccessDedicated  deployment=kubernetes  token=${user_token}  use_thread=${True}
  ...
  ${handle1}=  create app instance  region=${region}  app_name=${app_name_1}  app_version=v1  cloudlet_name=${cloudlet_name_openstack_dedicated}  cluster_instance_name=${cluster_name_1}   developer_org_name=${orgname}  operator_org_name=${operator_name_openstack_tdg}  token=${user_token}  use_thread=${True}
  ${handle2}=  create app instance  region=${region}  app_name=${app_name_2}  app_version=v1  cloudlet_name=${cloudlet_name_openstack_dedicated}  cluster_instance_name=${cluster_name_2}   developer_org_name=${orgname}  operator_org_name=${operator_name_openstack_tdg}  token=${user_token}  use_thread=${True}
  ${handle3}=  create app instance  region=${region}  app_name=${app_name_3}  app_version=v1  cloudlet_name=${cloudlet_name_openstack_dedicated}  cluster_instance_name=${cluster_name_3}   developer_org_name=${orgname}  operator_org_name=${operator_name_openstack_tdg}  token=${user_token}  use_thread=${True}
...
Docker Dedicated App Instance CPU Usage
  [Documentation]
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_1}  ${app_name_influx_1}  ${cluster_name_1}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  cpu
   log  ${metrics}
...
Docker Dedicated App Instance MEM Usage
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_1}  ${app_name_influx_1}  ${cluster_name_1}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  mem
   log  ${metrics}
...
Docker Dedicated App Instance DISK Usage
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_1}  ${app_name_influx_1}  ${cluster_name_1}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  disk
   log  ${metrics}
...
Docker Shared App Instance CPU Usage
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_2}  ${app_name_influx_2}  ${cluster_name_2}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  cpu
   log  ${metrics}
...
Docker Shared App Instance MEM Usage
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_2}  ${app_name_influx_2}  ${cluster_name_2}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  mem
   log  ${metrics}
...
Docker Shared App Instance DISK Usage
  ...
  [Documentation]
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_2}  ${app_name_influx_2}  ${cluster_name_2}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  disk
   log  ${metrics}
...
k8s Dedicated App Instance CPU Usage
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_3}  ${app_name_influx_3}  ${cluster_name_3}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  cpu
   log  ${metrics}
...
k8s Dedicated App Instance MEM Usage
  ...
  [Documentation]
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_3}  ${app_name_influx_3}  ${cluster_name_3}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  mem
   log  ${metrics}
...
k8s Dedicated App Instance DISK Usage
  ...
  [Documentation]
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name_3}  ${app_name_influx_3}  ${cluster_name_3}  ${cloudlet_name_openstack_dedicated}  ${operator_name_openstack_tdg}  ${orgname}  disk
   log  ${metrics}
