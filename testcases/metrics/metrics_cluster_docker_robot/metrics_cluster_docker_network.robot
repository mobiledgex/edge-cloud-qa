...
ClusterMetrics - Shall be able to get the last docker cluster Network metric on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last cluster metric on openstack   ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the last 5 docker cluster Network metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last 5 cluster metrics on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the last 10 docker cluster Network metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last 10 cluster metrics on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get all docker cluster Network metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get all cluster metrics on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to request more docker cluster Network metrics than exist on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get more cluster metrics than exist on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get docker cluster Network metrics with starttime on openstack
   ...
   ${metrics}=  Get cluster metrics with starttime on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get docker cluster Network metrics with endtime on openstack
   ...
   ${metrics}=  Get cluster metrics with endtime on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the docker cluster Network metrics with starttime=lastrecord on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get cluster metrics with starttime=lastrecord on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the docker cluster Network metrics with endtime=lastrecord on openstack
   ...
   ${metrics}=  Get cluster metrics with endtime=lastrecord on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the docker cluster Network metrics with endtime = firstrecord on openstack
   ...
   Get cluster metrics with endtime = firstrecord on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the docker cluster Network metrics with starttime > endtime on openstack
   ...
   Get cluster metrics with starttime > endtime on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the docker cluster Network metrics with starttime and endtime > lastrecord on openstack
   ...
   Get cluster metrics with starttime and endtime > lastrecord on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the docker cluster Network metrics with starttime and endtime on openstack
   ...
   ${metrics}=  Get cluster metrics with starttime and endtime on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - Shall be able to get the docker cluster Network metrics with starttime and endtime and last on openstack
   ...
   ${metrics}=  Get cluster metrics with starttime and endtime and last on openstack     ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - DeveloperManager shall be able to get docker cluster Network metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperManager shall be able to get cluster metrics  ${username}  ${password}  ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - DeveloperContributor shall be able to get docker cluster Network metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperContributor shall be able to get cluster metrics  ${username}  ${password}  ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
...
ClusterMetrics - DeveloperViewer shall be able to get docker cluster Network metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperViewer shall be able to get cluster metrics  ${username}  ${password}  ${clustername_docker}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
