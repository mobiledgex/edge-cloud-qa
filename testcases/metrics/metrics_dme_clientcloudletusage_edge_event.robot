...
Setup
    ...
    Should Be Equal  ${lu.new_cloudlet.fqdn}  shared.tmocloud-2-tmus.us.mobiledgex.net
    ...
    Should Be Equal  ${lu4.new_cloudlet.fqdn}  shared.tmocloud-2-tmus.us.mobiledgex.net
