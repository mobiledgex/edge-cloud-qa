...
DMEMetrics - VerifyLocation with error shall generate metrics
   ...
   Run Keyword and Expect Error  *  Verify Location  carrier_name=${tmus_operator_name}  latitude=5  longitude=-5  token=${Empty}

   MexDmeRest.Get Token

   Run Keyword and Expect Error  *  Verify Location  carrier_name=${tmus_operator_name}  latitude=135  longitude=-94 
   Run Keyword and Expect Error  *  Verify Location  carrier_name=${tmus_operator_name}  latitude=35  longitude=-194
   Run Keyword and Expect Error  *  Verify Location  carrier_name=${tmus_operator_name}  latitude=135  longitude=-194
   Run Keyword and Expect Error  *  Verify Location  carrier_name=${tmus_operator_name} 
