...
ClusterMetrics - Shall be able to get the cluster TCP metrics with cloudlet/operator/developer only
   ...
   ${metrics}=  Get cluster metrics with cloudlet/operator/developer only  ${cloudlet_name_openstack_metrics}  ${operator}  ${developer_name}  tcp 
...
ClusterMetrics - Shall be able to get the cluster TCP metrics with operator/developer only
   ...
   ${metrics}=  Get cluster metrics with operator/developer only  ${operator}  ${developer_name}  tcp 
