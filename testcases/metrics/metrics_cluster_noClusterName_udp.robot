...
ClusterMetrics - Shall be able to get the cluster UDP metrics with cloudlet/operator/developer only
   ...
   ${metrics}=  Get cluster metrics with cloudlet/operator/developer only  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  udp 
...
ClusterMetrics - Shall be able to get the cluster UDP metrics with operator/developer only
   ...
   ${metrics}=  Get cluster metrics with operator/developer only  ${operator_name_openstack}  ${developer_name}  udp 
...
# ECQ-2026
ClusterMetrics - Shall be able to get the cluster UDP metrics with developer only
   [Documentation]
   ...  request all cluster UDP metrics with developer only
   ...  verify info is correct

   ${metrics}=  Get cluster metrics with developer only  ${developer_name}  udp
...
ClusterMetrics - Shall be able to get all cluster UDP metrics with developer only
   ...
   ${metrics}=  Get all cluster metrics with developer only  ${developer_name}  udp  ${num_metrics}
   ...
   ${metrics}=  Get all cluster metrics with developer only  ${developer_name}  udp  10000
