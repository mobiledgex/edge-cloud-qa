*** Settings ***
Documentation   Cloudlet Utilization Metrics forbidden for Developer/Operator
...
*** Test Cases ***
CloudletMetrics - DeveloperManager shall not be able to get cloudlet utilization metrics
   [Documentation]
...
CloudletMetrics - DeveloperContributor shall not be able to get cloudlet utilization metrics
   [Documentation]
...
CloudletMetrics - DeveloperViewer shall not be able to get cloudlet utilization metrics
   [Documentation]
...
CloudletMetrics - OperatorManager shall not be able to get cloudlet utilization metrics from another operator
   [Documentation]
   ...  request the cloudlet utilization metrics as OperatorManager for another operator
   ...  verify forbidden is returned
...
CloudletMetrics - OperatorContributor shall not be able to get cloudlet utilization metrics from another operator
   [Documentation]
   ...  request the cloudlet utilization metrics as OperatorContributor for another operator
   ...  verify forbidden is returned
...
CloudletMetrics - OperatorViewer shall not be able to get cloudlet utilization metrics from another operator
   [Documentation]
   ...  request the cloudlet utilization metrics as OperatorViewer for another operator
   ...  verify forbidden is returned
