*** Settings ***
Documentation   App Memory Metrics with no app name
...
*** Test Cases ***
# ECQ-1980
AppMetrics - Shall be able to get the app Memory metrics with cloudlet/operator/developer only
   [Documentation]
   ...  request all app Memory metrics with cloudlet/operator/developer on openstack
   ...  verify info is correct

   ${metrics}=  Get app metrics with cloudlet/operator/developer only  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  mem 
...
# ECQ-1981
AppMetrics - Shall be able to get the app Memory metrics with cloudlet/developer only
   [Documentation]
   ...  request all app Memory metrics with cloudlet/developer on openstack
   ...  verify info is correct

   ${metrics}=  Get app metrics with cloudlet/developer only  ${cloudlet_name_openstack_metrics}  ${developer_name}  mem 
...
# ECQ-1982
AppMetrics - Shall be able to get the app Memory metrics with operator/developer only
   [Documentation]
   ...  request all app Memory metrics with operator/developer only
   ...  verify info is correct

   ${metrics}=  Get app metrics with operator/developer only  ${operator_name_openstack}  ${developer_name}  mem 
...
# ECQ-1983
AppMetrics - Shall be able to get the app Memory metrics with developer only
   [Documentation]
   ...  request all app Memory metrics with developer only
   ...  verify info is correct

   ${metrics}=  Get app metrics with developer only  ${developer_name}  mem
...
AppMetrics - Shall be able to get all app Memory metrics with developer only
   ...
   ${metrics}=  Get all app metrics with developer only  ${developer_name}  mem  1000 
...
# ECQ-3890
AppMetrics - Shall be able to get all app Memory metrics with developer/clusterorg only
   [Documentation]
   ...  - request all app Memory metrics with developer/clusterorg only
   ...  - verify info is correct

   ${metrics}=  Get all app metrics with developer/clusterorg only  ${developer_name}  ${clusterorg}  mem
