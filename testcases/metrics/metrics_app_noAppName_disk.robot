*** Settings ***
Documentation   App Disk Metrics with no app name
...
AppMetrics - Shall be able to get the app Disk metrics with cloudlet/developer only
   ...
   ${metrics}=  Get app metrics with cloudlet/developer only  ${cloudlet_name_openstack_metrics}  ${developer_name}  disk 
...
AppMetrics - Shall be able to get the app Disk metrics with developer only
   ...
   ${metrics}=  Get app metrics with developer only  ${developer_name}  disk
...
AppMetrics - Shall be able to get all app Disk metrics with developer only
   ...
   ${metrics}=  Get all app metrics with developer only  ${developer_name}  disk  ${num_metrics}
   ...
   ${metrics}=  Get all app metrics with developer only  ${developer_name}  disk  1000
...
# ECQ-3889
AppMetrics - Shall be able to get all app Disk metrics with developer/clusterorg only
   [Documentation]
   ...  - request all app Disk metrics with developer/clusterorg only
   ...  - verify info is correct

   ${metrics}=  Get all app metrics with developer/clusterorg only  ${developer_name}  ${clusterorg}  disk
