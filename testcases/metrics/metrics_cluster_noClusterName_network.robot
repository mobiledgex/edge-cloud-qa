*** Settings ***
Documentation   Cluster Network Metrics with no cluster name
...
ClusterMetrics - Shall be able to get the cluster Network metrics with cloudlet/operator/developer only
   ...
   ${metrics}=  Get cluster metrics with cloudlet/operator/developer only  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network 
...
ClusterMetrics - Shall be able to get the cluster Network metrics with operator/developer only
   ...
   ${metrics}=  Get cluster metrics with operator/developer only  ${operator_name_openstack}  ${developer_name}  network 
...
ClusterMetrics - Shall be able to get all cluster Network metrics with developer only
   ...
   ${metrics}=  Get all cluster metrics with developer only  ${developer_name}  network  ${num_metrics}
