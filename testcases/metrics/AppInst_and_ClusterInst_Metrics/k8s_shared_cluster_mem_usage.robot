*** Settings ***
Documentation   K8s Dedicated Cluster MEM Metrics
...
*** Test Cases ***
ClusterMetrics - k8s Dedicated Cluster MEM metric on openstack
   [Documentation]
...
ClusterMetrics - last 5 k8s Dedicated Cluster MEM metrics on openstack
   [Documentation]
...
Setup
   ...
   ${clustername_k8dedicated}=  set variable  k8sshared
