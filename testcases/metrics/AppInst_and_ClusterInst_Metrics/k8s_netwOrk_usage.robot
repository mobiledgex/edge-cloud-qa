...
${operator}=                       packet
${clustername_k8sdedicated}=   k8monitoring
...
*** Test Cases ***
k8s Dedicated AppInstMetrics - NETWORK metric on openstack
   [Documentation]
...
k8s Dedicated AppInstMetrics - last 5 NETWORK usage metrics on openstack
   [Documentation]
