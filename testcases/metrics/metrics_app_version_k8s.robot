...
Setup
   ...
   Create App  region=${region}  app_name=${app_name}  app_version=${app_version2}  default_flavor_name=${flavor_name}  deployment=kubernetes  image_path=${docker_image}  access_ports=tcp:2017,udp:2018
