...
Setup
    ...
    Should Be Equal  ${cloudlet2.fqdn}  tmocloud-1.dmuus.mobiledgex.net
    ...
    Should Be Equal  ${cloudlet3.fqdn}  tmocloud-2.dmuus.mobiledgex.net
    ...
    Should Be Equal  ${lu3.new_cloudlet.fqdn}  tmocloud-1.dmuus.mobiledgex.net
