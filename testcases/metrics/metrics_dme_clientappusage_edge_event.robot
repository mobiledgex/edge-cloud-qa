...
Setup
    ...
    @{collection_intervals}=  Create List  15s  2m10s  3m10s
    ...
    Should Be Equal  ${cloudlet1.fqdn}  shared.${cloudlet_name}-tmus.us.mobiledgex.net
    ...
    Should Be Equal  ${cloudlet2.fqdn}  shared.${cloudlet_name}-tmus.us.mobiledgex.net
    ...
    Should Be Equal  ${cloudlet3.fqdn}  shared.${cloudlet2_name}-tmus.us.mobiledgex.net
    ...
    Should Be Equal  ${lu.new_cloudlet.fqdn}  shared.${cloudlet2_name}-tmus.us.mobiledgex.net
    ...
    Should Be Equal  ${lu3.new_cloudlet.fqdn}  shared.${cloudlet_name}-tmus.us.mobiledgex.net
    ...
    Should Be Equal  ${lu4.new_cloudlet.fqdn}  shared.${cloudlet2_name}-tmus.us.mobiledgex.net
...
Teardown Settings
   ...
   Update Settings  region=${region}  edge_events_metrics_collection_interval=${settings['edge_events_metrics_collection_interval']}  edge_events_metrics_continuous_queries_collection_intervals=@{collection_intervals}
