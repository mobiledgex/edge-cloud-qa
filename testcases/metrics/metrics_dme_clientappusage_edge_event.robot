...
Setup
    ...
    Should Be Equal  ${cloudlet2.fqdn}  shared.${cloudlet_name}-dmuus.${region_lc}.mobiledgex.net
    ...
    Should Be Equal  ${cloudlet3.fqdn}  shared.${cloudlet2_name}-dmuus.${region_lc}.mobiledgex.net
    ...
    Should Be Equal  ${lu.new_cloudlet.fqdn}  shared.${cloudlet2_name}-dmuus.${region_lc}.mobiledgex.net
    ...
    Should Be Equal  ${lu3.new_cloudlet.fqdn}  shared.${cloudlet_name}-dmuus.${region_lc}.mobiledgex.net
    ...
    Should Be Equal  ${lu4.new_cloudlet.fqdn}  shared.${cloudlet2_name}-dmuus.${region_lc}.mobiledgex.net
