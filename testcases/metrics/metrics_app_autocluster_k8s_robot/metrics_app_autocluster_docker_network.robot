...
AppMetrics - Shall be able to get all docker autoluster app Network metrics
   ...
   ${metrics}  ${metrics_influx}=  Get all app metrics on openstack     ${app_name}  ${app_name_influx}  ${realclustername_k8s}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  network
