...
AppMetrics - Shall be able to get the last k8s dedicated app Disk metric on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last app metric on openstack   ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the last 5 k8s dedicated app Disk metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last 5 app metrics on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the last 10 k8s dedicated app Disk metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get the last 10 app metrics on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get all k8s dedicated app Disk metrics on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get all app metrics on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to request more k8s dedicated app Disk metrics than exist on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get more app metrics than exist on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get k8s dedicated app Disk metrics with starttime on openstack
   ...
   ${metrics}=  Get app metrics with starttime on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get k8s dedicated app Disk metrics with endtime on openstack
   ...
   ${metrics}=  Get app metrics with endtime on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the k8s dedicated app Disk metrics with starttime=lastrecord on openstack
   ...
   ${metrics}  ${metrics_influx}=  Get app metrics with starttime=lastrecord on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the k8s dedicated app Disk metrics with starttime > lastrecord on openstack
   ...
   Get app metrics with starttime > lastrecord on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the k8s dedicated app Disk metrics with endtime=lastrecord on openstack
   ...
   ${metrics}=  Get app metrics with endtime=lastrecord on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the k8s dedicated app Disk metrics with endtime = firstrecord on openstack
   ...
   Get app metrics with endtime = firstrecord on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the k8s dedicated app Disk metrics with starttime > endtime on openstack
   ...
   Get app metrics with starttime > endtime on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the k8s dedicated app Disk metrics with starttime and endtime > lastrecord on openstack
   ...
   Get app metrics with starttime and endtime > lastrecord on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the k8s dedicated app Disk metrics with starttime and endtime on openstack
   ...
   ${metrics}=  Get app metrics with starttime and endtime on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - Shall be able to get the k8s dedicated app Disk metrics with starttime and endtime and last on openstack
   ...
   ${metrics}=  Get app metrics with starttime and endtime and last on openstack     ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - DeveloperManager shall be able to get k8s dedicated app Disk metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperManager shall be able to get app metrics  ${username}  ${password}  ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - DeveloperContributor shall be able to get k8s dedicated app Disk metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperContributor shall be able to get app metrics  ${username}  ${password}  ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
...
AppMetrics - DeveloperViewer shall be able to get k8s dedicated app Disk metrics
   ...
   ${metrics}  ${metrics_influx}=  DeveloperViewer shall be able to get app metrics  ${username}  ${password}  ${app_name}  ${app_name_influx}  ${clustername_k8sdedicated}  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk
