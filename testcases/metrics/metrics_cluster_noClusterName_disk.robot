...
ClusterMetrics - Shall be able to get the cluster Disk metrics with cloudlet/operator/developer only
   ...
   ${metrics}=  Get cluster metrics with cloudlet/operator/developer only  ${cloudlet_name_openstack_metrics}  ${operator_name_openstack}  ${developer_name}  disk 
...
ClusterMetrics - Shall be able to get the cluster Disk metrics with operator/developer only
   ...
   ${metrics}=  Get cluster metrics with operator/developer only  ${operator_name_openstack}  ${developer_name}  disk 
