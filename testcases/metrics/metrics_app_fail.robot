...
AppMetrics - get with cluster not found shall return an empty list
   ...
   ${metrics}=  Get App Metrics  region=US  selector=cpu  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  app_name=automation_api_app  app_version=1.0  cluster_instance_name=xx  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=disk  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  app_name=automation_api_app  app_version=1.0  cluster_instance_name=xx  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=mem  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  app_name=automation_api_app  app_version=1.0  cluster_instance_name=xx  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=connections  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  cluster_instance_name=xx  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=network  last=1  cloudlet_name=${cloudlet_name_openstack_metrics}  cluster_instance_name=xx  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}
...
AppMetrics - get with cloudlet not found shall return an empty list
   ...
   ${metrics}=  Get App Metrics  region=US  selector=cpu  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=automation_api_app  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=disk  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=automation_api_app  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=mem  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=automation_api_app  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=connections  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=automation_api_app  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=network  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=automation_api_app  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}
...
AppMetrics - get with appname not found shall return an empty list
   ...
   ${metrics}=  Get App Metrics  region=US  selector=cpu  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=xx  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=disk  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=xx  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=mem  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=xx  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=connections  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=xx  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}

   ${metrics}=  Get App Metrics  region=US  selector=network  last=1  cloudlet_name=cloudlet_name_openstack_metrics  app_name=xx  app_version=1.0  cluster_instance_name=autoclusterautomation  operator_name=TDG  developer_name=mobiledgex  token=${token}  use_defaults=${False}
   Should Be Equal  ${metrics['data'][0]['Series']}        ${None}
   Should Be Equal  ${metrics['data'][0]['Messages']}      ${None}
