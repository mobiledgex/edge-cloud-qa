package com.mobiledgex.sdkexerciser2;
...
/*
edgectl controller --addr mexdemo-us.ctrl.mobiledgex.net:55001 --tls ~/mex-ca.crt CreateApp appname=automation-sdk-docker-app3 app-org=MobiledgeX appvers=1.0 imagepath=docker.mobiledgex.net/adevorg/images/server-ping-threaded:6.0 accessports=tcp:1234,udp:1,tcp:1-5:tls,tcp:8080 deployment=docker defaultflavor=x1.medium androidpackagename=com.mobiledgex.sdkexerciser2 officialfqdn=stackoverflow2.com
edgectl controller --addr mexdemo-us.ctrl.mobiledgex.net:55001 --tls ~/mex-ca.crt CreateAppInst appname=automation-sdk-docker-app3 app-org=MobiledgeX appvers=1.0 cloudlet=telusfake cloudlet-org=TELUS  cluster-org=MobiledgeX cluster=autoclustersdkdocker3
...
public class MainActivity extends AppCompatActivity {
    ...
    private String appName = "automation-sdk-docker-app3";
    ...
    private String uuidType = "Samsung:SamsungEnablingLayer";

    public static String foundCloudletFqdn = "autoclustersdkdocker3.telusfake.telus.mobiledgex.net";
    public static String officialFqdn = "stackoverflow2.com";
...
*/
                    ...
                    case "VerifyLocationSuccess":
                        ...
                        tcPassed = verifyLocation(location, "TDG");
                        break;

                    //case "RegisterAndFindCloudlet":
                    //    tcPassed = registerAndFindCloudlet("MobiledgeX SDK Demo", "MobiledgeX", "2.0", "TDG", location);
                    //    break;
    ...
    private boolean runRegisterClientTest() {
        try {
            ...
            if (!claimJson.get("orgname").getAsString().equals(organizationName)) throw new AssertionError("claim orgname does not patch");
    ...
    private boolean runFindCloudletTestMelEnabled(Location location, String testcaseName) {
        ...
        try {
            ...
            throw new AssertionError("caught UnknownHostException:" + var6.getLocalizedMessage());
        }
        if (null == reply) throw new AssertionError("FindCloudlet is null");

        if (!reply.getFqdn().equals(officialFqdn)) throw new AssertionError("App's expected test cloudlet FQDN doesn't match.");
