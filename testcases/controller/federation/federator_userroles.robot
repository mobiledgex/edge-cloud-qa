...
OperatorContributor shall be able to create/update/generateapikey/delete/view federator
    ...
    Create Federator  region=${region}  operatorid=tmus  countrycode=${countrycode}  mcc=${mcc}  mnc=${mnc}  federationid=${federationid}  token=${op1_token}    auto_delete=${False}

    Append to List  ${mnc}  102
    Update Federator  operatorid=tmus  mcc=${mcc}  mnc=${mnc}  federationid=${federationid}  token=${op1_token}  

    GenerateSelfApiKey Federator  operatorid=tmus  federationid=${federationid}  token=${op1_token}

    ${show}=  Show Federator  operatorid=tmus  federationid=${federationid}  token=${op1_token}
    Should Not Be Empty  ${show}

    Delete Federator  operatorid=tmus  federationid=${federationid}  token=${op1_token}
...
OperatorViewer shall not be able to create/update/generateapikey/delete federator
    ...
    ${federator}=  Create Federator  region=${region}  operatorid=tmus  countrycode=${countrycode}  mcc=${mcc}  mnc=${mnc}  federationid=${federationid}   
    ...
    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Create Federator  region=${region}  operatorid=tmus  countrycode=${countrycode}  mcc=${mcc}  mnc=${mnc}  token=${op1_token}  

    Append to List  ${mnc}  102
    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Update Federator  operatorid=tmus  mcc=${mcc}  mnc=${mnc}  federationid=${federationid}  token=${op1_token}  

    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  GenerateSelfApiKey Federator  operatorid=tmus  federationid=${federationid}  token=${op1_token}

    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Delete Federator  operatorid=tmus  federationid=${federationid}  token=${op1_token}
