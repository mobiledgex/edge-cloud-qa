...
MC - Admin shall be able to see orgcloudlet info
    ...
    ${info}=  Show Org Cloudlet Info  region=US  operator_org_name=GDDT
...
Developer shall not be able to see orgcloudletinfo data
    ...
    Run Keyword And Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Show Org Cloudlet Info  region=US  operator_org_name=GDDT
