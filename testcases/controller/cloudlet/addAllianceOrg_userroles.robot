...
AddAllianceOrg - OperatorManager shall be able to add/remove alliance org
   ...
   Add Cloudlet Alliance Org  region=${region}  cloudlet_name=${cloudlet['data']['key']['name']}  operator_org_name=${operator_name_fake}  alliance_org_name=dmuus  token=${user_token}
   Remove Cloudlet Alliance Org  region=${region}  cloudlet_name=${cloudlet['data']['key']['name']}  operator_org_name=${operator_name_fake}  alliance_org_name=dmuus  token=${user_token}
...
Forbidden Add/Remove Alliance Org 
   ...
   Run Keyword And Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Add Cloudlet Alliance Org  region=${region}  cloudlet_name=${cloudlet['data']['key']['name']}  operator_org_name=${operator_name_fake}  alliance_org_name=dmuus  token=${user_token}
   Run Keyword And Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Remove Cloudlet Alliance Org  region=${region}  cloudlet_name=${cloudlet['data']['key']['name']}  operator_org_name=${operator_name_fake}  alliance_org_name=dmuus  token=${user_token}
