...
DeleteCloudlet without a cloudlet name
	...
	Should Contain  ${error_msg}   status = StatusCode.UNKNOWN
	Should Contain  ${error_msg}   details = "Cloudlet key {"organization":"tmus"} not found" 
...
DeleteCloudlet with an invalid cloudlet name
	...
	Should Contain  ${error_msg}   status = StatusCode.UNKNOWN
	Should Contain  ${error_msg}   details = "Cloudlet key {"organization":"tmus","name":"Test"} not found"
