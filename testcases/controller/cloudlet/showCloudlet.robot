...
ShowCloudlets all
	...
	${list}=  Show Cloudlets
	Cloudlet Should Exist   operator_org_name=${oper}   cloudlet_name=${cldlet}   latitude=35     longitude=-96  notify_server_address=${port}
...
ShowCloudlets selected
	...
	${list}=  Show Cloudlets	  operator_org_name=${oper}   cloudlet_name=${cldlet}      
	Cloudlet Should Exist   operator_org_name=${oper}   cloudlet_name=${cldlet}  latitude=35     longitude=-96   notify_server_address=${port}
...
ShowCloudlets invalid
	...
	${list}=  Show Cloudlets	  operator_org_name=${oper}    cloudlet_name=ShowMe  latitude=35     longitude=-96 
...
Setup
	...
	Create Cloudlet     operator_org_name=${oper}   cloudlet_name=${cldlet}     number_of_dynamic_ips=${dips}    latitude=35     longitude=-96  notify_server_address=${port}
