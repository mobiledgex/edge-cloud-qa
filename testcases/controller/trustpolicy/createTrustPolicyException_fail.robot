...
CreateTrustPolicyException - create exception with unknown parm values shall return error
   ...
   ('code\=400', 'error\={"message":"CloudletPool key {\\\\"organization\\\\":\\\\"tmus\\\\",\\\\"name\\\\":\\\\"x\\\\"} not found"}')  policy_name=x  app_name=${app_name_automation}  app_version=1.0  developer_org_name=${developer_org_name_automation}  cloudlet_pool_name=x  cloudlet_pool_org_name=${pool['data']['key']['organization']}
