...
CreateVMPool - shall be able to create with 10 VMs 
   ...
   &{vm3}=  Create Dictionary  name=vm3  external_ip=80.187.128.12  internal_ip=2.2.2.3
   &{vm4}=  Create Dictionary  name=vm4  external_ip=80.187.128.12  internal_ip=2.2.2.4
   &{vm5}=  Create Dictionary  name=vm5  external_ip=80.187.128.12  internal_ip=2.2.2.5
   &{vm6}=  Create Dictionary  name=vm6  external_ip=80.187.128.12  internal_ip=2.2.2.6
   &{vm7}=  Create Dictionary  name=vm7  external_ip=80.187.128.12  internal_ip=2.2.2.7
   &{vm8}=  Create Dictionary  name=vm8  external_ip=80.187.128.12  internal_ip=2.2.2.8
   &{vm9}=  Create Dictionary  name=vm9  external_ip=80.187.128.12  internal_ip=2.2.2.9
