*** Settings ***
Documentation  UpdatePrivacyPolicy
...
UpdatePrivacyPolicy - shall be able to delete rules
   [Documentation]
   ...  send CreatePrivacyPolicy with rules
   ...
   ${policy_return}=  Create Privacy Policy  region=${region}  rule_list=${rulelist2}
...
UpdatePrivacyPolicy - update with no rules shall not change the rules 
   [Documentation]
   ...  send CreatePrivacyPolicy with rules
   ...
   ${policy_return2}=  Update Privacy Policy  region=${region}  token=${token}
...
UpdatePrivacyPolicy - shall be able to update icmp cidr
   [Documentation]
...
UpdatePrivacyPolicy - shall be able to update with tcp and no maxport
   [Documentation]
...
UpdatePrivacyPolicy - shall be able to update with tcp and minport/maxport
   [Documentation]
...
UpdatePrivacyPolicy - shall be able to update with tcp and min/max port numbers
   [Documentation]
   ...  send CreatePrivacyPolicy with tcp 
...
UpdatePrivacyPolicy - shall be able to update with udp and no maxport
   [Documentation]
...
UpdatePrivacyPolicy - shall be able to update with udp and maxport=0
   [Documentation]
...
UpdatePrivacyPolicy - shall be able to update with udp and minport/maxport
   [Documentation]
...
UpdatePrivacyPolicy - shall be able to update with udp and min/max port numbers
   [Documentation]
   ...  send CreatePrivacyPolicy with udp 
...
UpdatePrivacyPolicy - shall be able to update with tcp/udp/icmp 
   [Documentation]
   ...
   ${policy_return}=  Update Privacy Policy  region=${region}  rule_list=${rulelist}
...
UpdatePrivacyPolicy - shall be able to update with duplicate policy items
   [Documentation]
