...
Controller shall throw error when trying UpdateClusterInst with invalid cluster name
    ...
    Should Be Equal  ${error_msg}  ('code=400', 'error={"message":"ClusterInst key {\\\\"cluster_key\\\\":{\\\\"name\\\\":\\\\"${cluster_name}\\\\"},\\\\"cloudlet_key\\\\":{\\\\"organization\\\\":\\\\"GDDT\\\\",\\\\"name\\\\":\\\\"${cloudlet_name_openstack_shared}\\\\"},\\\\"organization\\\\":\\\\"MobiledgeX\\\\"} not found"}')
