...
Developer Manager shall not be able to create/update/view/delete reporter
    ...
    Create Reporter  reporter_name=${reporter_name}  organization=tmus  token=${super_token}
    ...
    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Update Reporter  reporter_name=${reporter_name}  organization=tmus  schedule=Every15Days
    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Show Reporter  reporter_name=${reporter_name}  organization=tmus
    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Delete Reporter  reporter_name=${reporter_name}  organization=tmus
...
Operator Contributor shall be able to create/update/view/delete reporter
    ...
    Create Reporter  reporter_name=${reporter_name}  organization=tmus  auto_delete=${False}
...
Operator Viewer shall not be able to create/update/delete reporter
    ...
    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Create Reporter  reporter_name=${reporter_name}1  organization=tmus  auto_delete=${False}
    ${reporter}=  Show Reporter  reporter_name=${reporter_name}  organization=tmus
    Should Be Equal  ${reporter[0]['Name']}  ${reporter_name}
    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Update Reporter  reporter_name=${reporter_name}  organization=tmus  schedule=Every15Days
    Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Delete Reporter  reporter_name=${reporter_name}  organization=tmus
