...
DeleteCloudletPool - deleting cloudlet pool shall delete all cloudlet pool members 
   ...
   Create Cloudlet Pool         region=US  cloudlet_pool_name=${pool_name}  operator_org_name=tmus  auto_delete=${False}
   Add Cloudlet Pool Member  region=US  cloudlet_pool_name=${pool_name}  operator_org_name=tmus  cloudlet_name=tmocloud-1  auto_delete=${False}
