...
DeleteCloudletPool - deleting cloudlet pool shall delete all cloudlet pool members 
   ...
   Create Cloudlet  region=US  operator_org_name=dmuus

   Create Cloudlet Pool         region=US  cloudlet_pool_name=${pool_name}  operator_org_name=dmuus  auto_delete=${False}  token=${token}
   Add Cloudlet Pool Member  region=US  cloudlet_pool_name=${pool_name}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name}  auto_delete=${False}  token=${token}
