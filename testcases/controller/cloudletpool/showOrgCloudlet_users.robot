...
#   ${inlist2}=  Is Cloudlet In List  ${public_cloudlet_list}  tmocloud-2  dmuus
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return2   automationAzureCentralCloudlet  azure
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return}  tmocloud-1  dmuus
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return}  tmocloud-2  dmuus

   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return}   automationAzureCentralCloudlet  azure
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return2}  tmocloud-1  dmuus
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return2}  tmocloud-2  dmuus
