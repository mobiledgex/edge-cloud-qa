...
ShowOrgCloudlet - members shall be removed from cloudlet pools
   ...
   Add Cloudlet Pool Member  region=${region}  token=${super_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-1
   Add Cloudlet Pool Member  region=${region}  token=${super_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2  auto_delete=${False}
...
ShowOrgCloudlet - shall be to add members after orgpoolcreate
   ...
   Create Org Cloudlet Pool     region=US  token=${super_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  org_name=${orgname2}
   ...
   Add Cloudlet Pool Member  region=US  token=${super_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-1
   Add Cloudlet Pool Member  region=US  token=${super_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2
