...
ShowOrgCloudlet - org shall be assigned to 2 cloudlets
   ...
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name1}  #cloudlet_name=tmocloud-1
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2

   Create Cloudlet Pool Access Invitation  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev}  use_defaults=False
   Create Cloudlet Pool Access Response  region=${region}  token=${dev_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev}  decision=accept  use_defaults=False

   #Create Org Cloudlet Pool     region=${region}  token=${super_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  org_name=${orgname}
   ...
   ${inlist}=  Is Cloudlet In List  ${public_cloudlet_list}  ${cloudlet_name1}  dmuus
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return}  ${cloudlet_name1}  dmuus
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return}  tmocloud-2  dmuus

   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return2}  ${cloudlet_name1}  dmuus
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return2}  tmocloud-2  dmuus
...
#      END
#      #Run Keyword If  '${c}' != 'dmuus'  Adduser Role  token=${super_token}  orgname=${c}  username=${op_manager_user_automation}  role=OperatorManager
...
ShowOrgCloudlet - orgs shall be assigned to different cloudlets
   ...
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name1}
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2
   ...
   Create Cloudlet Pool Access Invitation  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev2}  use_defaults=False
   ...
   Create Cloudlet Pool Access Response  region=${region}  token=${dev_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev2}  decision=accept  use_defaults=False
   ...
   #Create Org Cloudlet Pool     region=${region}  token=${super_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus   org_name=${orgname2}
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return2}  ${cloudlet_name1}  dmuus
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return2}  tmocloud-2  dmuus

   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return2}   automationAzureCentralCloudlet  azure
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return}  ${cloudlet_name1}  dmuus
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return}  tmocloud-2  dmuus
...
ShowOrgCloudlet - orgs shall be assigned the same cloudlet
   ...
   Create Cloudlet Pool         region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname1}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name1}
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name1}
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2

   Create Cloudlet Pool Access Invitation  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname1}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev}  use_defaults=False
   Create Cloudlet Pool Access Invitation  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev2}  use_defaults=False
   Create Cloudlet Pool Access Response  region=${region}  token=${dev_token}  cloudlet_pool_name=${poolname1}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev}  decision=accept  use_defaults=False
   Create Cloudlet Pool Access Response  region=${region}  token=${dev_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev2}  decision=accept  use_defaults=False

   #Create Org Cloudlet Pool     region=${region}  token=${super_token}  cloudlet_pool_name=${poolname1}  cloudlet_pool_org_name=dmuus  org_name=${orgname}
   #Create Org Cloudlet Pool     region=${region}  token=${super_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  org_name=${orgname2}
   ...
   ${inlist0}=  Is Cloudlet In List  ${public_cloudlet_list}  ${cloudlet_name1}  dmuus 
   ${cloudlet_length1}=  Run Keyword If  '${inlist0}'=='${True}'   Set Variable  ${org_cloudlets1}  # pool cloudlet is already public
   ...  ELSE  Evaluate  1+${org_cloudlets1}  # pool cloudlet is not already public so add it to the public list
...
ShowOrgCloudlet - orgs shall be assigned the same pool 
   ...
   Add Cloudlet Pool Member  region=${region}  token=${super_token}  cloudlet_pool_name=${poolname1}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name1}
   Add Cloudlet Pool Member  region=${region}  token=${super_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name1}
   Add Cloudlet Pool Member  region=${region}  token=${super_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2
   ...
   #Create Org Cloudlet Pool     region=${region}  token=${super_token}  cloudlet_pool_name=${poolname1}  cloudlet_pool_org_name=dmuus  org_name=${orgname}
   #Create Org Cloudlet Pool     region=${region}  token=${super_token}  cloudlet_pool_name=${poolname1}  cloudlet_pool_org_name=dmuus  org_name=${orgname2}
...
ShowOrgCloudlet - orgs shall be changed to different pools
   ...
   Adduser Role  token=${super_token}  orgname=azure  username=${op_manager_user_automation}  role=OperatorManager
   #Adduser Role  token=${super_token}  orgname=dmuus  username=${op_manager_user_automation}  role=OperatorManager
   ...
   Create Cloudlet Pool Access Invitation  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev2}  auto_delete=False
   ...
   Create Cloudlet Pool Access Response  region=${region}  token=${dev_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev2}  decision=accept  use_defaults=False  auto_delete=${False}
...
#   Length Should Be   ${show_return2}  2
   ...
   #Delete Org Cloudlet Pool     region=${region}  token=${super_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  org_name=${orgname2}
   ...
   Delete Cloudlet Pool Access Invitation  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  developer_org_name=${orgnamedev2}  use_defaults=False
...
#   ${inlist2}=  Is Cloudlet In List  ${public_cloudlet_list}  tmocloud-2  dmuus
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return_new}  ${cloudlet_name1}  dmuus
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return_new}  tmocloud-2  dmuus

   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return_new}   automationAzureCentralCloudlet  azure
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return_new2}  ${cloudlet_name1}  dmuus
...
ShowOrgCloudlet - members shall be removed from cloudlet pools
   ...
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name1}
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2  auto_delete=${False}
...
ShowOrgCloudlet - shall be to add members after orgpoolcreate
   ...
   Create Cloudlet Pool         region=US  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  #auto_delete=${False}
   ...
   #Create Org Cloudlet Pool     region=US  token=${op_token}  cloudlet_pool_name=${poolname2}  cloudlet_pool_org_name=dmuus  org_name=${orgname2}
   ...
   Add Cloudlet Pool Member  region=US  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=${cloudlet_name1}
   Add Cloudlet Pool Member  region=US  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return_new2}  ${cloudlet_name1}  dmuus
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return_new2}  tmocloud-2  dmuus

   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return_new2}   automationAzureCentralCloudlet  azure
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return_new}  ${cloudlet_name1}  dmuus
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return_new}  tmocloud-2  dmuus
...
ShowOrgCloudlet - shall be to add user to existing orgpool 
   ...
   Create Cloudlet Pool         region=${region}  token=${op_token}  cloudlet_pool_name=${poolname1}  operator_org_name=dmuus  cloudlet_list=${cloudlet_list}  #auto_delete=${False}
...
Setup
   ...
   ${cloudlet1}=  Create Cloudlet  region=${region}  operator_org_name=dmuus  token=${super_token}
