...
ShowOrgCloudlet - org shall be assigned to 2 cloudlets
   ...
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-1
   ...
   ${inlist}=  Is Cloudlet In List  ${public_cloudlet_list}  tmocloud-1  dmuus
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return}  tmocloud-1  dmuus
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return}  tmocloud-2  dmuus

   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return2}  tmocloud-1  dmuus
...
ShowOrgCloudlet - orgs shall be assigned to different cloudlets
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return2}  tmocloud-1  dmuus
   ...
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return}  tmocloud-1  dmuus
...
ShowOrgCloudlet - orgs shall be assigned the same cloudlet
   ...
   Create Cloudlet Pool         region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname1}  operator_org_name=dmuus  cloudlet_name=tmocloud-1
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-1
   Add Cloudlet Pool Member  region=${region}  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-2
   ...
   ${inlist0}=  Is Cloudlet In List  ${public_cloudlet_list}  tmocloud-1  dmuus 
   ${cloudlet_length1}=  Run Keyword If  '${inlist0}'=='${True}'   Set Variable  ${org_cloudlets1}  # pool cloudlet is already public
   ...  ELSE  Evaluate  1+${org_cloudlets1}  # pool cloudlet is not already public so add it to the public list
...
ShowOrgCloudlet - orgs shall be assigned the same pool 
   ...
   Add Cloudlet Pool Member  region=${region}  token=${super_token}  cloudlet_pool_name=${poolname1}  operator_org_name=dmuus  cloudlet_name=tmocloud-1
...
#   ${inlist2}=  Is Cloudlet In List  ${public_cloudlet_list}  tmocloud-2  dmuus
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return_new}  tmocloud-1  dmuus
   ...
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return_new2}  tmocloud-1  dmuus
...
ShowOrgCloudlet - shall be to add members after orgpoolcreate
   ...
   Add Cloudlet Pool Member  region=US  token=${op_token}  cloudlet_pool_name=${poolname2}  operator_org_name=dmuus  cloudlet_name=tmocloud-1
   ...
   Pool Cloudlet Should Be In Show Org Cloudlet  ${show_return_new2}  tmocloud-1  dmuus
   ...
   Pool Cloudlet Should Not Be In Show Org Cloudlet  ${show_return_new}  tmocloud-1  dmuus
