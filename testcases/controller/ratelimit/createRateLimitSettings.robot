...
# test not needed since it was a misunderstanding of the feature. See EDGECLOUD-5494
# ECQ-3732
...
CreateRateLimitMaxRequests - shall be able to create with FixedWindowAlgorithm and existing flow
   ...
   Should Be Equal  ${show2[0]['data']['key']['api_endpoint_type']}  Dme
   Should Be Equal  ${show2[0]['data']['key']['rate_limit_target']}  AllRequests 

   Should Be Equal  ${show2[0]['data']['max_reqs_settings']['${max_reqs_name}']['max_reqs_algorithm']}  FixedWindowAlgorithm 
   ...
   Should Be Equal  ${show2[0]['data']['flow_settings']['${flow_name}']['flow_algorithm']}  LeakyBucketAlgorithm
...
Flow Shall Be Created
   ...
   Should Be Equal  ${show['data']['key']['rate_limit_key']['api_endpoint_type']}  ${parms['api_endpoint_type']}
...
#   END
   ...
   Should Be Equal  ${show2[0]['data']['key']['api_endpoint_type']}  ${parms['api_endpoint_type']}
   Should Be Equal  ${show2[0]['data']['key']['rate_limit_target']}  ${parms['rate_limit_target']}

   Should Be Equal  ${show2[0]['data']['flow_settings']['${parms['flow_settings_name']}']['flow_algorithm']}  ${parms['flow_algorithm']}
...
#   END
   ...
   Should Be Equal              ${show['data']['settings']['max_reqs_algorithm']}  FixedWindowAlgorithm
   ...
   Should Be Equal             ${show2[0]['data']['max_reqs_settings']['${parms['max_requests_settings_name']}']['max_reqs_algorithm']}  FixedWindowAlgorithm
