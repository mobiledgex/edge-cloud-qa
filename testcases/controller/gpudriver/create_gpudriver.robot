...
MexAdmin shall be able to create/update/delete a gpudriver
    ...
    ${gpudriver}=  Create Gpudriver  region=${region}  gpudriver_org=TDG  builds_dict=${driver_details}  properties=${properties} 
    ...
    ${gpudriver}=  Update Gpudriver  region=${region}  gpudriver_org=TDG  properties=${properties}
...
MexAdmin shall to able to add/view licenconfig to a gpudriver
    ...
    ${gpudriver}=  Create Gpudriver  region=${region}  gpudriver_org=TDG  builds_dict=${driver_details}  properties=${properties}  license_config=`cat ~/Downloads/gridd.conf`  auto_delete=False
    ...
    Delete Gpudriver  region=${region}  gpudriver_org=TDG

    Create Gpudriver  region=${region}  gpudriver_org=TDG  builds_dict=${driver_details}  properties=${properties}  auto_delete=False
    ${gpudriver}=  Update Gpudriver  region=${region}  gpudriver_org=TDG  license_config=`cat ~/Downloads/gridd.conf`  properties=${properties}
    Should Contain  ${gpudriver['data']['license_config']}  storage.cloud.google.com
    Dictionary Should Contain Key  ${gpudriver['data']}  license_config_md5sum
    ...
    ${gpudriver}=  Update Gpudriver  region=${region}  gpudriver_org=TDG  license_config=`cat ~/Downloads/gridd.conf`
    Should Contain  ${gpudriver['data']['license_config']}  storage.cloud.google.com
    Dictionary Should Contain Key  ${gpudriver['data']}  license_config_md5sum
...
MexAdmin shall be able to add/remove build to a gpudriver
    ...
    &{properties}=  Create Dictionary  FPS=10
    Create Gpudriver  region=${region}  gpudriver_org=TDG  properties=${properties}  auto_delete=False
    ${gpudriver}=  Addbuild Gpudriver  region=${region}  gpudriver_org=TDG  build_name=${gpudriver_build}  build_driverpath=${driverpath}  build_os=Linux  build_md5sum=${md5sum}  build_driverpathcreds=apt:mobiledgex  build_kernelversion=4.15.0-143-generic
    ...
    Create Gpudriver  region=${region}  gpudriver_org=TDG  builds_dict=${driver_details}  properties=${properties}
    ${gpudriver}=  Addbuild Gpudriver  region=${region}  gpudriver_org=TDG  build_name=${gpudriver_build}1  build_driverpath=${driverpath1}  build_os=Linux  build_md5sum=${md5sum1}  build_driverpathcreds=apt:mobiledgex  build_kernelversion=4.15.0-135-generic
 
    Length Should Be   ${gpudriver['data']['builds']}  2

    ${gpudriver}=  Removebuild Gpudriver  region=${region}  gpudriver_org=TDG  build_name=${gpudriver_build}1
...
OperatorManager shall be able to create/update/delete a gpudriver
    ...
    &{properties}=  Create Dictionary  FPS=10
    ${gpudriver}=  Create Gpudriver  region=US  gpudriver_org=tmus  builds_dict=${driver_details}  properties=${properties}  token=${tokenop}
    ...
    &{properties}=  Create Dictionary  FPS=20
    ${gpudriver}=  Update Gpudriver  region=US  gpudriver_org=tmus  properties=${properties}  token=${tokenop}
    Should Be Equal  ${gpudriver['data']['properties']['FPS']}  20
...
OperatorManager shall be able to add licenconfig to a gpudriver
    ...
    &{properties}=  Create Dictionary  FPS=10
    ${gpudriver}=  Create Gpudriver  region=US  gpudriver_org=tmus  builds_dict=${driver_details}  properties=${properties}  license_config=`cat ~/Downloads/gridd.conf`  auto_delete=False  token=${tokenop}
    ...
    Delete Gpudriver  region=US  gpudriver_org=tmus  token=${tokenop}

    Create Gpudriver  region=US  gpudriver_org=tmus  builds_dict=${driver_details}  properties=${properties}  auto_delete=False  token=${tokenop}
    ${gpudriver}=  Update Gpudriver  region=US  gpudriver_org=tmus  license_config=`cat ~/Downloads/gridd.conf`  properties=${properties}  token=${tokenop}
    Dictionary Should Contain Key  ${gpudriver['data']}  license_config
    Dictionary Should Not Contain Key  ${gpudriver['data']}  license_config_md5sum
    Should Not Contain  ${gpudriver['data']['license_config']}  storage.cloud.google.com
    ...
    Create Gpudriver  region=US  gpudriver_org=tmus  builds_dict=${driver_details}  token=${tokenop}
    ${gpudriver}=  Update Gpudriver  region=US  gpudriver_org=tmus  license_config=`cat ~/Downloads/gridd.conf`  token=${tokenop}
    Dictionary Should Contain Key  ${gpudriver['data']}  license_config
    Dictionary Should Not Contain Key  ${gpudriver['data']}  license_config_md5sum
    Should Not Contain  ${gpudriver['data']['license_config']}  storage.cloud.google.com
...
OperatorManager shall be able to add/remove build to a gpudriver
    ...
    ${tokenop}=  Login  username=op_manager_automation  password=${op_manager_password_automation}
    Create Gpudriver  region=US  gpudriver_org=tmus  properties=${properties}  auto_delete=False  token=${tokenop}
    ${gpudriver}=  Addbuild Gpudriver  region=US  gpudriver_org=tmus  build_name=${gpudriver_build}  build_driverpath=${driverpath}  build_os=Linux  build_md5sum=${md5sum}  build_driverpathcreds=apt:mobiledgex  build_kernelversion=4.15.0-143-generic  token=${tokenop}
    ...
    Create Gpudriver  region=US  gpudriver_org=tmus  builds_dict=${driver_details}  properties=${properties}  token=${tokenop}
    ${gpudriver}=  Addbuild Gpudriver  region=US  gpudriver_org=tmus  build_name=${gpudriver_build}1  build_driverpath=${driverpath1}  build_os=Linux  build_md5sum=${md5sum1}  build_driverpathcreds=apt:mobiledgex  build_kernelversion=4.15.0-135-generic  token=${tokenop}

    Length Should Be   ${gpudriver['data']['builds']}  2

    ${gpudriver}=  Removebuild Gpudriver  region=US  gpudriver_org=tmus  build_name=${gpudriver_build}1  token=${tokenop}
