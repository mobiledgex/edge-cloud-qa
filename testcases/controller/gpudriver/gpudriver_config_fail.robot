...
ClusterInst create on cloudlet mapped to incompatible GPU driver fails
    ...
    Should Contain  ${error_msg}  'code=200', 'error={"result":{"message":"Encountered failures: Create failed: failed to install GPU drivers on cluster VM: Unable to find Linux GPU driver build for kernel version 4.15.0-147-generic
