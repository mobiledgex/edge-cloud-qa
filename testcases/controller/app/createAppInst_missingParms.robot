...
AppInst - User shall be able to create an AppInst without a ClusterInst Developer
    ...
    Create App Instance  app_name=${app_name_default}  app_version=1.0  developer_org_name=${developer_name_default}  use_defaults=${False}   cloudlet_name=${cloudlet_name}  operator_org_name=${operator_name}  cluster_instance_name=${cluster_name_default}  use_defaults=${False}

    #Show Cluster Instances
    ${clusterInst}=  Show Cluster Instances  cluster_name=${cluster_name_default}  cloudlet_name=${cloudlet_name}  operator_org_name=${operator_name}  developer_org_name=${developer_name_default}  liveness=LivenessStatic
