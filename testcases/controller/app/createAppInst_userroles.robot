...
CreateApp - DeveloperManager shall be able to create/show/delete/update an app
   ...
   ${appinst}=  Create App Instance  region=${region}  cloudlet_name=tmocloud-1  operator_org_name=tmus  cluster_instance_name=autoclusterxxx  cluster_instance_developer_org_name=MobiledgeX
