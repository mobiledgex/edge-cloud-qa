...
CreateAppInst - error shall be received when creating 2 appinst with same app with version=1.0 and version=10
    ...
    Should Contain  ${error}  ('code=400', 'error={"message":"Cannot deploy AppInst due to DNS name collision with existing instance app_key:\\\\u003corganization:\\\\"MobiledgeX\\\\" name:\\\\"${app_name_default}\\\\" version:\\\\"1.0\\\\" \\\\u003e cluster_inst_key:\\\\u003ccluster_key:\\\\u003cname:\\\\"${cluster_name}\\\\" \\\\u003e cloudlet_key:\\\\u003corganization:\\\\"${operator_name}\\\\" name:\\\\"${cloudlet_name}\\\\" \\\\u003e organization:\\\\"MobiledgeX\\\\" \\\\u003e  - app-key:\\\\u003corganization:\\\\"mobiledgex\\\\"name:\\\\"${app_name_default}\\\\"version:\\\\"10\\\\"\\\\u003ecluster-inst-key:\\\\u003ccluster-key:\\\\u003cname:\\\\"${cluster_name}\\\\"\\\\u003ecloudlet-key:\\\\u003corganization:\\\\"${operator_name}\\\\"name:\\\\"${cloudlet_name}\\\\"\\\\u003eorganization:\\\\"mobiledgex\\\\"\\\\u003e"}')
