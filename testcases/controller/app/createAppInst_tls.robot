...
CreateAppInst - User shall be able to add TLS and non-TLS ports with cluster=k8s/shared and app=k8s/lb
   ...
   Should Be Equal              ${appInst['data']['mapped_ports'][0]['proto']}          Tcp
   ...
   Should Be Equal              ${appInst['data']['mapped_ports'][1]['proto']}          Tcp
   ...
   Should Be Equal              ${appInst['data']['mapped_ports'][2]['proto']}          Tcp
   ...
   Should Be Equal              ${appInst['data']['mapped_ports'][3]['proto']}          Tcp  
   ...
   Should Be Equal              ${appInst['data']['mapped_ports'][4]['proto']}          Udp
...
CreateAppInst - User shall be able to add TLS and non-TLS ports with cluster=docker/shared and app=docker/lb
   ...
   Should Be Equal              ${appInst['data']['mapped_ports'][4]['proto']}          Tcp
   Dictionary Should Not Contain Key   ${appInst['data']['mapped_ports'][4]}  fqdn_prefix
   ...
   Should Be Equal              ${appInst['data']['mapped_ports'][5]['proto']}          Udp
