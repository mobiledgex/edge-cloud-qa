...
CreateApp - shall be to create with image_type=ImageTypeDocker deployment=docker and org does match
    ...
    Should Contain  ${error_msg}  code=400
    Should Contain  ${error_msg}  error={"message":"failed to validate docker registry image, path docker-qa.mobiledgex.net/${orgname}/images/server_ping_threaded:5.0, Not Found"}
