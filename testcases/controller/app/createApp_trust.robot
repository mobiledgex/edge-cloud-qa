...
CreateApp - Error shall be received for invalid trusted parm
   ...
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 353, valid values are true, false  image_type=ImageTypeDocker  deployment=kubernetes  access_type=loadbalancer  image_path=${docker_image}  trusted=x
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 353, valid values are true, false  image_type=ImageTypeDocker  deployment=kubernetes  access_type=loadbalancer  image_path=${docker_image}       trusted=x
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 354, valid values are true, false  image_type=ImageTypeDocker  deployment=docker      access_type=loadbalancer  image_path=${docker_image}       trusted=xTrue}
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 349, valid values are true, false  image_type=ImageTypeDocker  deployment=docker      access_type=loadbalancer  image_path=${docker_image}       trusted=a
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 347, valid values are true, false  image_type=ImageTypeHelm    deployment=helm        access_type=loadbalancer  image_path=${docker_image}       trusted=r
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 352, valid values are true, false  image_type=ImageTypeHelm    deployment=helm        access_type=loadbalancer  image_path=${docker_image}       trusted=cccccc
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 428, valid values are true, false  image_type=ImageTypeQcow    deployment=vm          access_type=loadbalancer  image_path=${qcow_centos_image}  trusted=111
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 427, valid values are true, false  image_type=ImageTypeQcow    deployment=vm          access_type=loadbalancer  image_path=${qcow_centos_image}  trusted=-1
...
UpdateApp - Error shall be received for invalid trusted parm
   ...
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 281, valid values are true, false  image_type=ImageTypeDocker  deployment=kubernetes  access_type=loadbalancer  image_path=${docker_image}  trusted=x
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 281, valid values are true, false  image_type=ImageTypeDocker  deployment=kubernetes  access_type=loadbalancer  image_path=${docker_image}       trusted=x
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 282, valid values are true, false  image_type=ImageTypeDocker  deployment=docker      access_type=loadbalancer  image_path=${docker_image}       trusted=xTrue}
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 277, valid values are true, false  image_type=ImageTypeDocker  deployment=docker      access_type=loadbalancer  image_path=${docker_image}       trusted=a
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 275, valid values are true, false  image_type=ImageTypeHelm    deployment=helm        access_type=loadbalancer  image_path=${docker_image}       trusted=r
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 280, valid values are true, false  image_type=ImageTypeHelm    deployment=helm        access_type=loadbalancer  image_path=${docker_image}       trusted=cccccc
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 356, valid values are true, false  image_type=ImageTypeQcow    deployment=vm          access_type=loadbalancer  image_path=${qcow_centos_image}  trusted=111
   ('code\=400', 'error\={"message":"Invalid JSON data: Unmarshal error: expected bool, but got string for field \\\\"App.trusted\\\\" at offset 355, valid values are true, false  image_type=ImageTypeQcow    deployment=vm          access_type=loadbalancer  image_path=${qcow_centos_image}  trusted=-1
   #('code\=400', 'error\={"message":"Invalid POST data, code\=400, message\=Unmarshal type error: expected\=bool, got\=string, field\=App.trusted, offset\=  image_type=ImageTypeQcow    deployment=vm          access_type=direct        image_path=${qcow_centos_image}  trusted=no
   #('code\=400', 'error\={"message":"Invalid POST data, code\=400, message\=Unmarshal type error: expected\=bool, got\=string, field\=App.trusted, offset\=  image_type=ImageTypeQcow    deployment=vm          access_type=direct        image_path=${qcow_centos_image}  trusted=yes
