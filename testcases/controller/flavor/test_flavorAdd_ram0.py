...
#                                                    client_cert = mex_cert
    ...
    def test_createFlavorRamOnly(self):
        # [Documentation] Flavor - User shall not be able to create flavor with ram=0 
        # ... create flavor with name and ram=0 only
        # ... verify 'Ram cannot be 0' is received
        ...
        # create flavor 
        error = None
        self.flavor = mex_controller.Flavor(flavor_name = flavor_name, ram = 0, use_defaults=False)
        try:
    ...
    def test_createFlavorRam0OtherParms(self):
        # [Documentation] Flavor - User shall not be able to create flavor with ram=0 and all parms
        # ... create flavor with ram=0 and all other valid parms
        # ... verify 'Ram cannot be 0' is received
