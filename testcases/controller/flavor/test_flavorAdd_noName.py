...
#                                                    client_cert = mex_cert
    ...
    def test_createFlavorEmptyName(self):
        # [Documentation] Flavor - User shall not be able to create flavor with empty name
        # ... create flavor with empty name
        # ... verify 'Invalid flavor name' is received
    ...
    def test_createFlavorNoName(self):
        # [Documentation] Flavor - User shall not be able to create flavor with no parms 
        # ... create flavor with no parms
        # ... verify 'Invalid flavor name' is received
    ...
    def test_createFlavorNoNameOtherParms(self):
        ...
        # ... create flavor with ram/vcpus/disk only
        # ... verify 'Invalid flavor name' is received
