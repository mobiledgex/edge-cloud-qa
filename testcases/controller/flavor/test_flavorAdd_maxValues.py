...
#
# create flavor with values set to largest int size 
...
#                                                    client_cert = mex_cert
    ...
    def test_createFlavorMaxValue(self):
        # [Documentation] Flavor - User shall be able to create a flavor with ram/disk/vcpus = largest int
        # ... create flavor with ram/disk/vcpus = largest int size
        # ... verify flavor is added
