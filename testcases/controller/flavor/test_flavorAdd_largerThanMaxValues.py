...
#                                                    client_cert = mex_cert
    ...
    def test_createFlavorRamTooLarge(self):
        # [Documentation] Flavor - User shall not be able to create a flavor with ram out of range
        # ... create flavor with ram > largest int size
        # ... verify flavor is not added
    ...
    def test_createFlavorVcpusTooLarge(self):
        # [Documentation] Flavor - User shall not be able to create a flavor with vcpus out of range
        # ... create flavor with vcpus > largest int size
        # ... verify flavor is not added
    ...
    def test_createFlavorDiskTooLarge(self):
        # [Documentation] Flavor - User shall not be able to create a flavor with disk out of range
        # ... create flavor with disk > largest int size
        # ... verify flavor is not added
