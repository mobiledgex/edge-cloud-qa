...
#
# delete flavor with wrong disk/vcups/ram parms
...
#                                                    client_cert = mex_cert
    ...
    def test_createFlavorMinValue(self):
        # [Documentation] Flavor - User shall be able to delete flavor with wrong ram/vcpus/disk
        # ... delete flavor with wrong disk/vcups/ram parms
        # ... verify flavor is deleted
        ...
        # delete flavor with wrong ram/vcpus/disk parms
        flavor_delete = mex_controller.Flavor(flavor_name=flavor_name, ram=9, vcpus=9, disk=9)
