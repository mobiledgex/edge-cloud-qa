*** Settings ***
Documentation   Create Dedicated Docker Cluster and Run UDP Performance Test between Docker Containers
...
SSH to RootLB VM
  ...
  ${stdout}  ${stderr}  ${rc}=  Execute Command  docker run --rm networkstatic/iperf3 -c dockerserver.automationDusseldorfCloudlet.TDG.mobiledgex.net -b 0 -u -p 5201  return_stderr=${True}  return_rc=${True}
#  log many  {$stdout}
  Should Be Equal As Integers	${rc}	0
  Log  ${stdout}
...
Setup
    ...
    Set Suite Variable  ${cluster_name}  #cluster1584127457-059605.automationdusseldorfcloudlet.tdg.mobiledgex.net
    ...
    Set Suite Variable  ${rootlb}  #cluster1584127457-059605.automationdusseldorfcloudlet.tdg.mobiledgex.net
