...
showDevice - request without id and type shall return device information
    ...
    ...  verify returns 5 result
      ...
      Register Client  developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=  unique_id_type=  first_seen=  seconds=  nanos=  notify_id=
...
showDevice - request with first_seen and nanos shall return device information
    ...
    ...  verify returns 1 result
      ...
      Register Client   developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=1234  unique_id_type=abcde  first_seen=1234  seconds=1234  nanos=1234  notify_id=1
...
showDevice - request without first_seen and nanos shall return device information
    ...
    ...  verify returns 1 result
      ...
      Register Client   developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=wofirsts  unique_id_type=wofirstsid  first_seen=  seconds=  nanos=  notify_id=
      ${device}=  Show Device  region=${region}
...
showDevice - request with notify_id shall return device information
    ...
    ...  verify returns 1 result
      ...
      Register Client   developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=9876  unique_id_type=april  first_seen=1234  seconds=1234  nanos=1234  notify_id=1
      ${device}=  Show Device  region=${region}  unique_id=1234  unique_id_type=abcd  first_seen=1234  seconds=1234  nanos=1234  notify_id=1
...
showDevice - request without notify_id shall return device information
    ...
    ...  verify returns 1 result
      ...
      Register Client   developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=1234  unique_id_type=abcde  first_seen=1234  seconds=1234  nanos=1234  notify_id=
      ${device}=  Show Device  region=${region}
      ${device}=  Show Device  region=${region}
...
showDevice - fail invalid format firstseen nanos
    ...
    ...  verify returns 1 result
      ...
      Register Client   developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=ifirstn  unique_id_type=ifirstnid  first_seen=21:12  seconds=  nanos=  notify_id=0
      ${device}=  Show Device  region=${region}
      ${device}=  Show Device  region=${region}
...
showDevice - fail invalid format seconds
    ...
    ...  verify returns 1 result
      ...
      Register Client   developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=iseconds  unique_id_type=isecondsid  first_seen=  seconds=x-221  nanos=  notify_id=0
      ${device}=  Show Device  region=${region}
      ${device}=  Show Device  region=${region}
...
showDevice - fail invalid format nanos
    ...
    ...  verify returns 1 result
      ...
      Register Client   developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=inanos  unique_id_type=inanosid  #first_seen=  seconds=  nanos=xxxxx  notify_id=
...
showDevice - fail invalid format notifyid
    ...
    ...  verify returns 1 result
      ...
      Register Client   developer_org_name=${platos_developer_name}  app_name=${platos_app_name}  unique_id=inotidyid  unique_id_type=inotifyidt  #first_seen=  seconds=  nanos=  notify_id=zzzzzzz
