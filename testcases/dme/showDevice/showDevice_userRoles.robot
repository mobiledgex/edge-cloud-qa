...
showDevice - OperatorManager shall be not able to ShowDevice/ShowDeviceReport
   ...
   Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Show Device         token=${user_token2}  region=${region}  unique_id=${epoch}  unique_id_type=${samsung_org}
   Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Show Device Report  token=${user_token2}  region=${region}  unique_id=${epoch}  unique_id_type=${samsung_org}
...
showDevice - AdminManager shall be able to ShowDevice/ShowDeviceReport
   ...
   Register Client  developer_org_name=${developer_org_name_automation}  app_name=${app_name_automation}  unique_id=${epoch}  unique_id_type=${samsung_org}

   ${device}=  Show Device         token=${admin_token}  region=${region}  unique_id=${epoch}  unique_id_type=${samsung_org}
   ${device_report}=   Show Device Report  token=${admin_token}  region=${region}  unique_id=${epoch}  unique_id_type=${samsung_org}
