...
DeviceInfo Metrics Headings Should Be Correct
  [Arguments]  ${metrics}  ${raw}=${False}
   ...
   FOR  ${i}  IN RANGE  0  ${count}
      ...
      Should Be Equal  ${metrics['data'][0]['Series'][${i}]['columns'][10]}  numsessions
      Should Be Equal  ${metrics['data'][0]['Series'][${i}]['columns'][11]}  datanetworktype
   END
...
DeviceInfo App Should Be Found
   ...
   Should Be Equal As Integers  ${metric_found[10]}  ${numsessions} 
