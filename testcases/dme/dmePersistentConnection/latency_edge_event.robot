...
DMEPersistentConnection - client for docker autocluster app shall be able to receive Latency request
    ...
    Create Flavor  region=${region}
    Create App  region=${region}  access_ports=tcp:1  deployment=docker
    ${dmuus_appinst}=  Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_fake}  operator_org_name=${operator_name_fake}  cluster_instance_name=autoclusterxx  cluster_instance_developer_org_name=MobiledgeX
