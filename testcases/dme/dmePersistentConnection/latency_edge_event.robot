...
DMEPersistentConnection - Latency edge event with no samples shall return no statistics
    ...
    ${latency}=  Send Latency Edge Event  carrier_name=GDDT  edge_events_cookie=${cloudlet.edge_events_cookie}  latitude=36  longitude=-96 
...
DMEPersistentConnection - Latency edge event with 0 in samples shall return no statistics
    ...
    ${latency}=  Send Latency Edge Event  carrier_name=GDDT  edge_events_cookie=${cloudlet.edge_events_cookie}  latitude=36  longitude=-96  samples=${samples}
...
DMEPersistentConnection - Latency edge event with device info shall return statistics
    ...
    ${latency}=  Send Latency Edge Event  carrier_name=GDDT  edge_events_cookie=${cloudlet.edge_events_cookie}  latitude=36  longitude=-96  samples=${samples}  device_info_data_network_type=5G  device_info_os=Android  device_info_model=Google Pixel  device_info_signal_strength=75
...
DMEPersistentConnection - client for vm app shall be able to receive Latency request
    ...
    ${dmuus_appinst}=  Create App Instance  region=${region}  token=${token}  app_name=${app_name}  app_version=1.0  developer_org_name=${developer_org_name}  cloudlet_name=${cloudlet_name_fake}  operator_org_name=${operator_name_fake}   use_defaults=${False}
    ...
    #Request App Instance Latency  region=${region}  app_name=${app_name}  app_version=1.0  developer_org_name=${developer_org_name}  cluster_instance_name=DefaultVMCluster  cluster_instance_developer_org_name=${developer_org_name}  cloudlet_name=${dmuus_cloudlet_name}  operator_org_name=${dmuus_operator_name}
...
#    Create Cloudlet		cloudlet_name=${azure_cloudlet_name}  operator_org_name=${azure_operator_name}  latitude=${azure_cloudlet_latitude}  longitude=${azure_cloudlet_longitude}
    ...
    ${dmuus_appinst}=  Create App Instance  region=${region}  cluster_instance_developer_org_name=MobiledgeX  cloudlet_name=${dmuus_cloudlet_name}  operator_org_name=${dmuus_operator_name}  cluster_instance_name=autocluster
