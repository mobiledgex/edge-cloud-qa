...
RequestAppInstLatency - OperatorManager shall not be able to request latency
   ...
   Run Keyword and Expect Error  ('code=403', 'error={"message":"Forbidden"}')  Request App Instance Latency  token=${user_token2}  region=${region}  app_name=${app_name_automation}  app_version=1.0  developer_org_name=${developer_org_name_automation}  cloudlet_name=${cloudlet_name_fake}  operator_org_name=${operator_name_fake}
...
RequestAppInstLatency - DeveloperManager shall be able to request latency
   ...
   Create App  token=${user_token2}  region=${region}  developer_org_name=${developer_org_name_automation}  access_ports=tcp:1
   ${appinst}=  Create App Instance  token=${user_token2}  region=${region}  developer_org_name=${developer_org_name_automation}  cluster_instance_developer_org_name=MobiledgeX  cloudlet_name=${cloudlet_name_fake}  operator_org_name=${operator_name_fake}  cluster_instance_name=autocluster
