...
GetAppInstList - request without carriername shall return 3 apps
    ...
    ...  verify returns 3 result
      ...
      Should Be Equal             ${appfqdns[1].carrier_name}                             ${dmuus_appinst_1.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal             ${appfqdns[1].cloudlet_name}                            ${dmuus_appinst_1.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal             ${appfqdns[1].gps_location.latitude}                    ${dmuus_appinst_1.cloudlet_loc.latitude}
      Should Be Equal             ${appfqdns[1].gps_location.longitude}                   ${dmuus_appinst_1.cloudlet_loc.longitude}
      Should Be Equal             ${appfqdns_distance_round1}                             ${distance_round1}
      Should Be Equal             ${appfqdns[1].appinstances[0].app_name}                 ${dmuus_appinst_1.key.app_key.name}
      Should Be Equal             ${appfqdns[1].appinstances[0].app_vers}                 ${dmuus_appinst_1.key.app_key.version}
      Should Be Equal             ${appfqdns[1].appinstances[0].fqdn}                    ${dmuus_appinst_1.uri}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].proto}          ${dmuus_appinst_1.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].internal_port}  ${dmuus_appinst_1.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].public_port}    ${dmuus_appinst_1.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].fqdn_prefix}    ${dmuus_appinst_1.mapped_ports[0].fqdn_prefix}

      Should Be Equal             ${appfqdns[2].carrier_name}                             ${dmuus_appinst_2.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal             ${appfqdns[2].cloudlet_name}                            ${dmuus_appinst_2.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal             ${appfqdns[2].gps_location.latitude}                    ${dmuus_appinst_2.cloudlet_loc.latitude}
      Should Be Equal             ${appfqdns[2].gps_location.longitude}                   ${dmuus_appinst_2.cloudlet_loc.longitude}
      Should Be Equal             ${appfqdns_distance_round2}                             ${distance_round2}
      Should Be Equal             ${appfqdns[2].appinstances[0].app_name}                 ${dmuus_appinst_2.key.app_key.name}
      Should Be Equal             ${appfqdns[2].appinstances[0].app_vers}                 ${dmuus_appinst_2.key.app_key.version}
...
GetAppInstList - request without carriername and limit shall return right apps
    ...
    ...  verify returns right number of apps 
      ...
      Should Be Equal             ${appfqdns[0].carrier_name}                             ${dmuus_appinst_1.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal             ${appfqdns[0].cloudlet_name}                            ${dmuus_appinst_1.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal             ${appfqdns[0].gps_location.latitude}                    ${dmuus_appinst_1.cloudlet_loc.latitude}
      Should Be Equal             ${appfqdns[0].gps_location.longitude}                   ${dmuus_appinst_1.cloudlet_loc.longitude}
      Should Be Equal             ${appfqdns_distance_round0}                             ${distance_round0}
      Should Be Equal             ${appfqdns[0].appinstances[0].app_name}                 ${dmuus_appinst_1.key.app_key.name}
      Should Be Equal             ${appfqdns[0].appinstances[0].app_vers}                 ${dmuus_appinst_1.key.app_key.version}
      ...
      Should Be Equal             ${appfqdns[1].carrier_name}                             ${dmuus_appinst_2.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal             ${appfqdns[1].cloudlet_name}                            ${dmuus_appinst_2.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal             ${appfqdns[1].gps_location.latitude}                    ${dmuus_appinst_2.cloudlet_loc.latitude}
      Should Be Equal             ${appfqdns[1].gps_location.longitude}                   ${dmuus_appinst_2.cloudlet_loc.longitude}
      Should Be Equal             ${appfqdns_distance_round1}                             ${distance_round1}
      Should Be Equal             ${appfqdns[1].appinstances[0].app_name}                 ${dmuus_appinst_2.key.app_key.name}
      Should Be Equal             ${appfqdns[1].appinstances[0].app_vers}                 ${dmuus_appinst_2.key.app_key.version}
      Should Be Equal             ${appfqdns[1].appinstances[0].fqdn}                    ${dmuus_appinst_2.uri}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].proto}          ${dmuus_appinst_2.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].internal_port}  ${dmuus_appinst_2.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].public_port}    ${dmuus_appinst_2.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].fqdn_prefix}    ${dmuus_appinst_2.mapped_ports[0].fqdn_prefix}
...
Setup
    ...
    ${dmuus_appinst_1}=           Create App Instance  cloudlet_name=${cloudlet_name}  operator_org_name=${operator_name}  cluster_instance_name=autocluster

    #${appname_2}=                Catenate  SEPARATOR=  ${app_name_default}  _2    
    #Create App                   app_version=2.0  access_ports=tcp:1
    ${dmuus_appinst_2}=           Create App Instance  cloudlet_name=${cloudlet_name2}  operator_org_name=${operator_name2}  cluster_instance_name=autocluster2
