...
Setup
    ...
    ${tmus_appinst}=           Create App Instance  cloudlet_name=tmocloud-1  operator_org_name=tmus  cluster_instance_name=autocluster
    Create App Instance         cloudlet_name=attcloud-1  operator_org_name=att  cluster_instance_name=autocluster
