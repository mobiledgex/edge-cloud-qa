...
GetAppInstList - request shall return appinst with alliance orgs
    ...
    ${dmuus_appinst_1}=           Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_1}  operator_org_name=${operator_name}  cluster_instance_name=autocluster
    ${dmuus_appinst_2}=           Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_2}  operator_org_name=${operator_name}  cluster_instance_name=autocluster
    ${dmuus_appinst_3}=           Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_3}  operator_org_name=packet  cluster_instance_name=autocluster
    ${dmuus_appinst_4}=           Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_4}  operator_org_name=packet  cluster_instance_name=autocluster
    ${dmuus_appinst_5}=           Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_5}  operator_org_name=packet  cluster_instance_name=autocluster
    ${dmuus_appinst_6}=           Create App Instance  region=${region}  cloudlet_name=${cloudlet_name_6}  operator_org_name=att     cluster_instance_name=autocluster
