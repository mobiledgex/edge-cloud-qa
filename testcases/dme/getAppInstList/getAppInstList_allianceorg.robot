...
GetAppInstList - request shall return appinst with alliance orgs
    ...
    ${allianceorgs}=  Create List  tmus  TDG
    ...
    Verify AppInst  ${appfqdns[0]}  ${tmus_appinst_3}  ${origin}
    Verify AppInst  ${appfqdns[1]}  ${tmus_appinst_5}  ${origin}
    Verify AppInst  ${appfqdns[2]}  ${tmus_appinst_6}  ${origin}
    Verify AppInst  ${appfqdns[3]}  ${tmus_appinst_1}  ${origin}
    Verify AppInst  ${appfqdns[4]}  ${tmus_appinst_2}  ${origin}
...
GetAppInstList - request shall return appinsts with alliance orgs after UpdateCloudlet
    ...
    Verify AppInst  ${appfqdns[0]}  ${tmus_appinst_1}  ${origin}
    Verify AppInst  ${appfqdns[1]}  ${tmus_appinst_2}  ${origin}
    ...
    Verify AppInst  ${appfqdns[0]}  ${tmus_appinst_3}  ${origin}
    Verify AppInst  ${appfqdns[1]}  ${tmus_appinst_5}  ${origin}
    Verify AppInst  ${appfqdns[2]}  ${tmus_appinst_1}  ${origin}
    Verify AppInst  ${appfqdns[3]}  ${tmus_appinst_2}  ${origin}
...
GetAppInstList - request shall return appinsts with alliance orgs after AddAllianceOrg
    ...
    Add Cloudlet Alliance Org  region=${region}  cloudlet_name=${cloudlet_name3}  operator_org_name=packet  alliance_org_name=tmus
    Add Cloudlet Alliance Org  region=${region}  cloudlet_name=${cloudlet_name5}  operator_org_name=packet  alliance_org_name=tmus
