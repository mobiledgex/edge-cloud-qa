...
GetAppInstList - request shall return 10 cloudlets
    ...
    ...  verify returns 10 cloudlets
      ...
      Should Be Equal             ${appfqdns[2].appinstances[0].app_name}                 ${tmus_appinst_1.key.app_key.name}
      Should Be Equal             ${appfqdns[2].appinstances[0].app_vers}                 ${tmus_appinst_1.key.app_key.version}
      ...
      Should Be Equal             ${appfqdns[3].appinstances[0].app_name}                 ${tmus_appinst_2.key.app_key.name}
      Should Be Equal             ${appfqdns[3].appinstances[0].app_vers}                 ${tmus_appinst_2.key.app_key.version}
      ...
      Should Be Equal             ${appfqdns[4].appinstances[0].app_name}                 ${tmus_appinst_3.key.app_key.name}
      Should Be Equal             ${appfqdns[4].appinstances[0].app_vers}                 ${tmus_appinst_3.key.app_key.version}
      ...
      Should Be Equal             ${appfqdns[5].appinstances[0].app_name}                 ${tmus_appinst_4.key.app_key.name}
      Should Be Equal             ${appfqdns[5].appinstances[0].app_vers}                 ${tmus_appinst_4.key.app_key.version}
      ...
      Should Be Equal             ${appfqdns[6].appinstances[0].app_name}                 ${tmus_appinst_5.key.app_key.name}
      Should Be Equal             ${appfqdns[6].appinstances[0].app_vers}                 ${tmus_appinst_5.key.app_key.version}
      ...
      Should Be Equal             ${appfqdns[7].appinstances[0].app_name}                 ${tmus_appinst_6.key.app_key.name}
      Should Be Equal             ${appfqdns[7].appinstances[0].app_vers}                 ${tmus_appinst_6.key.app_key.version}
      ...
      Should Be Equal             ${appfqdns[8].appinstances[0].app_name}                 ${tmus_appinst_7.key.app_key.name}
      Should Be Equal             ${appfqdns[8].appinstances[0].app_vers}                 ${tmus_appinst_7.key.app_key.version}
      ...
      Should Be Equal             ${appfqdns[9].appinstances[0].app_name}                 ${tmus_appinst_8.key.app_key.name}
      Should Be Equal             ${appfqdns[9].appinstances[0].app_vers}                 ${tmus_appinst_8.key.app_key.version}
