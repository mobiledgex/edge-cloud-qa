...
GetAppInstList - request shall return 10 cloudlets
    ...
    ...  verify returns 10 cloudlets
      ...
      Should Be Equal             ${appfqdns[2].CarrierName}                             ${tmus_appinst_1.key.cluster_inst_key.cloudlet_key.operator_key.name}
      Should Be Equal             ${appfqdns[2].CloudletName}                            ${tmus_appinst_1.key.cluster_inst_key.cloudlet_key.name}
      ...
      Should Be Equal             ${appfqdns[3].CarrierName}                             ${tmus_appinst_2.key.cluster_inst_key.cloudlet_key.operator_key.name}
      Should Be Equal             ${appfqdns[3].CloudletName}                            ${tmus_appinst_2.key.cluster_inst_key.cloudlet_key.name}
      ...
      Should Be Equal             ${appfqdns[4].CarrierName}                             ${tmus_appinst_3.key.cluster_inst_key.cloudlet_key.operator_key.name}
      Should Be Equal             ${appfqdns[4].CloudletName}                            ${tmus_appinst_3.key.cluster_inst_key.cloudlet_key.name}
      ...
      Should Be Equal             ${appfqdns[5].CarrierName}                             ${tmus_appinst_4.key.cluster_inst_key.cloudlet_key.operator_key.name}
      Should Be Equal             ${appfqdns[5].CloudletName}                            ${tmus_appinst_4.key.cluster_inst_key.cloudlet_key.name}
      ...
      Should Be Equal             ${appfqdns[6].CarrierName}                             ${tmus_appinst_5.key.cluster_inst_key.cloudlet_key.operator_key.name}
      Should Be Equal             ${appfqdns[6].CloudletName}                            ${tmus_appinst_5.key.cluster_inst_key.cloudlet_key.name}
      ...
      Should Be Equal             ${appfqdns[7].CarrierName}                             ${tmus_appinst_6.key.cluster_inst_key.cloudlet_key.operator_key.name}
      Should Be Equal             ${appfqdns[7].CloudletName}                            ${tmus_appinst_6.key.cluster_inst_key.cloudlet_key.name}
      ...
      Should Be Equal             ${appfqdns[8].CarrierName}                             ${tmus_appinst_7.key.cluster_inst_key.cloudlet_key.operator_key.name}
      Should Be Equal             ${appfqdns[8].CloudletName}                            ${tmus_appinst_7.key.cluster_inst_key.cloudlet_key.name}
      ...
      Should Be Equal             ${appfqdns[9].CarrierName}                             ${tmus_appinst_8.key.cluster_inst_key.cloudlet_key.operator_key.name}
      Should Be Equal             ${appfqdns[9].CloudletName}                            ${tmus_appinst_8.key.cluster_inst_key.cloudlet_key.name}
