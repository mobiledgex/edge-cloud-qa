...
GetAppInstList - request shall return 10 cloudlets
    ...
    ...  verify returns 10 cloudlets
      ...
      Should Be Equal             ${appfqdns[6].carrier_name}                             ${tmus_appinst_1.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[6].appinstances[0].ports[0].proto}          ${tmus_appinst_1.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[6].appinstances[0].ports[0].internal_port}  ${tmus_appinst_1.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[6].appinstances[0].ports[0].public_port}    ${tmus_appinst_1.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[6].appinstances[0].ports[0].fqdn_prefix}    ${tmus_appinst_1.mapped_ports[0].fqdn_prefix}
      ${decoded_edge_cookie}=  Decode Cookie  ${appfqdns[6].appinstances[0].edge_events_cookie}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['latitude']}   ${mobile_latitude}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['longitude']}  ${mobile_longitude}
      Should Be True  ${decoded_edge_cookie['exp']} - ${decoded_edge_cookie['iat']} == 600
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletname']}  ${tmus_appinst_1.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletorg']}  ${tmus_appinst_1.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal  ${decoded_edge_cookie['key']['clustername']}  ${tmus_appinst_1.key.cluster_inst_key.cluster_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['clusterorg']}  ${tmus_appinst_1.key.cluster_inst_key.organization}

      Should Be Equal             ${appfqdns[7].carrier_name}                             ${tmus_appinst_2.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[7].appinstances[0].ports[0].proto}          ${tmus_appinst_2.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[7].appinstances[0].ports[0].internal_port}  ${tmus_appinst_2.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[7].appinstances[0].ports[0].public_port}    ${tmus_appinst_2.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[7].appinstances[0].ports[0].fqdn_prefix}    ${tmus_appinst_2.mapped_ports[0].fqdn_prefix}
      ${decoded_edge_cookie}=  Decode Cookie  ${appfqdns[7].appinstances[0].edge_events_cookie}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['latitude']}   ${mobile_latitude}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['longitude']}  ${mobile_longitude}
      Should Be True  ${decoded_edge_cookie['exp']} - ${decoded_edge_cookie['iat']} == 600
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletname']}  ${tmus_appinst_2.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletorg']}  ${tmus_appinst_2.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal  ${decoded_edge_cookie['key']['clustername']}  ${tmus_appinst_2.key.cluster_inst_key.cluster_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['clusterorg']}  ${tmus_appinst_2.key.cluster_inst_key.organization}

      Should Be Equal             ${appfqdns[0].carrier_name}                             ${tmus_appinst_3.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[0].appinstances[0].ports[0].proto}          ${tmus_appinst_3.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[0].appinstances[0].ports[0].internal_port}  ${tmus_appinst_3.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[0].appinstances[0].ports[0].public_port}    ${tmus_appinst_3.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[0].appinstances[0].ports[0].fqdn_prefix}    ${tmus_appinst_3.mapped_ports[0].fqdn_prefix}
      ${decoded_edge_cookie}=  Decode Cookie  ${appfqdns[0].appinstances[0].edge_events_cookie}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['latitude']}   ${mobile_latitude}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['longitude']}  ${mobile_longitude}
      Should Be True  ${decoded_edge_cookie['exp']} - ${decoded_edge_cookie['iat']} == 600
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletname']}  ${tmus_appinst_3.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletorg']}  ${tmus_appinst_3.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal  ${decoded_edge_cookie['key']['clustername']}  ${tmus_appinst_3.key.cluster_inst_key.cluster_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['clusterorg']}  ${tmus_appinst_3.key.cluster_inst_key.organization}

      Should Be Equal             ${appfqdns[1].carrier_name}                             ${tmus_appinst_4.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].proto}          ${tmus_appinst_4.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].internal_port}  ${tmus_appinst_4.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].public_port}    ${tmus_appinst_4.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[1].appinstances[0].ports[0].fqdn_prefix}    ${tmus_appinst_4.mapped_ports[0].fqdn_prefix}
      ${decoded_edge_cookie}=  Decode Cookie  ${appfqdns[1].appinstances[0].edge_events_cookie}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['latitude']}   ${mobile_latitude}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['longitude']}  ${mobile_longitude}
      Should Be True  ${decoded_edge_cookie['exp']} - ${decoded_edge_cookie['iat']} == 600
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletname']}  ${tmus_appinst_4.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletorg']}  ${tmus_appinst_4.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal  ${decoded_edge_cookie['key']['clustername']}  ${tmus_appinst_4.key.cluster_inst_key.cluster_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['clusterorg']}  ${tmus_appinst_4.key.cluster_inst_key.organization}

      Should Be Equal             ${appfqdns[2].carrier_name}                             ${tmus_appinst_5.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[2].appinstances[0].ports[0].proto}          ${tmus_appinst_5.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[2].appinstances[0].ports[0].internal_port}  ${tmus_appinst_5.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[2].appinstances[0].ports[0].public_port}    ${tmus_appinst_5.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[2].appinstances[0].ports[0].fqdn_prefix}    ${tmus_appinst_5.mapped_ports[0].fqdn_prefix}
      ${decoded_edge_cookie}=  Decode Cookie  ${appfqdns[2].appinstances[0].edge_events_cookie}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['latitude']}   ${mobile_latitude}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['longitude']}  ${mobile_longitude}
      Should Be True  ${decoded_edge_cookie['exp']} - ${decoded_edge_cookie['iat']} == 600
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletname']}  ${tmus_appinst_5.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletorg']}  ${tmus_appinst_5.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal  ${decoded_edge_cookie['key']['clustername']}  ${tmus_appinst_5.key.cluster_inst_key.cluster_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['clusterorg']}  ${tmus_appinst_5.key.cluster_inst_key.organization}

      Should Be Equal             ${appfqdns[3].carrier_name}                             ${tmus_appinst_6.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[3].appinstances[0].ports[0].proto}          ${tmus_appinst_6.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[3].appinstances[0].ports[0].internal_port}  ${tmus_appinst_6.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[3].appinstances[0].ports[0].public_port}    ${tmus_appinst_6.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[3].appinstances[0].ports[0].fqdn_prefix}    ${tmus_appinst_6.mapped_ports[0].fqdn_prefix}
      ${decoded_edge_cookie}=  Decode Cookie  ${appfqdns[3].appinstances[0].edge_events_cookie}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['latitude']}   ${mobile_latitude}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['longitude']}  ${mobile_longitude}
      Should Be True  ${decoded_edge_cookie['exp']} - ${decoded_edge_cookie['iat']} == 600
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletname']}  ${tmus_appinst_6.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletorg']}  ${tmus_appinst_6.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal  ${decoded_edge_cookie['key']['clustername']}  ${tmus_appinst_6.key.cluster_inst_key.cluster_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['clusterorg']}  ${tmus_appinst_6.key.cluster_inst_key.organization}

      Should Be Equal             ${appfqdns[4].carrier_name}                             ${tmus_appinst_7.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[4].appinstances[0].ports[0].proto}          ${tmus_appinst_7.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[4].appinstances[0].ports[0].internal_port}  ${tmus_appinst_7.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[4].appinstances[0].ports[0].public_port}    ${tmus_appinst_7.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[4].appinstances[0].ports[0].fqdn_prefix}    ${tmus_appinst_7.mapped_ports[0].fqdn_prefix}
      ${decoded_edge_cookie}=  Decode Cookie  ${appfqdns[4].appinstances[0].edge_events_cookie}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['latitude']}   ${mobile_latitude}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['longitude']}  ${mobile_longitude}
      Should Be True  ${decoded_edge_cookie['exp']} - ${decoded_edge_cookie['iat']} == 600
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletname']}  ${tmus_appinst_7.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletorg']}  ${tmus_appinst_7.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal  ${decoded_edge_cookie['key']['clustername']}  ${tmus_appinst_7.key.cluster_inst_key.cluster_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['clusterorg']}  ${tmus_appinst_7.key.cluster_inst_key.organization}

      Should Be Equal             ${appfqdns[5].carrier_name}                             ${tmus_appinst_8.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[5].appinstances[0].ports[0].proto}          ${tmus_appinst_8.mapped_ports[0].proto}
      Should Be Equal             ${appfqdns[5].appinstances[0].ports[0].internal_port}  ${tmus_appinst_8.mapped_ports[0].internal_port}
      Should Be Equal             ${appfqdns[5].appinstances[0].ports[0].public_port}    ${tmus_appinst_8.mapped_ports[0].public_port}
      Should Be Equal             ${appfqdns[5].appinstances[0].ports[0].fqdn_prefix}    ${tmus_appinst_8.mapped_ports[0].fqdn_prefix}
      ${decoded_edge_cookie}=  Decode Cookie  ${appfqdns[5].appinstances[0].edge_events_cookie}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['latitude']}   ${mobile_latitude}
      Should Be Equal As Numbers  ${decoded_edge_cookie['key']['location']['longitude']}  ${mobile_longitude}
      Should Be True  ${decoded_edge_cookie['exp']} - ${decoded_edge_cookie['iat']} == 600
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletname']}  ${tmus_appinst_8.key.cluster_inst_key.cloudlet_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['cloudletorg']}  ${tmus_appinst_8.key.cluster_inst_key.cloudlet_key.organization}
      Should Be Equal  ${decoded_edge_cookie['key']['clustername']}  ${tmus_appinst_8.key.cluster_inst_key.cluster_key.name}
      Should Be Equal  ${decoded_edge_cookie['key']['clusterorg']}  ${tmus_appinst_8.key.cluster_inst_key.organization}
