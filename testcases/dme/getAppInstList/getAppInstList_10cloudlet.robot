...
GetAppInstList - request shall return 10 cloudlets
    ...
    ...  verify returns 10 cloudlets
      ...
      Should Be Equal             ${appfqdns[2].carrier_name}                             ${dmuus_appinst_1.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[3].carrier_name}                             ${dmuus_appinst_2.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[4].carrier_name}                             ${dmuus_appinst_3.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[5].carrier_name}                             ${dmuus_appinst_4.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[6].carrier_name}                             ${dmuus_appinst_5.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[7].carrier_name}                             ${dmuus_appinst_6.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[8].carrier_name}                             ${dmuus_appinst_7.key.cluster_inst_key.cloudlet_key.organization}
      ...
      Should Be Equal             ${appfqdns[9].carrier_name}                             ${dmuus_appinst_8.key.cluster_inst_key.cloudlet_key.organization}
