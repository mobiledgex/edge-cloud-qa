...
GetAppInstList - request shall return 2 cloudlets with same coord in random order
    ...
    FOR  ${x}  IN RANGE  0  ${num_finds} 
        ...
        Should Be True  '${appfqdns[2].cloudlet_name}' == '${dmuus_appinst_5.key.cluster_inst_key.cloudlet_key.name}' or '${appfqdns[2].cloudlet_name}' == '${dmuus_appinst_6.key.cluster_inst_key.cloudlet_key.name}'
        ${num_found_21}=  Set Variable If  '${appfqdns[2].cloudlet_name}' == '${dmuus_appinst_5.key.cluster_inst_key.cloudlet_key.name}'  ${num_found_21+1}  ${num_found_21}
        ${num_found_22}=  Set Variable If  '${appfqdns[2].cloudlet_name}' == '${dmuus_appinst_6.key.cluster_inst_key.cloudlet_key.name}'  ${num_found_22+1}  ${num_found_22}

        Should Be True  '${appfqdns[3].cloudlet_name}' == '${dmuus_appinst_5.key.cluster_inst_key.cloudlet_key.name}' or '${appfqdns[3].cloudlet_name}' == '${dmuus_appinst_6.key.cluster_inst_key.cloudlet_key.name}'
        ${num_found_31}=  Set Variable If  '${appfqdns[3].cloudlet_name}' == '${dmuus_appinst_5.key.cluster_inst_key.cloudlet_key.name}'  ${num_found_31+1}  ${num_found_31}
        ${num_found_32}=  Set Variable If  '${appfqdns[3].cloudlet_name}' == '${dmuus_appinst_6.key.cluster_inst_key.cloudlet_key.name}'  ${num_found_32+1}  ${num_found_32}
