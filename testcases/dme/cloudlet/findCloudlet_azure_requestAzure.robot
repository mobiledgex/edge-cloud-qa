*** Settings ***
Documentation   FindCloudlet - request shall return azure with dmuus and gcp/azure cloudlet provisioned and requesting azure
...
...                89.96km  from gcp
...                142.67km  from azure
...             dmuus farther than gcp/azure but less than 100km closer. return azure cloudlet since requesting azure
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
*** Test Cases ***
FindCloudlet - request shall return azure with dmuus and gcp/azure cloudlet provisioned and requesting azure
    [Documentation]
    ...  findCloudlet with dmuus/gcp/azure provisioned. request azure. return azure
    ...             dmuus tmocloud-2 cloudlet at: 35 -95
    ...             gcp gcpcloud-1  cloudlet at: 36 -95
    ...             azure azurecloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 36 -96
