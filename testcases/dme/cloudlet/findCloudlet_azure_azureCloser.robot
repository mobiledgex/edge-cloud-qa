...
FindCloudlet - findCloudlet shall return gcp with with gcp closer by more than 100km
    [Documentation]   
    ...  findCloudlet with tmus and gcp. tmus farther but greater than 100km from gcp - return gcp
    ...		tmus tmocloud-2 cloudlet at: 35 -95
    ...         gcp tmocloud-2  cloudlet at: 37 -95
    ...
    ...		find cloudlet closest to   : 37 -96
...
Setup
    ...
    Create Cloudlet		cloudlet_name=${tmus_cloudlet_name}  operator_name=${operator_name}  number_of_dynamic_ips=default  latitude=${tmus_cloudlet_latitude}  longitude=${tmus_cloudlet_longitude}
    ...
    Create App Instance		app_name=${app_name}  developer_name=${developer_name}  app_version=${app_version}  cloudlet_name=${tmus_cloudlet_name}  operator_name=${operator_name}
