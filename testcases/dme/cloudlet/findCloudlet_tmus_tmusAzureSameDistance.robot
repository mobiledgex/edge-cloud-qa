*** Settings ***
Documentation   FindCloudlet shall return tmus with azure cloudlet provisioned and tmus and azure same distance
...		tmus tmocloud-2 cloudlet at: 35 -95
...             azure azurecloud-1  cloudlet at: 37 -95
...		find cloudlet closest to   : 36 -95
...                111.19km from tmus
...                111.19km  from azure
...             tmus and azure are same distance. return tmus cloudlet
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
FindCloudlet shall return tmus with azure cloudlet provisioned and tmus and azure same distance
    [Documentation]
    ...  findCloudlet with tmus and azure provisioned. tmus and azure same distance from request. return tmus
    ...             tmus tmocloud-2 cloudlet at: 35 -95
    ...             azure azurecloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 36 -95
    ...                111.19km from tmus
