...
*** Test Cases ***
FindCloudlet - request shall return tmus with no gcp/azure proisioned ond same coord as tmocloud-1
    [Documentation]
...
FindCloudlet - request shall return tmus with no gcp/azure proisioned ond same coord as tmocloud-2
    [Documentation]
...
FindCloudlet - request shall return tmus with no gcp/azure proisioned ond coord closer to tmocloud-1
    [Documentation]
...
FindCloudlet - request shall return tmus with no gcp/azure proisioned ond coord closer to tmocloud-2
    [Documentation]
...
FindCloudlet - request shall return tmus with no gcp/azure proisioned ond coord of max distance 
    [Documentation]
...
FindCloudlet - request shall return tmus with no gcp/azure proisioned ond coord of min distance
    [Documentation]
