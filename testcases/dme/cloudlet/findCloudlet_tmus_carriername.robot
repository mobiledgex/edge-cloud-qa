...
#    CreateOperatorCode  region=${region}
    ...
    Create App             access_ports=${access_ports}  region=${region}  #developer_name=MobiledgeX
     #${appinst_1}=          Create App Instance    region=${region}  app_name=automation_api_app  app_version=1.0  developer_name=automation_api  cluster_instance_name=autoclusterAutomatio  cluster_instance_developer_name=automation_api  cloudlet_name=tmocloud-1  operator_name=tmus  flavor_name=automation_api_flavor
     ${appinst_1}=          Create App Instance    region=${region}  cloudlet_name=${cloudlet_name1}  operator_name=${operator_name}  cluster_instance_name=autocluster  #developer_name=MobiledgeX
     ${appinst_2}=          Create App Instance    region=${region}  cloudlet_name=${cloudlet_name2}  operator_name=${operator_name}  cluster_instance_name=autocluster  #developer_name=MobiledgeX
