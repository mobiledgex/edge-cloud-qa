*** Settings ***
Documentation   FindCloudlet shall return dmuus with gcp cloudlet provisioned and dmuus and gcp same distance
...		dmuus tmocloud-2 cloudlet at: 35 -95
...             gcp gcpcloud-1  cloudlet at: 37 -95
...		find cloudlet closest to   : 36 -95
...                111.19km from dmuus
...                111.19km  from gcp
...             dmuus and gcp are same distance. return dmuus cloudlet
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
*** Test Cases ***
FindCloudlet - request shall return dmuus with gcp cloudlet provisioned and dmuus and gcp same distance away
    [Documentation]
    ...  findCloudlet with with dmuus and gcp same distance. return dmuus
    ...		dmuus tmocloud-2 cloudlet at: 35 -95
    ...         gcp gcpcloud-1  cloudlet at: 37 -95
    ...		find cloudlet closest to   : 36 -95
    ...                111.19km from dmuus
