*** Settings ***
Documentation   FindCloudlet - request shall return tmus with azure/gcp cloudlet provisioned and tmus and azure/gcp same coord
...
...                111.19km  from gcp
...                111.19km  from azure
...             tmus and gcp are same coord/distance. return tmus cloudlet
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
FindCloudlet - request shall return tmus with azure/gcp cloudlet provisioned and tmus/azure/gcp same coord
    [Documentation]
    ...  send findCloudlet with with tmus and gcp and azure set to the same coord
    ...             tmus tmocloud-2 cloudlet at: 35 -95
    ...             gcp gcpcloud-1  cloudlet at: 35 -95
    ...             azure azurecloud-1  cloudlet at: 35 -95
    ...             find cloudlet closest to   : 36 -95
