*** Settings ***
Documentation   FindCloudlet - request shall return gcp with dmuus and gcp/azure cloudlet provisioned and requesting gcp
...
...                89.96km  from gcp
...                142.67km  from azure
...             dmuus farther than gcp/azure but less than 100km closer. return gcp cloudlet since requesting gcp
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
*** Test Cases ***
findCloudlet with with dmuus and gcp/azure
      Register Client	app_name=${app_name}  app_version=${app_version}  developer_name=${developer_name}
      ${cloudlet}=  Find Cloudlet	carrier_name=${public_gcp_operator_name}  latitude=36  longitude=-96

      Should Be Equal             ${cloudlet.FQDN}  acmeappcosomeapplication210.tmocloud-2.gcp.mobiledgex.net
      Should Be Equal As Numbers  ${cloudlet.cloudlet_location.lat}  36.0
