*** Settings ***
Documentation   FindCloudlet - request shall return error when sending FindCloudlet for app without permits_platform_apps
...
FindCloudlet Samsung - request shall return error when sending FindCloudlet for app without permits_platform_apps
    [Documentation]
    ...  send FindCloudlet for app without permits_platform_apps
