...
#    CreateOperatorCode  region=${region}
    ...
    Create App             access_ports=${access_ports}  region=${region}  #developer_name=MobiledgeX
     ...
     ${appinst_1}=          Create App Instance    region=${region}  cloudlet_name=${cloudlet_name1}  operator_org_name=${operator_name}  cluster_instance_name=autocluster  #developer_name=MobiledgeX
     ${appinst_2}=          Create App Instance    region=${region}  cloudlet_name=${cloudlet_name2}  operator_org_name=${operator_name}  cluster_instance_name=autocluster  #developer_name=MobiledgeX
