*** Settings ***
Documentation   FindCloudlet - request shall return dmuus with azure cloudlet closer but no appinst provisioned
...		dmuus tmocloud-2 cloudlet at: 35 -95
...             azure azurecloud-1  cloudlet at: 37 -95
...		find cloudlet closest to   : 37 -96
...                239.89km from dmuus
...                88.80km  from azure
...             azure is closer by 151.09km which is more than 100km closer. return dmuus cloudlet since no azure appinst
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
*** Test Cases ***
FindCloudlet - request shall return dmuus with azure cloudlet closer but no appinst provisioned
    [Documentation]
    ...  findCloudlet with dmuus and azure provisioned but not appinst provisioned for azure. return dmuus
    ...             dmuus tmocloud-2 cloudlet at: 35 -95
    ...             azure azurecloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 37 -96
    ...                239.89km from dmuus
