*** Settings ***
Documentation   FindCloudlet - request shall return tmus with azure cloudlet provisioned and tmus farther but < 100km than azure
...		tmus tmocloud-2 cloudlet at: 35 -95
...             azure azurecloud-1  cloudlet at: 37 -95
...		find cloudlet closest to   : 36 -96
...                143.38km from tmus
...                142.67km  from azure
...             tmus farther than azure but less than 100km closer. return tmus cloudlet
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
FindCloudlet - request shall return tmus with azure cloudlet provisioned and tmus farther but < 100km than azure
    [Documentation]
    ...  send findcloudlet request with tmus/azure provisioned. tmus farther but < 100km than azure. return tmus
    ...             tmus tmocloud-2 cloudlet at: 35 -95
    ...             azure azurecloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 36 -96
    ...                143.38km from tmus
