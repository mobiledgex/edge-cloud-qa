...
FindCloudlet Samsung - request shall return tmus with gcp/azure cloudlet provisioned and tmus closer and < 100km from request
    ...
    ...                 long: -94
      ...
      ${cloudlet}=  Find Cloudlet  app_name=${app_name_default}  app_version=1.0  developer_name=${developer_name_default}  carrier_name=${tmus_operator_name}  latitude=35  longitude=-94
