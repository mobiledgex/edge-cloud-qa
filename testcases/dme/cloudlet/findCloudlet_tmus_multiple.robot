...
Setup
    ...
    #Create Cloudlet		cloudlet_name=${tmus_cloudlet_name1}  operator_org_name=${tmus_operator_name}  latitude=${tmus_cloudlet_latitude1}  longitude=${tmus_cloudlet_longitude1}
    #Create Cloudlet		cloudlet_name=${tmus_cloudlet_name2}  operator_org_name=${tmus_operator_name}  latitude=${tmus_cloudlet_latitude2}  longitude=${tmus_cloudlet_longitude2}
    Create Cloudlet		cloudlet_name=${t3}  operator_org_name=tmus  latitude=35  longitude=-96
    Create Cloudlet		cloudlet_name=${t4}  operator_org_name=tmus  latitude=35  longitude=-97
    Create Cloudlet		cloudlet_name=${t5}  operator_org_name=tmus  latitude=35  longitude=-98
    Create Cloudlet		cloudlet_name=${t6}  operator_org_name=tmus  latitude=35  longitude=-99
    Create Cloudlet		cloudlet_name=${t7}  operator_org_name=tmus  latitude=35  longitude=-100
    Create Cloudlet		cloudlet_name=${t8}  operator_org_name=tmus  latitude=35  longitude=-101
    ...
    ${appinst_5}=               Create App Instance		cloudlet_name=${t5}  operator_org_name=${tmus_operator_name}  cluster_instance_name=autocluster
    ${appinst_6}=               Create App Instance		cloudlet_name=${t6}  operator_org_name=${tmus_operator_name}  cluster_instance_name=autocluster
    ${appinst_7}=               Create App Instance		cloudlet_name=${t7}  operator_org_name=${tmus_operator_name}  cluster_instance_name=autocluster
    ${appinst_8}=               Create App Instance		cloudlet_name=${t8}  operator_org_name=${tmus_operator_name}  cluster_instance_name=autocluster
    ${appinst_9}=               Create App Instance		cloudlet_name=${t9}  operator_org_name=${tmus_operator_name}  cluster_instance_name=autocluster
    ${appinst_10}=              Create App Instance		cloudlet_name=${t10}  operator_org_name=${tmus_operator_name}  cluster_instance_name=autocluster
