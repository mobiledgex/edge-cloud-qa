...
Setup
    ...
    ${appinst_1}=               Create App Instance		cloudlet_name=${tmus_cloudlet_name1}  operator_name=${tmus_operator_name}
    ${appinst_2}=               Create App Instance		cloudlet_name=${tmus_cloudlet_name2}  operator_name=${tmus_operator_name}
    ${appinst_3}=               Create App Instance		cloudlet_name=tmocloud-3  operator_name=${tmus_operator_name}
    ${appinst_4}=               Create App Instance		cloudlet_name=tmocloud-4  operator_name=${tmus_operator_name}
    ${appinst_5}=               Create App Instance		cloudlet_name=tmocloud-5  operator_name=${tmus_operator_name}
    ${appinst_6}=               Create App Instance		cloudlet_name=tmocloud-6  operator_name=${tmus_operator_name}
    ${appinst_7}=               Create App Instance		cloudlet_name=tmocloud-7  operator_name=${tmus_operator_name}
    ${appinst_8}=               Create App Instance		cloudlet_name=tmocloud-8  operator_name=${tmus_operator_name}
    ${appinst_9}=               Create App Instance		cloudlet_name=tmocloud-9  operator_name=${tmus_operator_name}
    ${appinst_10}=              Create App Instance		cloudlet_name=tmocloud-10  operator_name=${tmus_operator_name}
