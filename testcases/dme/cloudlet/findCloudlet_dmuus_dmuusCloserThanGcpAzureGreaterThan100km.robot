*** Settings ***
Documentation   FindCloudlet - request shall return dmuus with gcp/azure cloudlet provisioned and dmuus closer and > 100km from request
...
*** Test Cases ***
FindCloudlet - request shall return dmuus with gcp/azure cloudlet provisioned and dmuus closer and > 100km from request
    [Documentation]
    ...
    ...                 long: -94
      ...
      Register Client	
      ${cloudlet}=  Find Cloudlet	carrier_name=${dmuus_operator_name}  latitude=34  longitude=-96
