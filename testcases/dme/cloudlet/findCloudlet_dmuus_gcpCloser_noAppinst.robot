*** Settings ***
Documentation   FindCloudlet - request shall return dmuus with gcp cloudlet closer but no appinst provisioned
...		dmuus tmocloud-2 cloudlet at: 35 -95
...             gcp gcpcloud-1  cloudlet at: 37 -95
...		find cloudlet closest to   : 37 -96
...                239.89km from dmuus
...                88.80km  from gcp
...             gcp is closer by 151.09km which is more than 100km closer. return dmuus cloudlet since no gcp appinst
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
*** Test Cases ***
FindCloudlet - request shall return dmuus with gcp cloudlet closer but no appinst provisioned
    [Documentation]
    ...  findCloudlet with with gcp closer by more than 100km but not appinst provisioned. return dmuus
    ...		dmuus tmocloud-2 cloudlet at: 35 -95
    ...         gcp gcpcloud-1  cloudlet at: 37 -95
    ...		find cloudlet closest to   : 37 -96
    ...                239.89km from dmuus
...
Setup
    ...
    # no gcp app instance
    #Create App Instance		app_name=${app_name}  developer_name=${developer_name}  app_version=${app_version}  cloudlet_name=${cloudlet_name}  operator_name=${public_operator_name}  cluster_instance_name=autocluster
