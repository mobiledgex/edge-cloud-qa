*** Settings ***
Documentation   FindCloudlet - request shall return gcp with dmuus and gcp/azure cloudlet provisioned and dmuus farther and > 100km than gcp and < 100km than azure and gcp closer than azure
...
*** Test Cases ***
FindCloudlet - request shall return gcp with dmuus and gcp/azure cloudlet provisioned and dmuus farther and > 100km than gcp and < 100km than azure and gcp closer than azure
    [Documentation]
    ...  findCloudlet with dmuus/gcp/azure provisioned. dmuus farther than gcp and azure. dmuus > 100km than gcp. dmuus < 100km than azure. gcp closer than azure. return gcp
    ...             dmuus tmocloud-2 cloudlet at: 35 -95
    ...             azure azurecloud-1  cloudlet at: 36 -95
    ...             gcp gcpcloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 37 -96
