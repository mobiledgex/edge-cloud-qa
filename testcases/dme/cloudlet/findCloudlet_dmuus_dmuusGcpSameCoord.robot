...
*** Test Cases ***
FindCloudlet - request shall return dmuus with gcp cloudlet provisioned and dmuus and gcp same coord
    [Documentation]
    ...  findCloudlet with with dmuus and gcp same coord. return dmuus
    ...		dmuus tmocloud-2 cloudlet at: 35 -95
    ...         gcp gcpcloud-1  cloudlet at: 35 -95
    ...		find cloudlet closest to   : 36 -95
    ...                111.19km from dmuus
