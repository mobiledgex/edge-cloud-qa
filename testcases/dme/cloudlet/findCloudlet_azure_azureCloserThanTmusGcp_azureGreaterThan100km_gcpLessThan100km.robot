*** Settings ***
Documentation   FindCloudlet - request shall return azure with dmuus and gcp/azure cloudlet provisioned and dmuus farther but > 100km than azure and < 100km than gcp and azure closer than gcp
...
*** Test Cases ***
FindCloudlet - request shall return azure with dmuus and gcp/azure cloudlet provisioned and dmuus farther but > 100km than azure and < 100km than gcp and azure closer than gcp
    [Documentation]
    ...  findCloudlet with dmuus/azure/gcp provisioned. dmuus farther than azure/gcp. dmuus > 100km than azure. dmuus < 100km than gcp. azure closer than gcp. return azure
    ...             dmuus tmocloud-2 cloudlet at: 35 -95
    ...             gcp gcpcloud-1  cloudlet at: 36 -95
    ...             azure azurecloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 37 -96
