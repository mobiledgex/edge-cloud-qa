*** Settings ***
Documentation   FindCloudlet - request shal return  tmus with azure cloudlet provisioned and tmus closer and < 100km from request
...
FindCloudlet - request shall return tmus with azure cloudlet provisioned and tmus closer and < 100km from request
    [Documentation]
    ...  findcloudlet with tmus and azure. tmus closer and < 100km from request. return tumus
    ...             tmus tmocloud-2 cloudlet at: 35 -95
    ...             azure azurecloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 35 -94
    ...                91.09km from tmus
