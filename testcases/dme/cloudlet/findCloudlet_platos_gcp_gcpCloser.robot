...
FindCloudlet platos - request shall return gcp with dmuus farther and > 100km farther than gcp
    ...
    ...                 long: -95
      ...
      Should Be Equal  ${fqdn.ports[0].proto}  ${gcp_appinst.mapped_ports[0].proto}
      Should Be Equal  ${fqdn.ports[0].internal_port}  ${gcp_appinst.mapped_ports[0].internal_port}
