...
*** Test Cases ***
FindCloudlet - request shall return dmuus with azure cloudlet provisioned and dmuus farther but < 100km than azure
    [Documentation]
    ...  send findcloudlet request with dmuus/azure provisioned. dmuus farther but < 100km than azure. return dmuus
    ...             dmuus tmocloud-2 cloudlet at: 35 -95
    ...             azure azurecloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 36 -96
    ...                143.38km from dmuus
