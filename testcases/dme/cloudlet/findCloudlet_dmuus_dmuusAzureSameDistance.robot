*** Settings ***
Documentation   FindCloudlet shall return dmuus with azure cloudlet provisioned and dmuus and azure same distance
...		dmuus tmocloud-2 cloudlet at: 35 -95
...             azure azurecloud-1  cloudlet at: 37 -95
...		find cloudlet closest to   : 36 -95
...                111.19km from dmuus
...                111.19km  from azure
...             dmuus and azure are same distance. return dmuus cloudlet
...
...             ShowCloudlet
...             - key:
...                 operatorkey:
...
*** Test Cases ***
FindCloudlet shall return dmuus with azure cloudlet provisioned and dmuus and azure same distance
    [Documentation]
    ...  findCloudlet with dmuus and azure provisioned. dmuus and azure same distance from request. return dmuus
    ...             dmuus tmocloud-2 cloudlet at: 35 -95
    ...             azure azurecloud-1  cloudlet at: 37 -95
    ...             find cloudlet closest to   : 36 -95
    ...                111.19km from dmuus
