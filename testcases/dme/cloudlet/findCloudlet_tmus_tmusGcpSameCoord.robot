*** Settings ***
Documentation   FindCloudlet - request shall return tmus with gcp cloudlet provisioned and tmus and gcp same coord
...
FindCloudlet - request shall return tmus with gcp cloudlet provisioned and tmus and gcp same coord
    [Documentation]
    ...  findCloudlet with with tmus and gcp same coord. return tmus
    ...		tmus tmocloud-2 cloudlet at: 35 -95
    ...         gcp gcpcloud-1  cloudlet at: 35 -95
    ...		find cloudlet closest to   : 36 -95
    ...                111.19km from tmus
