...
#   Register Client
#   Get Token
#   ${error_msg}=  Run Keyword And Expect Error  *  Verify Location  session_cookie=default  carrier_name=dmuus  token=default  latitude=35  use_defaults=${True}  # no error should be received
#
#   Should Contain  ${error_msg}   status = StatusCode.INVALID_ARGUMENT
