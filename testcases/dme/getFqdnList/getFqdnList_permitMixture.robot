...
GetFqdnList - request shall only return apps with permits_platform_apps=True
    ...
    ...  verify only returns apps with permits_platform_apps=True
      ...
      Should Be Equal             ${appfqdns[1].dev_name}  ${app_3.key.developer_key.name}
      ...
      Should Be Equal             ${appfqdns[2].dev_name}  ${app_4.key.developer_key.name}
      ...
      Should Be Equal             ${appfqdns[3].dev_name}  ${app_7.key.developer_key.name}
      ...
      Should Be Equal             ${appfqdns[4].dev_name}  ${app_8.key.developer_key.name}
      ...
      Should Be Equal             ${appfqdns[5].dev_name}  ${app_9.key.developer_key.name}
...
Setup
    ...
    ${app_2}=  Create App               access_ports=tcp:1  #permits_platform_apps=${False}
    ...
    ${app_5}=  Create App               access_ports=tcp:1   
    ...
    ${app_6}=  Create App               access_ports=tcp:1  #permits_platform_apps=${False}
    ...
    ${app_10}=  Create App               access_ports=tcp:1   
