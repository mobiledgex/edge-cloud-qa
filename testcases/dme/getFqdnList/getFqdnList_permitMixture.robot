...
GetFqdnList - request shall only return apps with permits_platform_apps=True
    ...
    ...  verify only returns apps with permits_platform_apps=True
      ...
      Should Be Equal             ${appfqdns[1].app_name}  ${appinst_3.key.app_key.name}
      Should Be Equal             ${appfqdns[1].app_vers}  ${appinst_3.key.app_key.version}
      Should Be Equal             ${appfqdns[1].dev_name}  ${appinst_3.key.app_key.developer_key.name}
      Should Be Equal             ${appfqdns[1].fqdns[0]}     ${appinst_3.uri}

      Should Be Equal             ${appfqdns[2].app_name}  ${appinst_4.key.app_key.name}
      Should Be Equal             ${appfqdns[2].app_vers}  ${appinst_4.key.app_key.version}
      Should Be Equal             ${appfqdns[2].dev_name}  ${appinst_4.key.app_key.developer_key.name}
      Should Be Equal             ${appfqdns[2].fqdns[0]}     ${appinst_4.uri}

      Should Be Equal             ${appfqdns[3].app_name}  ${appinst_7.key.app_key.name}
      Should Be Equal             ${appfqdns[3].app_vers}  ${appinst_7.key.app_key.version}
      Should Be Equal             ${appfqdns[3].dev_name}  ${appinst_7.key.app_key.developer_key.name}
      Should Be Equal             ${appfqdns[3].fqdns[0]}     ${appinst_7.uri}

      Should Be Equal             ${appfqdns[4].app_name}  ${appinst_8.key.app_key.name}
      Should Be Equal             ${appfqdns[4].app_vers}  ${appinst_8.key.app_key.version}
      Should Be Equal             ${appfqdns[4].dev_name}  ${appinst_8.key.app_key.developer_key.name}
      Should Be Equal             ${appfqdns[4].fqdns[0]}     ${appinst_8.uri}

      Should Be Equal             ${appfqdns[5].app_name}  ${appinst_9.key.app_key.name}
      Should Be Equal             ${appfqdns[5].app_vers}  ${appinst_9.key.app_key.version}
      Should Be Equal             ${appfqdns[5].dev_name}  ${appinst_9.key.app_key.developer_key.name}
      Should Be Equal             ${appfqdns[5].fqdns[0]}     ${appinst_9.uri}
