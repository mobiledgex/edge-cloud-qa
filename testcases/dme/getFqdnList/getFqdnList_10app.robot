...
GetFqdnList - request shall return 10 apps
    ...
    ...  verify returns 10 results
      ...
      Should Be Equal             ${appfqdns[1].FQDN}     ${appinst_2.uri}
      ...
      Should Be Equal             ${appfqdns[2].FQDN}     ${appinst_3.uri}
      ...
      Should Be Equal             ${appfqdns[3].FQDN}     ${appinst_4.uri}
      ...
      Should Be Equal             ${appfqdns[4].FQDN}     ${appinst_5.uri}
      ...
      Should Be Equal             ${appfqdns[5].FQDN}     ${appinst_6.uri}
      ...
      Should Be Equal             ${appfqdns[6].FQDN}     ${appinst_7.uri}
      ...
      Should Be Equal             ${appfqdns[7].FQDN}     ${appinst_8.uri}
      ...
      Should Be Equal             ${appfqdns[8].FQDN}     ${appinst_9.uri}
      ...
      Should Be Equal             ${appfqdns[9].FQDN}     ${appinst_10.uri}
...
Setup
    ...
    Create App               access_ports=tcp:1  permits_platform_apps=${True}
    ${appinst_3}=            Create App Instance  cloudlet_name=${platos_cloudlet_name}  operator_name=${platos_operator_name}  uri=${uri_3}

    Create Developer         developer_name=${dev_4}
    Create App               access_ports=tcp:1  permits_platform_apps=${True}
    ${appinst_4}=            Create App Instance  cloudlet_name=${platos_cloudlet_name}  operator_name=${platos_operator_name}  uri=${uri_4}

    Create Developer         developer_name=${dev_5}
    Create App               access_ports=tcp:1  permits_platform_apps=${True}
    ${appinst_5}=            Create App Instance  cloudlet_name=${platos_cloudlet_name}  operator_name=${platos_operator_name}  uri=${uri_5}

    Create Developer         developer_name=${dev_6}
    Create App               access_ports=tcp:1  permits_platform_apps=${True}
    ${appinst_6}=            Create App Instance  cloudlet_name=${platos_cloudlet_name}  operator_name=${platos_operator_name}  uri=${uri_6}

    Create Developer         developer_name=${dev_7}
    Create App               access_ports=tcp:1  permits_platform_apps=${True}
    ${appinst_7}=            Create App Instance  cloudlet_name=${platos_cloudlet_name}  operator_name=${platos_operator_name}  uri=${uri_7}

    Create Developer         developer_name=${dev_8}
    Create App               access_ports=tcp:1  permits_platform_apps=${True}
    ${appinst_8}=            Create App Instance  cloudlet_name=${platos_cloudlet_name}  operator_name=${platos_operator_name}  uri=${uri_8}

    Create Developer         developer_name=${dev_9}
    Create App               access_ports=tcp:1  permits_platform_apps=${True}
    ${appinst_9}=            Create App Instance  cloudlet_name=${platos_cloudlet_name}  operator_name=${platos_operator_name}  uri=${uri_9}

    Create Developer         developer_name=${dev_10}
    Create App               access_ports=tcp:1  permits_platform_apps=${True}
    ${appinst_10}=           Create App Instance  cloudlet_name=${platos_cloudlet_name}  operator_name=${platos_operator_name}  uri=${uri_10}
