...
WebUI - OperatorManager shall be able to add a OperatorManager role to a user
    ...
    #Open Organizations
    Add New Organization User  username=${username2_epoch}  organization=${org_name}  role=Manager  flag=after_org_create
...
WebUI - OperatorManager shall be able to add a OperatorContributor role to a user
    ...
    #Open Organizations
    Add New Organization User  username=${username2_epoch}  organization=${org_name}  role=Contributor  flag=after_org_create
...
WebUI - OperatorManager shall be able to add a OperatorViewer role to a user
    ...
    #Open Organizations
    Add New Organization User  username=${username2_epoch}  organization=${org_name}  role=Viewer  flag=after_org_create
