*** Settings ***
Documentation   Add users to operator roles as AdminManager
...
*** Test Cases ***
Web UI - Admin user shall be able to add a user in an OperatorManager role
    [Documentation]
    ...  Create user to delete
    ...  Add user to organization as OperatorManager and relog as admin
...
Web UI - Admin user shall be able to add a user in an OperatorContributor role
    [Documentation]
    ...  Create user to delete
    ...  Add user to organization as OperatorContributor and relog as admin
    ...  Confirm successfully updated and delete created user
...
Web UI - Admin user shall be able to add a user in an OperatorViewer role
    [Documentation]
    ...  Create user to delete
    ...  Add user to organization as OperatorViewer and relog as admin
    ...  Confirm successfully updated and delete created user
...
Setup
    Open Browser
    Run Keyword and Ignore Error  Delete Account  email=${email}  tempName=${username}
