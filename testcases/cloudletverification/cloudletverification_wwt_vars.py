...
# date;time mcctl --addr https://console-qa.mobiledgex.net:443 region --skipverify CreateCloudlet cloudlet=qawwt-cld1 region=US cloudlet-org=wwt physicalname=qawwt-lab infraapiaccess=DirectAccess platformtype=PlatformTypeVcd location.latitude=35 location.longitude=-95 numdynamicips=64 envvar=MEX_VDC_TEMPLATE=mobiledgex-v4.2.1-vcd envvar=MEX_CATALOG=MobiledgeX envvar=MEX_EXTERNAL_NETWORK_MASK=25 envvar=MEX_EXTERNAL_NETWORK_GATEWAY=10.253.172.129 envvar=MEX_NETWORK_SCHEME=cidr=10.102.X.0/24 envvar=MEX_IMAGE_DISK_FORMAT=vmdk deployment=docker infraconfig.flavorname=vcd-medium envvar=MEX_EXT_NETWORK=vcd-net-1  --debug
...
cloudlet_latitude = '35'
cloudlet_longitude = '-95'
cloudlet_ipsupport = 'dynamic'
cloudlet_infraapiaccess = 'directaccess'
cloudlet_numdynamicips = '60'
...
# for VCD mex-edge /25
cloudlet_name = 'qawwt-cld1'
physical_name = 'qawwt-lab'
cloudlet_vdc_template = 'MEX_VDC_TEMPLATE=mobiledgex-v4.3.2-vcd'
cloudlet_mex_catalog =  'MEX_CATALOG=MobiledgeX'
...
cloudlet_ext_netmask = 'MEX_EXTERNAL_NETWORK_MASK=25'
cloudlet_ext_gateway = 'MEX_EXTERNAL_NETWORK_GATEWAY=10.253.172.129'
cloudlet_ext_network = 'MEX_EXT_NETWORK=vcd-net-1'
cloudlet_image_disk_format = 'MEX_IMAGE_DISK_FORMAT=vmdk'
cloudlet_ext_netscheme = 'MEX_NETWORK_SCHEME=cidr=10.102.X.0/24'
cloudlet_nsx_type = 'VCD_NSX_TYPE=NSX-T'

#vcd format

cloudlet_env_vars= f'{cloudlet_datastore},{cloudlet_rootlb_ram},{cloudlet_rootlb_disk},{cloudlet_rootlb_vcpus},{cloudlet_ext_netmask},{cloudlet_ext_netscheme},{cloudlet_ext_network},{cloudlet_ext_gateway},{cloudlet_image_disk_format},{cloudlet_vdc_template},{cloudlet_mex_catalog}, {cloudlet_nsx_type}'
