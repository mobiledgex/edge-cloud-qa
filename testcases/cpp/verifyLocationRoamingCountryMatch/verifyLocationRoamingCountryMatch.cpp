...
class MexGrpcClient {
  public:
    ...
    unique_ptr<Loc> retrieveLocation() {
        ...
        location->set_longitude(21.01178);
        location->set_latitude(52.22977);
	...
	string locReturn = setLocation("52.22977", "21.01178");
...
int main() {
    cout << "VerifyLocationRoamingCountryMatch Test Case" << endl;
    cout << endl;
