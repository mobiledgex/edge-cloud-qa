...
int main() {
    cout << "RegisterClientWithAuthWrongAppVer Test Case";
    cout << endl;
    ...
    int authToken = system(("genauthtoken -appname automation_api_auth_app -appvers 3.0 -devname automation_api -privkeyfile " + pubkey + " >token.txt").c_str());
