...
class MexGrpcClient {
  public:
    ...
    const string orgName = "automaton_dev_org"; // Your developer org name
...
int main() {
    cout << "Verify Location Bad Carrier Test Case" << endl;
    cout << endl;
    ...
    try {
	  ...
	  if(tokenURI == registerClientReply.token_server_uri()){
	    ...
	    cout << endl << "Carrier: " <<mexClient->getCarrierName() << endl << endl;
