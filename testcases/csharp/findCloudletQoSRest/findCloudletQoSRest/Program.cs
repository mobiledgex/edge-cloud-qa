...
namespace RestSample
{
    ...
    class Program
    {
        ...
        async static Task Main(string[] args)
        {
            try
            {
                Console.WriteLine("FindCloudletQoSRest Testcase");
                ...
                tags["ip_user_equipment"] = "192.168.254.15";

                var findCloudletRequest = me.CreateFindCloudletRequest(loc, carrierName, tags);
                ...
                if (findCloudletReply.status == FindCloudletReply.FindStatus.Found && findCloudletReply.qos_result == FindCloudletReply.QosSessionResult.SessionCreated)
                {
                    Console.WriteLine("FindCloudlet QoS Result: " + findCloudletReply.qos_result);
                    Console.WriteLine("FindCloudlet Status:     " + findCloudletReply.status);
                    Console.WriteLine("FindCloudlet FQDN:       " + findCloudletReply.fqdn);
                    Console.WriteLine("FindCloudlet Loc-Lat:    " + findCloudletReply.cloudlet_location.latitude);
                    Console.WriteLine("FindCloudlet Loc-Long:   " + findCloudletReply.cloudlet_location.longitude);
