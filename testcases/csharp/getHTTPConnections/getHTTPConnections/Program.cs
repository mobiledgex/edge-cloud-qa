...
namespace MexGrpcSampleConsoleApp
{
    class Program
    {
        ...
        {
            Console.WriteLine("Get HTTP Connection GRPC Test Case");
    ...
    class MexGrpcLibApp
    {
        ...
        public async Task RunSampleFlow()
        {
            ...
            Uri httpUri = uriBuilder.Uri;

            // HTTP Connection Test
            try
            {
                HttpClient httpClient = await me.GetHTTPClient(httpUri);
