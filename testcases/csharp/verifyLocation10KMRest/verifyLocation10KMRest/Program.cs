    ...
    class Program
    {
        ...
        async static Task Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("VerifyLocation10KMRest Testcase");
                ...
                {
                    Console.WriteLine("Token Server URI Incorrect!");
                ...
                if (verifyLocationReply.gps_location_status == VerifyLocationReply.GPSLocationStatus.Verified && verifyLocationReply.gps_location_accuracy_km.ToString() == "10")
                {
