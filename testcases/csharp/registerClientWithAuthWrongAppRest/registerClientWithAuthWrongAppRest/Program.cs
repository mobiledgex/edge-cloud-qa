    ...
    class Program
    {
        ...
        async static Task Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("RegisterClientWithAuthWrongAppRest Testcase");

                //MatchingEngine me = new MatchingEngine(null, new SimpleNetInterface(new MacNetworkInterfaceName()), new DummyUniqueID(), new DummyDevice.Info());
