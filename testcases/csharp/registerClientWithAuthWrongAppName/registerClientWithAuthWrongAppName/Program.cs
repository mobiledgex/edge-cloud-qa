...
namespace MexGrpcSampleConsoleApp
{
    class Program
    {
        ...
        {
            Console.WriteLine("RegisterClientWithAuthWrongAppName Test Case");
    ...
    class MexGrpcLibApp
    {
        ...
        public async Task RunSampleFlow()
        {
            ...
            psi.Arguments = "-appname automation_api_auth_Leon -appvers 1.0 -devname automation_dev_org -privkeyfile " + pubkey;
            ...
            {
                if (regReplyError.Status.Detail == "failed to verify token - token appname mismatch")
                {
