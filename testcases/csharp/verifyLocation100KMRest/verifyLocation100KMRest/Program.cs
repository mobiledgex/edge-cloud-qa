    ...
    class Program
    {
        ...
        async static Task Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("VerifyLocation100KMRest Testcase");
                ...
                if (verifyLocationReply.gps_location_status == VerifyLocationReply.GPSLocationStatus.Verified && verifyLocationReply.gps_location_accuracy_km.ToString() == "100")
                {
