    ...
    class Program
    {
        ...
        async static Task Main(string[] args)
        {
            try
            {
                ...
                if (verifyLocationReply.gps_location_status == VerifyLocationReply.GPSLocationStatus.RoamingCountryMismatch)
                {
            ...
            catch (Exception e)
            {
                ...
                {
                    Console.WriteLine("Inner Exceptioin: " + e.InnerException.Message);
                }
            }
