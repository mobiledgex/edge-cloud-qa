    ...
    class Program
    {
        ...
        async static Task Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("VerifyLocationMisMatchOtherCountryRest Testcase");
                ...
                if (verifyLocationReply.gps_location_status == VerifyLocationReply.GPSLocationStatus.MismatchOtherCountry)
                {
