...
namespace MexGrpcSampleConsoleApp
{
    class Program
    {
        ...
        {
            Console.WriteLine("FindCloudletQoS Test Case");
    ...
    class MexGrpcLibApp
    {
        ...
        public async Task RunSampleFlow()
        {
            ...
            if (findCloudletResponse.Status == FindCloudletReply.Types.FindStatus.FindFound && findCloudletResponse.QosResult == FindCloudletReply.Types.QosSessionResult.QosSessionCreated)
            {
                Console.WriteLine("FindCloudlet QoS Result:   " + findCloudletResponse.QosResult);
                Console.WriteLine("FindCloudlet QoS Session:  " + findCloudletResponse.Tags);
                Console.WriteLine("FindCloudlet Reply Status: " + findCloudletResponse.Status);
                Console.WriteLine("FindCloudlet FQDN:         " + findCloudletResponse.Fqdn);
                Console.WriteLine("FindCloudlet Loc:          " + findCloudletResponse.CloudletLocation);
