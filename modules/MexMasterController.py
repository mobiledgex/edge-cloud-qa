...
#        self._number_deletecloudlet_requests_fail = 0
    ...
    def show_alert_receivers(self, token=None, receiver_name=None, type=None, severity=None, app_name=None, app_version=None, cloudlet_name=None, operator_org_name=None, developer_org_name=None, cluster_instance_developer_org_name=None, user=None, json_data=None, use_defaults=True, auto_delete=True, use_thread=False):
        return self.alert_receiver.show_alert_receiver(token=token, receiver_name=receiver_name, type=type, severity=severity, app_name=app_name, app_version=app_version, cloudlet_name=cloudlet_name, operator_org_name=operator_org_name,  developer_org_name=developer_org_name, cluster_instance_developer_org_name=cluster_instance_developer_org_name, user=user, json_data=json_data, use_defaults=use_defaults, auto_delete=auto_delete, use_thread=use_thread)
    ...
    def show_alerts(self, token=None, alert_name=None, region=None, app_name=None,  app_version=None,  developer_org_name=None, port=None, json_data=None, use_defaults=True, use_thread=False):
        return self.alert.show_alert(token=token, alert_name=alert_name, region=region, app_name=app_name, app_version=app_version, developer_org_name=developer_org_name, port=port, json_data=json_data, use_defaults=use_defaults, use_thread=use_thread)
