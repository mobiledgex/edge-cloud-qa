...
#        self._number_deletecloudlet_requests_fail = 0
    ...
    def create_trust_policy_exception(self, token=None, region=None, policy_name=None, app_name=None, developer_org_name=None, app_version=None, cloudlet_pool_name=None, cloudlet_pool_org_name=None, rule_list=[], json_data=None, use_defaults=True, auto_delete=True, use_thread=False):
        return self.trust_policy.create_trust_policy_exception(token=token, region=region, policy_name=policy_name, app_name=app_name, developer_org_name=developer_org_name, app_version=app_version, cloudlet_pool_name=cloudlet_pool_name, cloudlet_pool_org_name=cloudlet_pool_org_name, rule_list=rule_list, json_data=json_data, use_defaults=use_defaults, auto_delete=auto_delete, use_thread=use_thread)
