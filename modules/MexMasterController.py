...
#        self._number_deletecloudlet_requests_fail = 0
    ...
    def create_reporter(self, token=None, reporter_name=None, organization=None, email=None, schedule=None, start_schedule_date=None, timezone=None, use_defaults=True, use_thread=False):
        return self.operator_reporting.create_reporter(token=token, reporter_name=reporter_name, organization=organization, email=email, schedule=schedule, start_schedule_date=start_schedule_date, timezone=timezone, use_defaults=use_defaults, use_thread=use_thread)

    def update_reporter(self, token=None, reporter_name=None, organization=None, email=None, schedule=None, start_schedule_date=None, timezone=None, use_defaults=True, use_thread=False):
        return self.operator_reporting.update_reporter(token=token, reporter_name=reporter_name, organization=organization, email=email, schedule=schedule, start_schedule_date=start_schedule_date, timezone=timezone, use_defaults=use_defaults, use_thread=use_thread)
