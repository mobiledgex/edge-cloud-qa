...
#        self._number_deletecloudlet_requests_fail = 0
    ...
    def create_cluster_instance(self, token=None, region=None, cluster_name=None, operator_org_name=None, cloudlet_name=None, developer_org_name=None, flavor_name=None, liveness=None, ip_access=None, deployment=None, number_masters=None, number_nodes=None, shared_volume_size=None, privacy_policy=None, autoscale_policy_name=None, reservable=None, reservation_ended_at_seconds=None, reservation_ended_at_nanoseconds=None, networks_list=[], timeout=900, json_data=None, auto_delete=True, use_defaults=True, use_thread=False):
        ...
        return self.cluster_instance.create_cluster_instance(token=token, region=region, cluster_name=cluster_name, operator_org_name=operator_org_name, cloudlet_name=cloudlet_name, developer_org_name=developer_org_name, flavor_name=flavor_name, liveness=liveness, ip_access=ip_access, deployment=deployment, number_masters=number_masters, number_nodes=number_nodes, shared_volume_size=shared_volume_size, privacy_policy=privacy_policy, autoscale_policy_name=autoscale_policy_name, reservable=reservable, reservation_ended_at_seconds=reservation_ended_at_seconds, reservation_ended_at_nanoseconds=reservation_ended_at_nanoseconds, networks_list=networks_list, stream_timeout=timeout, auto_delete=auto_delete, use_defaults=use_defaults, use_thread=use_thread)
    ...
    def update_cloudlet_pool(self, token=None, region=None, cloudlet_pool_name=None, operator_org_name=None, cloudlet_list=[], json_data=None, use_defaults=True, auto_delete=True, use_thread=False):
            ...
            for pool in all_pools:
                if pool['data']['cloudlets'] is not None:
                    for cloudlet in pool['data']['cloudlets']:
                        pool_cloudlet_list.append(cloudlet['name'])
    ...
    def show_network(self, token=None, region=None, network_name=None, cloudlet_name=None, cloudlet_org=None, connection_type=None, federated_org=None, route_list=[], json_data=None, auto_delete=True, use_defaults=True, use_thread=False):
        return self.network.show_network(token=token, region=region, network_name=network_name, cloudlet_name=cloudlet_name, cloudlet_org=cloudlet_org, federated_org=federated_org, route_list=route_list, json_data=json_data, use_defaults=use_defaults, use_thread=use_thread)

    def update_network(self, token=None, region=None, network_name=None, cloudlet_name=None, cloudlet_org=None, connection_type=None, federated_org=None, route_list=[], json_data=None, auto_delete=True, use_defaults=True, use_thread=False):
    ...
    def delete_alert_receiver(self, token=None, receiver_name=None, type=None, severity=None, user=None, developer_org_name=None, cluster_instance_developer_org_name=None, json_data=None, use_defaults=True, auto_delete=True, use_thread=False):
        return self.alert_receiver.delete_alert_receiver(token=token, receiver_name=receiver_name, type=type, severity=severity, user=user, developer_org_name=developer_org_name, cluster_instance_developer_org_name=cluster_instance_developer_org_name, json_data=json_data, use_defaults=use_defaults, auto_delete=auto_delete, use_thread=use_thread)
