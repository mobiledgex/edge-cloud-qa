        ...
        def send_message(thread_name='Thread'):
            ...
            try:
                ...
                if 'UpdateClusterInst' in url:
                    ...
                    if 'Updated Cloudlet successfully' in str(self.resp.text) or 'Upgraded Cloudlet successfully' in str(self.resp_text) or 'Cloudlet updated successfully' in str(self.resp_text):
                        pass
                    else:
                        raise Exception('ERROR: Cloudlet not updated successfully:' + str(self.resp_text))
