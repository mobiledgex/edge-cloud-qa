...
class CloudletPoolMember(MexOperation):
    ...
    def create_cloudlet_pool_member(self, token=None, region=None, cloudlet_pool_name=None, operator_org_name=None, cloudlet_name=None, json_data=None, use_defaults=True, auto_delete=True, use_thread=False):
        ...
        if auto_delete and 'pool_key' in msg:
            msg_delete = self._build(cloudlet_pool_name=msg['pool_key']['name'], cloudlet_name=msg['cloudlet_key']['name'], operator_org_name=msg['cloudlet_key']['organization'], use_defaults=False)
    ...
    def delete_cloudlet_pool_member(self, token=None, region=None, cloudlet_pool_name=None, operator_org_name=None, cloudlet_name=None, json_data=None, use_defaults=True, auto_delete=True, use_thread=False):
        msg = self._build(cloudlet_pool_name=cloudlet_pool_name, operator_org_name=operator_org_name, cloudlet_name=cloudlet_name, use_defaults=use_defaults)
        msg_dict = {'cloudletpoolmember': msg}
