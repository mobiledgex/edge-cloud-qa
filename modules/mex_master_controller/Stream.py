...
class Stream(MexOperation):
    ...
    def _build_cloudlet(self, cloudlet_name=None, operator_org_name=None, use_defaults=True):
        ...
        #'{"cloudletkey":{"name":"andybuckhorn","organization":"GDDT"},"region":"EU"}'
        stream_dict = {}
        cloudlet_key_dict = {}
    ...
    def _build_clusterinst(self, cluster_name=None, developer_org_name=None, cloudlet_dict=None, use_defaults=True):
        ...
        #'{"clusterinstkey":{"cloudlet_key":{"name":"cloudlet1603909082-905556","organization":"GDDT"},"cluster_key":{"name":"mycluster"},"organization":"MobiledgeX"},"region":"EU"}'
        stream_dict = {}
        cluster_key_dict = {}
        cloudlet_key_dict = {}
    ...
    def _build_appinst(self, app_name=None, app_version=None, developer_org_name=None, cloudlet_dict=None, cluster_dict=None, use_defaults=True):
        ...
        #'{"appinstkey":{"app_key":{"name":"myname,","organization":"MobiledgeX","version":"1.0"},"cluster_inst_key":{"cloudlet_key":{"name":"automationHawkinsCloudlet","organization":"GDDT"},"cluster_key":{"name":"cluster1603915771-749813"}}},"region":"EU"}'
        stream_dict = {}
        app_key_dict = {}
        appinst_key_dict = {}
        cloudlet_key_dict = {}
