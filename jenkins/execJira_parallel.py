...
def exec_testcase(z, t):
    ...
    if tc_type == 'robot':
        ...
        if crm_pool_round_robin:
            ...
            my_env['AUTOMATION_OPENSTACK_VGPU_ENV'] = os.environ['WORKSPACE'] + '/go/src/github.com/mobiledgex/testcases/config/openrc_automationParadiseCloudlet.mex'
            my_env['AUTOMATION_OPENSTACK_VMPOOL_ENV'] = os.environ['WORKSPACE'] + '/go/src/github.com/mobiledgex/testcases/config/openrc_automationParadiseCloudlet.mex'
