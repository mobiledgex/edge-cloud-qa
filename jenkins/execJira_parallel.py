...
def exec_testcase(z, t):
    ...
    if tc_type == 'robot':
        ...
        if crm_pool_round_robin:
            ...
            my_env['AUTOMATION_OPENSTACK_GPU_ENV'] = os.environ['WORKSPACE'] + '/go/src/github.com/mobiledgex/testcases/config/openrc_automationBonnCloudlet.mex'
            my_env['AUTOMATION_OPENSTACK_OFFLINE_ENV'] = openstack_file
            my_env['AUTOMATION_OPENSTACK_VGPU_ENV'] = os.environ['WORKSPACE'] + '/go/src/github.com/mobiledgex/testcases/config/openrc_automationBonnCloudlet.mex'
            my_env['AUTOMATION_OPENSTACK_VMPOOL_ENV'] = os.environ['WORKSPACE'] + '/go/src/github.com/mobiledgex/testcases/config/openrc_automationBonnCloudlet.mex'
